...
public class HealthSeederTests
{
    ...
    {
        IReadOnlyList<string> issues = HealthSeeder.ValidateDefaultSurgeryTargetAliasesForTesting();
    ...
    public void BuildTargetDefinition_OrganicHumanoid_ResolvesInheritedAndLocalBodyparts()
    {
        ...
        BodyProto organicHumanoidBody = new()
        {
            Id = 2,
            Name = "Organic Humanoid",
        ...
        string definition = HealthSeeder.BuildTargetDefinition(context, organicHumanoidBody, "lupperarm", "brain");
        long[] targetIds = XElement.Parse(definition)
            .Element("Parts")!
            .Elements("Part")
