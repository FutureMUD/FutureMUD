...
--
-- Definition of environmentalmagicoperations
--
...
CREATE TABLE IF NOT EXISTS `environmentalmagicoperations` (
  ...
  `RequestedRepair` double NOT NULL,
  `AppliedDamage` double NOT NULL,
  `AppliedPressure` double NOT NULL,
  `AppliedRepair` double NOT NULL,
  `AtUtc` datetime(6) NOT NULL,
  `ActorId` bigint DEFAULT NULL,
  `Attribution` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table environmentalmagicoperations
--

/*!40000 ALTER TABLE `environmentalmagicoperations` DISABLE KEYS */;
/*!40000 ALTER TABLE `environmentalmagicoperations` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `charactercombatsettings` (
  ...
  `PreferToStandOverAttacking` bit(1) NOT NULL DEFAULT b'1',
  PRIMARY KEY (`Id`),
...
--
-- Definition of chargenskillselectiongroups
--

DROP TABLE IF EXISTS `chargenskillselectiongroups`;
CREATE TABLE IF NOT EXISTS `chargenskillselectiongroups` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `StableKey` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  `MemberEligibilityProgId` bigint DEFAULT NULL,
  `SeedBaseline` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `IX_ChargenSkillSelectionGroups_StableKey` (`StableKey`),
  KEY `IX_ChargenSkillSelectionGroups_EligibilityProgId` (`EligibilityProgId`),
  KEY `IX_ChargenSkillSelectionGroups_MemberEligibilityProgId` (`MemberEligibilityProgId`),
...
--
-- Dumping data for table chargenskillselectiongroups
--

/*!40000 ALTER TABLE `chargenskillselectiongroups` DISABLE KEYS */;
/*!40000 ALTER TABLE `chargenskillselectiongroups` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `liquids` (
  ...
  `SpoilAfterSeconds` double DEFAULT NULL,
  `SpoiledLiquidId` bigint DEFAULT NULL,
  `StaleAfterSeconds` double DEFAULT NULL,
  `StaleLiquidId` bigint DEFAULT NULL,
  PRIMARY KEY (`Id`),
  ...
  KEY `FK_Liquids_SpoiledLiquid_idx` (`SpoiledLiquidId`),
  KEY `FK_Liquids_StaleLiquid_idx` (`StaleLiquidId`),
  ...
  CONSTRAINT `FK_Liquids_SpoiledLiquid` FOREIGN KEY (`SpoiledLiquidId`) REFERENCES `liquids` (`Id`) ON DELETE RESTRICT,
  CONSTRAINT `FK_Liquids_StaleLiquid` FOREIGN KEY (`StaleLiquidId`) REFERENCES `liquids` (`Id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Definition of magicalsubstances
--

DROP TABLE IF EXISTS `magicalsubstances`;
CREATE TABLE IF NOT EXISTS `magicalsubstances` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `Name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table magicalsubstances
--
...
--
-- Definition of charactermagiccapabilitystates
--

DROP TABLE IF EXISTS `charactermagiccapabilitystates`;
CREATE TABLE IF NOT EXISTS `charactermagiccapabilitystates` (
  `CharacterId` bigint NOT NULL,
  ...
  KEY `IX_CharacterMagicCapabilityStates_MagicCapabilityId` (`MagicCapabilityId`),
...
--
-- Dumping data for table charactermagiccapabilitystates
--

/*!40000 ALTER TABLE `charactermagiccapabilitystates` DISABLE KEYS */;
/*!40000 ALTER TABLE `charactermagiccapabilitystates` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `bodypartproto` (
  ...
  `UseLimbSeverDescription` bit(1) NOT NULL DEFAULT b'1',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `projectlabourqueues` (
  ...
  `ClaimingCharacterInstanceId` bigint DEFAULT NULL,
  `CompletionMode` int NOT NULL DEFAULT '0',
  `ElapsedHours` double NOT NULL DEFAULT '0',
  `EntryType` int NOT NULL DEFAULT '0',
  `LabourPreference` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `ProjectId` bigint DEFAULT NULL,
  `TargetHours` double NOT NULL DEFAULT '0',
  `WatchedPhaseId` bigint DEFAULT NULL,
  PRIMARY KEY (`Id`),
  ...
  KEY `FK_ProjectLabourQueues_CharacterInstances_idx` (`ClaimingCharacterInstanceId`),
  CONSTRAINT `FK_ProjectLabourQueues_ActiveProjects` FOREIGN KEY (`ActiveProjectId`) REFERENCES `activeprojects` (`Id`) ON DELETE SET NULL,
  CONSTRAINT `FK_ProjectLabourQueues_CharacterInstances` FOREIGN KEY (`ClaimingCharacterInstanceId`) REFERENCES `characterinstances` (`Id`) ON DELETE SET NULL,
  CONSTRAINT `FK_ProjectLabourQueues_Characters` FOREIGN KEY (`CharacterId`) REFERENCES `characters` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_ProjectLabourQueues_ProjectLabourRequirements` FOREIGN KEY (`ProjectLabourRequirementId`) REFERENCES `projectlabourrequirements` (`Id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `races` (
  ...
  `PainToleranceMultiplier` double NOT NULL DEFAULT '1',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `ethnicities` (
  ...
  KEY `IX_Ethnicities_NativeLanguageId` (`NativeLanguageId`),
  CONSTRAINT `FK_Ethnicities_AvailabilityProg` FOREIGN KEY (`AvailabilityProgId`) REFERENCES `futureprogs` (`Id`) ON DELETE SET NULL,
  CONSTRAINT `FK_Ethnicities_Languages_NativeLanguageId` FOREIGN KEY (`NativeLanguageId`) REFERENCES `languages` (`Id`) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS `characters` (
  ...
  KEY `IX_Characters_NativeLanguageId` (`NativeLanguageId`),
  ...
  CONSTRAINT `FK_Characters_Languages_NativeLanguageId` FOREIGN KEY (`NativeLanguageId`) REFERENCES `languages` (`Id`) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS `magicspells` (
  ...
  `ScrollInscriptionAllowed` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Definition of chargenskillselectiongroupmembers
--

DROP TABLE IF EXISTS `chargenskillselectiongroupmembers`;
CREATE TABLE IF NOT EXISTS `chargenskillselectiongroupmembers` (
  `GroupId` bigint NOT NULL,
  `TraitDefinitionId` bigint NOT NULL,
  `DisplayOrder` int NOT NULL,
  PRIMARY KEY (`GroupId`,`TraitDefinitionId`),
  KEY `IX_ChargenSkillSelectionGroupMembers_TraitDefinitionId` (`TraitDefinitionId`),
...
--
-- Dumping data for table chargenskillselectiongroupmembers
--

/*!40000 ALTER TABLE `chargenskillselectiongroupmembers` DISABLE KEYS */;
/*!40000 ALTER TABLE `chargenskillselectiongroupmembers` ENABLE KEYS */;
...
--
-- Definition of accentsassociatedlanguages
--

DROP TABLE IF EXISTS `accentsassociatedlanguages`;
CREATE TABLE IF NOT EXISTS `accentsassociatedlanguages` (
  `AccentId` bigint NOT NULL,
  `LanguageId` bigint NOT NULL,
  PRIMARY KEY (`AccentId`,`LanguageId`),
  KEY `IX_AccentsAssociatedLanguages_LanguageId` (`LanguageId`),
...
--
-- Dumping data for table accentsassociatedlanguages
--

/*!40000 ALTER TABLE `accentsassociatedlanguages` DISABLE KEYS */;
/*!40000 ALTER TABLE `accentsassociatedlanguages` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `characters_languages` (
  `CharacterId` bigint NOT NULL,
  `LanguageId` bigint NOT NULL,
  `AcquisitionAccentId` bigint DEFAULT NULL,
  PRIMARY KEY (`CharacterId`,`LanguageId`),
  KEY `FK_Characters_Languages_Languages_idx` (`LanguageId`),
  KEY `IX_Characters_Languages_AcquisitionAccentId` (`AcquisitionAccentId`),
  CONSTRAINT `FK_Characters_Languages_Accents_AcquisitionAccentId` FOREIGN KEY (`AcquisitionAccentId`) REFERENCES `accents` (`Id`) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS `rangedweapontypes` (
  ...
  `MinimumFiringPositionStateId` int DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
--
-- Definition of traptemplates
--

DROP TABLE IF EXISTS `traptemplates`;
CREATE TABLE IF NOT EXISTS `traptemplates` (
  `Id` bigint NOT NULL,
  `RevisionNumber` int NOT NULL,
  `EditableItemId` bigint NOT NULL,
  `Name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Definition` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`,`RevisionNumber`),
  KEY `FK_TrapTemplates_EditableItems_idx` (`EditableItemId`),
  CONSTRAINT `FK_TrapTemplates_EditableItems` FOREIGN KEY (`EditableItemId`) REFERENCES `editableitems` (`Id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table traptemplates
--

/*!40000 ALTER TABLE `traptemplates` DISABLE KEYS */;
/*!40000 ALTER TABLE `traptemplates` ENABLE KEYS */;
...
--
-- Definition of vancianmagicoperations
--

DROP TABLE IF EXISTS `vancianmagicoperations`;
CREATE TABLE IF NOT EXISTS `vancianmagicoperations` (
  `Id` char(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `CharacterId` bigint NOT NULL,
  `MagicCapabilityId` bigint NOT NULL,
  `SourceItemId` bigint DEFAULT NULL,
  `DestinationItemId` bigint DEFAULT NULL,
  `Kind` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Status` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_VancianMagicOperations_CharacterId_MagicCapabilityId` (`CharacterId`,`MagicCapabilityId`),
  KEY `IX_VancianMagicOperations_DestinationItemId` (`DestinationItemId`),
  KEY `IX_VancianMagicOperations_SourceItemId` (`SourceItemId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table vancianmagicoperations
--

/*!40000 ALTER TABLE `vancianmagicoperations` DISABLE KEYS */;
/*!40000 ALTER TABLE `vancianmagicoperations` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `vehiclepropulsionprofileprotos` (
  ...
  `RiderStaminaMultiplier` double NOT NULL DEFAULT '1',
  PRIMARY KEY (`Id`),
  ...
  CONSTRAINT `CK_VehiclePropulsionProfileProtos_RiderStaminaMultiplier` CHECK ((`RiderStaminaMultiplier` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `vehiclemovementprofileprotos` (
  ...
  `MinimumEnginePowerInWatts` double NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `terrains` (
  ...
  KEY `IX_Terrains_EnvironmentalMagicProfileId` (`EnvironmentalMagicProfileId`),
...
--
-- Definition of vehicleriderstaminamodifierprotos
--

DROP TABLE IF EXISTS `vehicleriderstaminamodifierprotos`;
CREATE TABLE IF NOT EXISTS `vehicleriderstaminamodifierprotos` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `VehiclePropulsionProfileProtoId` bigint NOT NULL,
  `TerrainId` bigint DEFAULT NULL,
  `TerrainTagId` bigint DEFAULT NULL,
  `Multiplier` double NOT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `UX_VehicleRiderStaminaModifierProtos_Profile_Tag` (`VehiclePropulsionProfileProtoId`,`TerrainTagId`),
  UNIQUE KEY `UX_VehicleRiderStaminaModifierProtos_Profile_Terrain` (`VehiclePropulsionProfileProtoId`,`TerrainId`),
  KEY `FK_VehicleRiderStaminaModifierProtos_PropulsionProfiles_idx` (`VehiclePropulsionProfileProtoId`),
  KEY `FK_VehicleRiderStaminaModifierProtos_Tags_idx` (`TerrainTagId`),
  KEY `FK_VehicleRiderStaminaModifierProtos_Terrains_idx` (`TerrainId`),
  CONSTRAINT `FK_VehicleRiderStaminaModifierProtos_PropulsionProfiles` FOREIGN KEY (`VehiclePropulsionProfileProtoId`) REFERENCES `vehiclepropulsionprofileprotos` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_VehicleRiderStaminaModifierProtos_Tags` FOREIGN KEY (`TerrainTagId`) REFERENCES `tags` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_VehicleRiderStaminaModifierProtos_Terrains` FOREIGN KEY (`TerrainId`) REFERENCES `terrains` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `CK_VehicleRiderStaminaModifierProtos_Multiplier` CHECK ((`Multiplier` >= 0)),
  CONSTRAINT `CK_VehicleRiderStaminaModifierProtos_Target` CHECK ((((`TerrainId` is null) and (`TerrainTagId` is not null)) or ((`TerrainId` is not null) and (`TerrainTagId` is null))))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table vehicleriderstaminamodifierprotos
--

/*!40000 ALTER TABLE `vehicleriderstaminamodifierprotos` DISABLE KEYS */;
/*!40000 ALTER TABLE `vehicleriderstaminamodifierprotos` ENABLE KEYS */;
...
-- Instance description overrides: reviewed EF-generated delta.
START TRANSACTION;
DROP PROCEDURE IF EXISTS MigrationsScript;
DELIMITER //
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__efmigrationshistory` WHERE `MigrationId` = '20260922124142_AddGameItemDescriptionOverrides') THEN

    ALTER TABLE `gameitems` ADD `OverrideDesc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL;
...
BEGIN
    ...
    ALTER TABLE `gameitems` ADD `OverrideSdesc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL;
...
BEGIN
    ...
    INSERT INTO `__efmigrationshistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260922124142_AddGameItemDescriptionOverrides', '9.0.11');
