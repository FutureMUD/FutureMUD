...
CREATE TABLE IF NOT EXISTS `gameitems` (
  ...
  `RoutePosition` decimal(18,3) DEFAULT NULL,
  `OverrideDesc` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  `OverrideSdesc` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  PRIMARY KEY (`Id`),
...
-- Dump completed on 2026-09-26 22:06:05
-- Total time: 0:0:0:2:17 (d:h:m:s:ms)
