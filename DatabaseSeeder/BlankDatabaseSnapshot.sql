CREATE DATABASE IF NOT EXISTS `__FUTUREMUD_DATABASE__` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
ALTER TABLE `MarketPopulations` ADD `IncomeFactor` decimal(65,30) NOT NULL DEFAULT 1.0;

ALTER TABLE `MarketPopulations` ADD `Savings` decimal(65,30) NOT NULL DEFAULT 0.0;

ALTER TABLE `MarketPopulations` ADD `SavingsCap` decimal(65,30) NOT NULL DEFAULT 0.0;

ALTER TABLE `MarketInfluenceTemplates` ADD `PopulationImpacts` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `MarketInfluences` ADD `PopulationImpacts` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Celestials` MODIFY COLUMN `CelestialType` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'Sun';

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260415122407_MarketPopulationIncomeAndPricePressure', '9.0.11');

ALTER TABLE `MarketPopulations` ADD `StressFlickerThreshold` decimal(65,30) NOT NULL DEFAULT 0.01;

ALTER TABLE `MarketCategories` ADD `CombinationCategories` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `MarketCategories` ADD `MarketCategoryType` int NOT NULL DEFAULT 0;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260415225956_MarketCombinationCategoriesAndStressHysteresisReady', '9.0.11');

CREATE TABLE `CharacterComputerExecutables` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `OwnerCharacterId` bigint(20) NOT NULL,
    `OwnerHostItemId` bigint(20) NULL,
    `OwnerStorageItemId` bigint(20) NULL,
    `Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `ExecutableKind` int(11) NOT NULL,
    `CompilationContext` int(11) NOT NULL,
    `ReturnTypeDefinition` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `SourceCode` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `CompilationStatus` int(11) NOT NULL,
    `CompileError` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `CharacterComputerExecutableParameters` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `CharacterComputerExecutableId` bigint(20) NOT NULL,
    `ParameterIndex` int(11) NOT NULL,
    `ParameterName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `ParameterTypeDefinition` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`Id`),
...
CREATE TABLE `CharacterComputerProgramProcesses` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `CharacterComputerExecutableId` bigint(20) NOT NULL,
    `OwnerCharacterId` bigint(20) NOT NULL,
    `ProcessName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Status` int(11) NOT NULL,
    `WaitType` int(11) NOT NULL,
    `WakeTimeUtc` datetime NULL,
    `WaitArgument` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `PowerLossBehaviour` int(11) NOT NULL,
    `StateJson` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `ResultJson` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `LastError` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE INDEX `FK_CharacterComputerExecutableParameters_Executables_idx` ON `CharacterComputerExecutableParameters` (`CharacterComputerExecutableId`);

CREATE UNIQUE INDEX `IX_CharacterComputerExecutableParameters_Executable_Index` ON `CharacterComputerExecutableParameters` (`CharacterComputerExecutableId`, `ParameterIndex`);

CREATE INDEX `FK_CharacterComputerExecutables_Characters_idx` ON `CharacterComputerExecutables` (`OwnerCharacterId`);

CREATE INDEX `IX_CharacterComputerExecutables_Owner_Name` ON `CharacterComputerExecutables` (`OwnerCharacterId`, `Name`);

CREATE INDEX `FK_CharacterComputerProgramProcesses_Characters_idx` ON `CharacterComputerProgramProcesses` (`OwnerCharacterId`);

CREATE INDEX `FK_CharacterComputerProgramProcesses_Executables_idx` ON `CharacterComputerProgramProcesses` (`CharacterComputerExecutableId`);

CREATE INDEX `IX_CharacterComputerProgramProcesses_Owner_Status_Wake` ON `CharacterComputerProgramProcesses` (`OwnerCharacterId`, `Status`, `WakeTimeUtc`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260416225128_AddCharacterComputerWorkspace', '9.0.11');

CREATE TABLE `ComputerMailDomains` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `DomainName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `HostItemId` bigint(20) NOT NULL,
...
CREATE TABLE `ComputerMailMessages` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `SenderAddress` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `RecipientAddress` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Subject` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Body` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `SentAtUtc` datetime NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`Id`)
) CHARACTER SET=utf8mb4;

CREATE TABLE `ComputerMailAccounts` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `ComputerMailDomainId` bigint(20) NOT NULL,
    `UserName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `PasswordHash` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `PasswordSalt` bigint(20) NOT NULL,
...
CREATE TABLE `ComputerMailMailboxEntries` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `ComputerMailAccountId` bigint(20) NOT NULL,
    `ComputerMailMessageId` bigint(20) NOT NULL,
...
CREATE INDEX `FK_ComputerMailAccounts_ComputerMailDomains_idx` ON `ComputerMailAccounts` (`ComputerMailDomainId`);

CREATE UNIQUE INDEX `IX_ComputerMailAccounts_Domain_UserName` ON `ComputerMailAccounts` (`ComputerMailDomainId`, `UserName`);

CREATE INDEX `FK_ComputerMailDomains_GameItems_idx` ON `ComputerMailDomains` (`HostItemId`);

CREATE UNIQUE INDEX `IX_ComputerMailDomains_DomainName` ON `ComputerMailDomains` (`DomainName`);

CREATE INDEX `FK_ComputerMailMailboxEntries_ComputerMailAccounts_idx` ON `ComputerMailMailboxEntries` (`ComputerMailAccountId`);

CREATE INDEX `FK_ComputerMailMailboxEntries_ComputerMailMessages_idx` ON `ComputerMailMailboxEntries` (`ComputerMailMessageId`);

CREATE INDEX `IX_ComputerMailMailboxEntries_Account_Folder_Delivered` ON `ComputerMailMailboxEntries` (`ComputerMailAccountId`, `IsDeleted`, `IsSentFolder`, `DeliveredAtUtc`);

CREATE INDEX `IX_ComputerMailMessages_SentAtUtc` ON `ComputerMailMessages` (`SentAtUtc`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260418111319_AddComputerMailService', '9.0.11');

ALTER TABLE `BodypartProto` ADD `SeverFormula` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260420105205_AddBodypartSeverFormula', '9.0.11');

ALTER TABLE `Characters` ADD `CurrentProjectProjectHours` double NOT NULL DEFAULT 0.0;

CREATE TABLE `ProjectLabourQueues` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `CharacterId` bigint(20) NOT NULL,
    `ActiveProjectId` bigint(20) NOT NULL,
    `ProjectLabourRequirementId` bigint(20) NOT NULL,
    ...
    CONSTRAINT `PK_ProjectLabourQueues` PRIMARY KEY (`Id`),
...
CREATE INDEX `FK_ProjectLabourQueues_ActiveProjects_idx` ON `ProjectLabourQueues` (`ActiveProjectId`);

CREATE INDEX `FK_ProjectLabourQueues_Characters_idx` ON `ProjectLabourQueues` (`CharacterId`);

CREATE INDEX `FK_ProjectLabourQueues_ProjectLabourRequirements_idx` ON `ProjectLabourQueues` (`ProjectLabourRequirementId`);

CREATE UNIQUE INDEX `IX_ProjectLabourQueues_Character_QueueOrder` ON `ProjectLabourQueues` (`CharacterId`, `QueueOrder`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260421064024_ProjectQueueAndCancellationContinuity', '9.0.11');

ALTER TABLE `TraitDefinitions` ADD `OwnerScope` int(11) NOT NULL DEFAULT '0';

ALTER TABLE `Bodies` ADD `DominantHandAlignment` int(11) NOT NULL DEFAULT '3';

CREATE TABLE `CharacterBodies` (
    `CharacterId` bigint(20) NOT NULL,
    `BodyId` bigint(20) NOT NULL,
    `Alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `SortOrder` int(11) NOT NULL,
    `AllowVoluntarySwitch` bit(1) NOT NULL DEFAULT b'0',
    `CanVoluntarilySwitchProgId` bigint(20) NULL,
    `WhyCannotVoluntarilySwitchProgId` bigint(20) NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`CharacterId`, `BodyId`),
...
CREATE TABLE `CharacterTraits` (
    ...
    `Value` double NOT NULL,
    `AdditionalValue` double NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`CharacterId`, `TraitDefinitionId`),
...
CREATE INDEX `FK_CharacterBodies_Bodies_idx` ON `CharacterBodies` (`BodyId`);

CREATE INDEX `FK_CharacterBodies_CanVoluntarilySwitchProg_idx` ON `CharacterBodies` (`CanVoluntarilySwitchProgId`);

CREATE INDEX `FK_CharacterBodies_WhyCannotVoluntarilySwitchProg_idx` ON `CharacterBodies` (`WhyCannotVoluntarilySwitchProgId`);

CREATE INDEX `FK_CharacterTraits_TraitDefinitions` ON `CharacterTraits` (`TraitDefinitionId`);
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260422035105_Phase1MultiBodyForms', '9.0.11');

ALTER TABLE `CharacterBodies` ADD `CanSeeFormProgId` bigint(20) NULL;

CREATE TABLE `CharacterBodySources` (
    `CharacterId` bigint(20) NOT NULL,
    `SourceType` int(11) NOT NULL,
    `SourceId` bigint(20) NOT NULL,
    `SourceKey` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `BodyId` bigint(20) NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`CharacterId`, `SourceType`, `SourceId`, `SourceKey`),
...
CREATE INDEX `FK_CharacterBodies_CanSeeFormProg_idx` ON `CharacterBodies` (`CanSeeFormProgId`);

CREATE INDEX `FK_CharacterBodySources_Bodies_idx` ON `CharacterBodySources` (`BodyId`);

ALTER TABLE `CharacterBodies` ADD CONSTRAINT `FK_CharacterBodies_CanSeeFormProg` FOREIGN KEY (`CanSeeFormProgId`) REFERENCES `FutureProgs` (`Id`) ON DELETE SET NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260423090353_Phase15BodyFormProvisioning', '9.0.11');

ALTER TABLE `CharacterBodies` ADD `TraumaMode` int(11) NOT NULL DEFAULT '0';

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260423093000_CharacterBodyTraumaMode', '9.0.11');

ALTER TABLE `CharacterBodies` ADD `TransformationEcho` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260423114308_Phase15FormTransformationEcho', '9.0.11');

ALTER TABLE `Races` DROP FOREIGN KEY `FK_Races_AttributeBonusProg`;

ALTER TABLE `Races` DROP INDEX `FK_Races_AttributeBonusProg`;

ALTER TABLE `Races` DROP COLUMN `AttributeBonusProgId`;

ALTER TABLE `Races_Attributes` ADD `AttributeBonus` double NOT NULL DEFAULT 0.0;

ALTER TABLE `Races_Attributes` ADD `DiceExpression` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260424000000_RaceAttributeAlterations', '9.0.11');

ALTER TABLE `Races` ADD `MaximumDrinkSatiatedHours` double NOT NULL DEFAULT 8.0;

ALTER TABLE `Races` ADD `MaximumFoodSatiatedHours` double NOT NULL DEFAULT 16.0;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260424035904_RaceSatiationLimits', '9.0.11');

ALTER TABLE `GameItemProtos` ADD `PlanarData` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL;

ALTER TABLE `BodyProtos` ADD `PlanarData` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL;

CREATE TABLE `Planes` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `Name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Alias` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
    `Description` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `DisplayOrder` int(11) NOT NULL,
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260424040025_PlanesAndPlanarData', '9.0.11');

ALTER TABLE `Planes` ADD `RoomDescriptionAddendum` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL;

ALTER TABLE `Planes` ADD `RoomNameFormat` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260424044647_PlaneRoomPresentation', '9.0.11');

ALTER TABLE `Properties` ADD `HotelDefinition` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260425131140_HotelRoomRentals', '9.0.11');
...
CREATE TABLE `Stables` (
    ...
    `CellId` bigint(20) NOT NULL,
    `BankAccountId` bigint(20) NULL,
    `IsTrading` bit(1) NOT NULL DEFAULT 1,
    `LodgeFee` decimal(58,29) NOT NULL,
    `DailyFee` decimal(58,29) NOT NULL,
    `LodgeFeeProgId` bigint(20) NULL,
    `DailyFeeProgId` bigint(20) NULL,
    `CanStableProgId` bigint(20) NULL,
    `WhyCannotStableProgId` bigint(20) NULL,
...
CREATE TABLE `StableAccounts` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `StableId` bigint(20) NOT NULL,
    `AccountName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `AccountOwnerId` bigint(20) NOT NULL,
    `AccountOwnerName` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `StableStays` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `StableId` bigint(20) NOT NULL,
    `MountId` bigint(20) NOT NULL,
    `OriginalOwnerId` bigint(20) NOT NULL,
    `OriginalOwnerName` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `LodgedDateTime` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `LastDailyFeeDateTime` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `ClosedDateTime` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `Status` int(11) NOT NULL,
    `TicketItemId` bigint(20) NULL,
    `TicketToken` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `StableAccountUsers` (
    `StableAccountId` bigint(20) NOT NULL,
    `AccountUserId` bigint(20) NOT NULL,
    `AccountUserName` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `SpendingLimit` decimal(58,29) NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`StableAccountId`, `AccountUserId`),
...
CREATE TABLE `StableStayLedgerEntries` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `StableStayId` bigint(20) NOT NULL,
    `EntryType` int(11) NOT NULL,
    `MudDateTime` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `ActorId` bigint(20) NULL,
    `ActorName` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `Amount` decimal(58,29) NOT NULL,
...
CREATE INDEX `FK_StableAccounts_Characters_idx` ON `StableAccounts` (`AccountOwnerId`);

CREATE INDEX `FK_StableAccounts_Stables_idx` ON `StableAccounts` (`StableId`);

CREATE INDEX `FK_StableAccountUsers_Characters_idx` ON `StableAccountUsers` (`AccountUserId`);

CREATE INDEX `FK_Stables_BankAccounts_idx` ON `Stables` (`BankAccountId`);

CREATE INDEX `FK_Stables_Cells_idx` ON `Stables` (`CellId`);

CREATE INDEX `FK_Stables_EconomicZones_idx` ON `Stables` (`EconomicZoneId`);

CREATE INDEX `FK_Stables_FutureProgs_Can_idx` ON `Stables` (`CanStableProgId`);

CREATE INDEX `FK_Stables_FutureProgs_Daily_idx` ON `Stables` (`DailyFeeProgId`);

CREATE INDEX `FK_Stables_FutureProgs_Lodge_idx` ON `Stables` (`LodgeFeeProgId`);

CREATE INDEX `FK_Stables_FutureProgs_Why_idx` ON `Stables` (`WhyCannotStableProgId`);

CREATE INDEX `FK_StableStayLedgerEntries_Characters_idx` ON `StableStayLedgerEntries` (`ActorId`);

CREATE INDEX `FK_StableStayLedgerEntries_StableStays_idx` ON `StableStayLedgerEntries` (`StableStayId`);

CREATE INDEX `FK_StableStays_Characters_Mount_idx` ON `StableStays` (`MountId`);

CREATE INDEX `FK_StableStays_Characters_Owner_idx` ON `StableStays` (`OriginalOwnerId`);

CREATE INDEX `FK_StableStays_GameItems_Ticket_idx` ON `StableStays` (`TicketItemId`);

CREATE INDEX `FK_StableStays_Stables_idx` ON `StableStays` (`StableId`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260425131520_StableMountStabling', '9.0.11');

ALTER TABLE `Terrains` ADD `GravityModel` int(11) NOT NULL DEFAULT 0;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260425132107_AddTerrainGravity', '9.0.11');

UPDATE StaticStrings
SET Text = '@ transform|transforms into ^1.'
WHERE Id = 'DefaultFormTransformationEcho'
AND Text = '@ transform|transforms into $1.';

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260426114113_DefaultFormTransformationEchoNonSelf', '9.0.11');

ALTER TABLE `ProgSchedules` ADD `IntervalFallback` int(11) NOT NULL DEFAULT 0;

ALTER TABLE `ProgSchedules` ADD `IntervalOtherSecondary` int(11) NOT NULL DEFAULT 0;

ALTER TABLE `EconomicZones` ADD `IntervalFallback` int(11) NOT NULL DEFAULT 0;

ALTER TABLE `EconomicZones` ADD `IntervalOther` int(11) NOT NULL DEFAULT 0;

ALTER TABLE `Clans` ADD `PayIntervalFallback` int(11) NOT NULL DEFAULT 0;

ALTER TABLE `Clans` ADD `PayIntervalOtherSecondary` int(11) NOT NULL DEFAULT 0;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260427110022_RecurringIntervalOrdinalFields', '9.0.11');

ALTER TABLE `Planes` ADD `RemoteObservationTag` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260501090000_PlaneRemoteObservationTag', '9.0.11');

ALTER TABLE `Races` MODIFY COLUMN `YouthAge` int(11) NOT NULL;

ALTER TABLE `Races` MODIFY COLUMN `YoungAdultAge` int(11) NOT NULL;

ALTER TABLE `Races` MODIFY COLUMN `VenerableAge` int(11) NOT NULL;

ALTER TABLE `Races` MODIFY COLUMN `ElderAge` int(11) NOT NULL;

ALTER TABLE `Races` MODIFY COLUMN `ChildAge` int(11) NOT NULL;

ALTER TABLE `Races` MODIFY COLUMN `AdultAge` int(11) NOT NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260501132243_RaceAgeColumnsNoDatabaseDefaults', '9.0.11');

ALTER TABLE `Writings` DROP FOREIGN KEY `FK_Writings_Characters_Author`;

ALTER TABLE `Writings` MODIFY COLUMN `AuthorId` bigint(20) NULL;

ALTER TABLE `Writings` ADD CONSTRAINT `FK_Writings_Characters_Author` FOREIGN KEY (`AuthorId`) REFERENCES `Characters` (`Id`) ON DELETE SET NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260506102652_PrintedWritingAuthorNullable', '9.0.11');

CREATE TABLE `ClanBudgets` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `ClanId` bigint(20) NOT NULL,
    `AppointmentId` bigint(20) NOT NULL,
    `BankAccountId` bigint(20) NOT NULL,
    ...
    `PeriodIntervalType` int(11) NOT NULL,
    `PeriodIntervalModifier` int(11) NOT NULL,
    `PeriodIntervalOther` int(11) NOT NULL,
    `PeriodIntervalOtherSecondary` int(11) NOT NULL,
    `PeriodIntervalFallback` int(11) NOT NULL,
    `CurrentPeriodStart` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `CurrentPeriodEnd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    ...
    CONSTRAINT `FK_ClanBudgets_BankAccounts` FOREIGN KEY (`BankAccountId`) REFERENCES `BankAccounts` (`Id`) ON DELETE CASCADE,
...
CREATE TABLE `ClanPayrollHistories` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `ClanId` bigint(20) NOT NULL,
    `CharacterId` bigint(20) NOT NULL,
    `RankId` bigint(20) NOT NULL,
...
CREATE TABLE `ClanBudgetTransactions` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `ClanBudgetId` bigint(20) NOT NULL,
    `ActorId` bigint(20) NOT NULL,
    `BankAccountId` bigint(20) NOT NULL,
    `CurrencyId` bigint(20) NOT NULL,
    `Amount` decimal(58,29) NOT NULL,
    `TransactionTime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `PeriodStart` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `PeriodEnd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `BankBalanceAfter` decimal(58,29) NOT NULL,
    `Reason` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`Id`),
    CONSTRAINT `FK_ClanBudgetTransactions_BankAccounts` FOREIGN KEY (`BankAccountId`) REFERENCES `BankAccounts` (`Id`) ON DELETE CASCADE,
...
CREATE INDEX `FK_ClanBudgets_Appointments_idx` ON `ClanBudgets` (`AppointmentId`);

CREATE INDEX `FK_ClanBudgets_BankAccounts_idx` ON `ClanBudgets` (`BankAccountId`);

CREATE INDEX `FK_ClanBudgets_Clans_idx` ON `ClanBudgets` (`ClanId`);

CREATE INDEX `FK_ClanBudgets_Currencies_idx` ON `ClanBudgets` (`CurrencyId`);

CREATE INDEX `FK_ClanBudgetTransactions_Actors_idx` ON `ClanBudgetTransactions` (`ActorId`);

CREATE INDEX `FK_ClanBudgetTransactions_BankAccounts_idx` ON `ClanBudgetTransactions` (`BankAccountId`);

CREATE INDEX `FK_ClanBudgetTransactions_Budgets_idx` ON `ClanBudgetTransactions` (`ClanBudgetId`);

CREATE INDEX `FK_ClanBudgetTransactions_Currencies_idx` ON `ClanBudgetTransactions` (`CurrencyId`);

CREATE INDEX `FK_ClanPayrollHistories_Actors_idx` ON `ClanPayrollHistories` (`ActorId`);

CREATE INDEX `FK_ClanPayrollHistories_Appointments_idx` ON `ClanPayrollHistories` (`AppointmentId`);

CREATE INDEX `FK_ClanPayrollHistories_Characters_idx` ON `ClanPayrollHistories` (`CharacterId`);

CREATE INDEX `FK_ClanPayrollHistories_Clans_idx` ON `ClanPayrollHistories` (`ClanId`);

CREATE INDEX `FK_ClanPayrollHistories_Currencies_idx` ON `ClanPayrollHistories` (`CurrencyId`);

CREATE INDEX `FK_ClanPayrollHistories_Paygrades_idx` ON `ClanPayrollHistories` (`PaygradeId`);

CREATE INDEX `FK_ClanPayrollHistories_Ranks_idx` ON `ClanPayrollHistories` (`RankId`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260506103358_ClanBudgetsAndPayrollHistory', '9.0.11');

ALTER TABLE `AuctionHouses` DROP FOREIGN KEY `FK_AuctionHouses_BankAccounts`;

ALTER TABLE `AuctionHouses` MODIFY COLUMN `ProfitsBankAccountId` bigint(20) NULL;

CREATE TABLE `VirtualCashBalances` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `OwnerType` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `OwnerId` bigint(20) NOT NULL,
    `CurrencyId` bigint(20) NOT NULL,
    `Balance` decimal(58,29) NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`Id`),
...
CREATE TABLE `VirtualCashLedgerEntries` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `OwnerType` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `OwnerId` bigint(20) NOT NULL,
    `CurrencyId` bigint(20) NOT NULL,
    ...
    `ActorId` bigint(20) NULL,
    `ActorName` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `CounterpartyId` bigint(20) NULL,
    `CounterpartyType` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `CounterpartyName` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `Amount` decimal(58,29) NOT NULL,
    `BalanceAfter` decimal(58,29) NOT NULL,
    `SourceKind` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `DestinationKind` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `LinkedBankAccountId` bigint(20) NULL,
    `ReferenceType` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE INDEX `FK_VirtualCashBalances_Currencies_idx` ON `VirtualCashBalances` (`CurrencyId`);

CREATE UNIQUE INDEX `IX_VirtualCashBalances_Owner_Currency` ON `VirtualCashBalances` (`OwnerType`, `OwnerId`, `CurrencyId`);

CREATE INDEX `FK_VirtualCashLedgerEntries_BankAccounts_idx` ON `VirtualCashLedgerEntries` (`LinkedBankAccountId`);

CREATE INDEX `FK_VirtualCashLedgerEntries_Currencies_idx` ON `VirtualCashLedgerEntries` (`CurrencyId`);

CREATE INDEX `IX_VirtualCashLedgerEntries_Owner_Date` ON `VirtualCashLedgerEntries` (`OwnerType`, `OwnerId`, `RealDateTime`);

ALTER TABLE `AuctionHouses` ADD CONSTRAINT `FK_AuctionHouses_BankAccounts` FOREIGN KEY (`ProfitsBankAccountId`) REFERENCES `BankAccounts` (`Id`) ON DELETE SET NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260507091523_VirtualCashLedgerAndBanklessSettlement', '9.0.11');

ALTER TABLE `ClanBudgets` DROP FOREIGN KEY `FK_ClanBudgets_BankAccounts`;

ALTER TABLE `ClanBudgetTransactions` DROP FOREIGN KEY `FK_ClanBudgetTransactions_BankAccounts`;

ALTER TABLE `ClanBudgetTransactions` MODIFY COLUMN `BankAccountId` bigint(20) NULL;

ALTER TABLE `ClanBudgets` MODIFY COLUMN `BankAccountId` bigint(20) NULL;

ALTER TABLE `ClanBudgets` ADD CONSTRAINT `FK_ClanBudgets_BankAccounts` FOREIGN KEY (`BankAccountId`) REFERENCES `BankAccounts` (`Id`) ON DELETE SET NULL;

ALTER TABLE `ClanBudgetTransactions` ADD CONSTRAINT `FK_ClanBudgetTransactions_BankAccounts` FOREIGN KEY (`BankAccountId`) REFERENCES `BankAccounts` (`Id`) ON DELETE SET NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260507092824_ClanBudgetVirtualTreasuryFallback', '9.0.11');

ALTER TABLE `PatrolRoutes` ADD `StrategyData` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260510212610_PatrolRouteStrategyData', '9.0.11');

CREATE TABLE `ManualCombatCommands` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    ...
    `WeaponAttackId` bigint(20) NULL,
    `CombatActionId` bigint(20) NULL,
    ...
    CONSTRAINT `PK_ManualCombatCommands` PRIMARY KEY (`Id`),
...
CREATE TABLE `CharacterCombatSettings_ManualCombatCommands` (
    `CharacterCombatSettingId` bigint(20) NOT NULL,
    `ManualCombatCommandId` bigint(20) NOT NULL,
    `WeightMultiplier` double NOT NULL DEFAULT '1',
    CONSTRAINT `PRIMARY` PRIMARY KEY (`CharacterCombatSettingId`, `ManualCombatCommandId`),
...
CREATE INDEX `FK_CCS_ManualCombatCommands_ManualCombatCommands_idx` ON `CharacterCombatSettings_ManualCombatCommands` (`ManualCombatCommandId`);

CREATE INDEX `FK_ManualCombatCommands_CombatActions_idx` ON `ManualCombatCommands` (`CombatActionId`);

CREATE INDEX `FK_ManualCombatCommands_FutureProgs_idx` ON `ManualCombatCommands` (`UsabilityProgId`);

CREATE INDEX `FK_ManualCombatCommands_WeaponAttacks_idx` ON `ManualCombatCommands` (`WeaponAttackId`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260513234412_ManualCombatCommands', '9.0.11');

ALTER TABLE `Terrains` ADD `DefaultAgricultureFieldProfileId` bigint(20) NULL;

CREATE TABLE `AgricultureCropDefinitions` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `Name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `AgricultureFieldProfiles` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `Name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Description` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Definition` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `AgricultureHerdDefinitions` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `Name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Description` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Definition` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `NpcTemplateId` bigint(20) NULL,
    `NpcTemplateRevisionNumber` int(11) NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`Id`),
...
CREATE TABLE `AgricultureOperations` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `Name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Description` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `OperationType` int(11) NOT NULL,
    `TargetType` int(11) NOT NULL,
    `RequiredUse` int(11) NOT NULL,
    `ResultUse` int(11) NOT NULL,
    `ProjectId` bigint(20) NOT NULL,
    `ProjectRevisionNumber` int(11) NOT NULL,
    `CompletionProgId` bigint(20) NULL,
    `Definition` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `AgricultureWoodlandDefinitions` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `Name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Description` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `WoodlandType` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `Definition` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`Id`)
) CHARACTER SET=utf8mb4;

CREATE TABLE `AgricultureFields` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `CellId` bigint(20) NOT NULL,
    ...
    `LastTickMudDateTime` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `Definition` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`Id`),
...
CREATE TABLE `AgricultureFieldCrops` (
    `AgricultureFieldId` bigint(20) NOT NULL,
    `CropDefinitionId` bigint(20) NOT NULL,
    `Stage` int(11) NOT NULL,
    `GrowthDays` int(11) NOT NULL,
    `Health` int(11) NOT NULL,
    `YieldPotential` int(11) NOT NULL,
    `PlantedMudDateTime` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `Definition` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`AgricultureFieldId`),
...
CREATE TABLE `AgricultureFieldHerds` (
    `Id` bigint(20) NOT NULL AUTO_INCREMENT,
    `AgricultureFieldId` bigint(20) NOT NULL,
    `HerdDefinitionId` bigint(20) NOT NULL,
...
CREATE TABLE `AgricultureFieldWoodlands` (
    `AgricultureFieldId` bigint(20) NOT NULL,
    `WoodlandDefinitionId` bigint(20) NOT NULL,
    `GrowthDays` int(11) NOT NULL,
    `Health` int(11) NOT NULL,
    `YieldPotential` int(11) NOT NULL,
    `PlantedMudDateTime` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `AgricultureProjectContexts` (
    `ActiveProjectId` bigint(20) NOT NULL,
    `AgricultureFieldId` bigint(20) NOT NULL,
    `OperationId` bigint(20) NOT NULL,
    `TargetType` int(11) NOT NULL,
    `TargetId` bigint(20) NULL,
    `TargetText` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
    `ActorId` bigint(20) NULL,
    `Definition` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    CONSTRAINT `PRIMARY` PRIMARY KEY (`ActiveProjectId`),
...
CREATE INDEX `FK_Terrains_AgricultureFieldProfiles_idx` ON `Terrains` (`DefaultAgricultureFieldProfileId`);

CREATE INDEX `FK_AgricultureFieldCrops_Crops_idx` ON `AgricultureFieldCrops` (`CropDefinitionId`);

CREATE INDEX `FK_AgricultureFieldHerds_Fields_idx` ON `AgricultureFieldHerds` (`AgricultureFieldId`);

CREATE INDEX `FK_AgricultureFieldHerds_Herds_idx` ON `AgricultureFieldHerds` (`HerdDefinitionId`);

CREATE INDEX `FK_AgricultureFields_Profiles_idx` ON `AgricultureFields` (`ProfileId`);

CREATE UNIQUE INDEX `IX_AgricultureFields_CellId` ON `AgricultureFields` (`CellId`);

CREATE INDEX `FK_AgricultureFieldWoodlands_Woodlands_idx` ON `AgricultureFieldWoodlands` (`WoodlandDefinitionId`);

CREATE INDEX `FK_AgricultureHerdDefinitions_NpcTemplates_idx` ON `AgricultureHerdDefinitions` (`NpcTemplateId`, `NpcTemplateRevisionNumber`);

CREATE INDEX `FK_AgricultureOperations_FutureProgs_idx` ON `AgricultureOperations` (`CompletionProgId`);

CREATE INDEX `FK_AgricultureOperations_Projects_idx` ON `AgricultureOperations` (`ProjectId`, `ProjectRevisionNumber`);

CREATE INDEX `FK_AgricultureProjectContexts_Actors_idx` ON `AgricultureProjectContexts` (`ActorId`);

CREATE INDEX `FK_AgricultureProjectContexts_Fields_idx` ON `AgricultureProjectContexts` (`AgricultureFieldId`);

CREATE INDEX `FK_AgricultureProjectContexts_Operations_idx` ON `AgricultureProjectContexts` (`OperationId`);
