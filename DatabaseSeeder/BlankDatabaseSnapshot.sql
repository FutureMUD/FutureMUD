...
--
-- Table structure for table `CharacterBodies`
--
...
LOCK TABLES `CharacterBodySources` WRITE;
...
--
-- Table structure for table `CharacterComputerExecutableParameters`
--
...
LOCK TABLES `CharacterComputerExecutableParameters` WRITE;
...
--
-- Table structure for table `CharacterComputerExecutables`
--
...
LOCK TABLES `CharacterComputerProgramProcesses` WRITE;
...
--
-- Table structure for table `ComputerMailAccounts`
--
...
LOCK TABLES `ComputerMailMessages` WRITE;
...
--
-- Table structure for table `ManualCombatCommands`
--
...
LOCK TABLES `ManualCombatCommands` WRITE;
/*!40000 ALTER TABLE `ManualCombatCommands` DISABLE KEYS */;
/*!40000 ALTER TABLE `ManualCombatCommands` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `CharacterCombatSettings_ManualCombatCommands`
--
...
LOCK TABLES `CharacterCombatSettings_ManualCombatCommands` WRITE;
...
--
-- Table structure for table `ProjectLabourQueues`
--
...
LOCK TABLES `ProjectLabourQueues` WRITE;
...
CREATE TABLE `Properties` (
  ...
  `HotelDefinition` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  PRIMARY KEY (`Id`),
...
--
-- Table structure for table `StableAccounts`
--
...
LOCK TABLES `StableAccountUsers` WRITE;
...
--
-- Table structure for table `StableStayLedgerEntries`
--
...
-- Dump completed on 2026-05-01 21:16:27
