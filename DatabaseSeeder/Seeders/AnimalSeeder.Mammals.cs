...
public partial class AnimalSeeder
{
	private static IEnumerable<AnimalRaceTemplate> GetMammalRaceTemplates()
	{
		...
		var udder = new List<AnimalBodypartUsageTemplate> { new("udder", "female") };
		var hornedMale = new List<AnimalBodypartUsageTemplate> { new("rhorn", "male"), new("lhorn", "male") };
		var hornedFemale = new List<AnimalBodypartUsageTemplate> { new("udder", "female"), new("rhorn", "male"), new("lhorn", "male") };
		var antlered = new List<AnimalBodypartUsageTemplate> { new("udder", "female"), new("rantler", "male"), new("lantler", "male") };
		var tuskedMale = new List<AnimalBodypartUsageTemplate> { new("rtusk", "male"), new("ltusk", "male") };
		var tuskedGeneral = new List<AnimalBodypartUsageTemplate> { new("rtusk", "general"), new("ltusk", "general") };
		var rhinoHorn = new List<AnimalBodypartUsageTemplate> { new("udder", "female"), new("horn", "general") };
		...
		yield return Mammal("Dog", "Canine", "Toed Quadruped", SizeCategory.Small, 0.8, "Small Canid",
			...
			MammalPack("a puppy", "a young dog", "a young dog", "a dog", "a bitch",
				...
				"farmsteads, roads and human settlements") with { AddDogBreedDescriptions = true },
		...
		yield return Mammal("Cat", "Feline", "Toed Quadruped", SizeCategory.Small, 0.5, "Domestic Cat",
			...
			MammalPack("a kitten", "a young tomcat", "a young cat", "a tomcat", "a cat",
				...
				"hearths, rooftops and the edges of human habitation") with { UseCatCoatDescriptions = true },
		...
		yield return Mammal("Sheep", "Ovine", "Ungulate", SizeCategory.Normal, 0.8, "Small Ungulate",
			...
			"Sheep", bloodProfile: "ovine", usages: hornedFemale);
		...
		yield return Mammal("Cow", "Bovine", "Ungulate", SizeCategory.Large, 1.5, "Large Ungulate",
			...
			"Cows", bloodProfile: "bovine", usages: hornedFemale);
		...
		yield return Mammal("Horse", "Equine", "Ungulate", SizeCategory.Large, 1.5, "Horse",
			...
			"Horse", canClimb: false, bloodProfile: "equine", usages: udder);
		yield return Mammal("Rhinocerous", "Ceratorhine", "Ungulate", SizeCategory.Large, 1.5, "Pachyderm",
			...
			"Rhinocerouses", usages: rhinoHorn);
		yield return Mammal("Hippopotamus", "Hippopotamine", "Ungulate", SizeCategory.Large, 1.5, "Pachyderm",
			...
			"Hippopotamuses", usages: tuskedGeneral);
		yield return Mammal("Elephant", "Elephantine", "Ungulate", SizeCategory.VeryLarge, 2.0, "Pachyderm",
			...
			"Elephants", usages: tuskedGeneral);
