...
public partial class AnimalSeeder
{
	...
	private static (double FoodHours, double DrinkHours) GetAnimalSatiationCadence(AnimalRaceTemplate template)
	{
		return template.Name switch
		{
			...
			"Capybara" or "Platypus" => (8.0, 12.0),
			"Cat" or "Fox" or "Jackal" or "Red Panda" => (12.0, 6.0),
			"Dog" or "Coyote" or "Hyena" or "Dingo" => (16.0, 8.0),
			"Wolf" or "Lion" or "Tiger" or "Sabretooth Tiger" or "Cheetah" or "Leopard" or "Panther" or "Jaguar" => (24.0, 12.0),
			"Bear" => (72.0, 24.0),
			"Giant Panda" => (18.0, 12.0),
			...
			"Macaque" or "Sloth" or "Koala" or "Wombat" or "Kangaroo" or "Wallaby" or "Tapir" => (10.0, 6.0),
			"Anteater" or "Armadillo" or "Tasmanian Devil" => (12.0, 6.0),
			...
			"Hummingbird" => (1.0, 1.0),
			"Pigeon" or "Parrot" or "Quail" or "Duck" or "Grouse" or "Pheasant" or "Chicken" or "Seagull" or "Crow" or "Raven" or "Woodpecker" or "Kingfisher" or "Macaw" or "Toucan" or "Cockatoo" or "Kookaburra" or "Lyrebird" or "Kiwi" => (6.0, 4.0),
			"Goose" or "Swan" or "Turkey" or "Heron" or "Crane" or "Flamingo" or "Peacock" or "Ibis" or "Pelican" or "Stork" or "Penguin" or "Mandarin Duck" or "Red-Crowned Crane" or "Hoatzin" => (10.0, 8.0),
			"Albatross" => (18.0, 16.0),
			"Emu" or "Ostrich" or "Moa" or "Rhea" or "Cassowary" => (12.0, 8.0),
			"Vulture" or "Condor" => (72.0, 12.0),
			...
			"Lizard" or "Gecko" or "Skink" or "Chameleon" or "Frilled Lizard" or "Thorny Devil" or "Blue-Tongued Skink" or "Bearded Dragon" or "Basilisk Lizard" => (168.0, 72.0),
			"Iguana" or "Monitor Lizard" or "Komodo Dragon" or "Tegu" or "Gila Monster" => (336.0, 96.0),
			"Turtle" => (720.0, 336.0),
			"Tortoise" => (1440.0, 720.0),
			"Crocodile" or "Alligator" or "Caiman" => (720.0, 240.0),
    ...
    private static Dictionary<string, AnimalHeightWeightTemplate> BuildHeightWeightTemplates()
    {
        ...
        return new Dictionary<string, AnimalHeightWeightTemplate>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Primate"] = Model("Primate", 55, 2.75, 45, 4.5),
            ["Capybara"] = Model("Capybara", 55, 2.75, 95, 9.5),
            ["Sloth"] = Model("Sloth", 60, 3.0, 32, 3.2),
            ["Anteater"] = Model("Anteater", 90, 4.5, 55, 5.5),
            ["Armadillo"] = Model("Armadillo", 30, 1.5, 45, 4.5),
            ...
            ["Kangaroo"] = Model("Kangaroo", 130, 6.5, 38, 3.8),
            ["Koala"] = Model("Koala", 60, 3.0, 32, 3.2),
            ["Wombat"] = Model("Wombat", 40, 2.0, 85, 8.5),
            ["Pachyderm"] = Model("Pachyderm", 220, 11, 410, 41),
            ["Oliphant"] = Model("Oliphant", 420, 21, 520, 52),
