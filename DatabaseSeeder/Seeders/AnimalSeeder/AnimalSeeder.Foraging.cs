	...
	private static readonly IReadOnlyDictionary<string, StockNonHumanDietProfile[]> AnimalDietOverrides =
		new ReadOnlyDictionary<string, StockNonHumanDietProfile[]>(
			new Dictionary<string, StockNonHumanDietProfile[]>(StringComparer.OrdinalIgnoreCase)
			{
				...
				["Giant Panda"] = [StockNonHumanDietProfile.Browser, StockNonHumanDietProfile.GeneralHerbivore],
				["Red Panda"] = [StockNonHumanDietProfile.Browser, StockNonHumanDietProfile.Omnivore],
				["Macaque"] = [StockNonHumanDietProfile.Omnivore, StockNonHumanDietProfile.GeneralHerbivore],
				["Capybara"] = [StockNonHumanDietProfile.Grazer, StockNonHumanDietProfile.AquaticOmnivore],
				["Sloth"] = [StockNonHumanDietProfile.Browser],
				["Anteater"] = [StockNonHumanDietProfile.Insectivore],
				["Armadillo"] = [StockNonHumanDietProfile.Insectivore, StockNonHumanDietProfile.ScavengerOmnivore],
				...
				["Tapir"] = [StockNonHumanDietProfile.Browser, StockNonHumanDietProfile.Grazer],
				["Kangaroo"] = [StockNonHumanDietProfile.Grazer, StockNonHumanDietProfile.Browser],
				["Wallaby"] = [StockNonHumanDietProfile.Grazer, StockNonHumanDietProfile.Browser],
				["Koala"] = [StockNonHumanDietProfile.Browser],
				["Wombat"] = [StockNonHumanDietProfile.Grazer, StockNonHumanDietProfile.Browser],
				["Platypus"] = [StockNonHumanDietProfile.Insectivore, StockNonHumanDietProfile.Piscivore, StockNonHumanDietProfile.AquaticOmnivore],
				...
				["Mandarin Duck"] = [StockNonHumanDietProfile.AquaticOmnivore, StockNonHumanDietProfile.Grazer],
				["Red-Crowned Crane"] = [StockNonHumanDietProfile.Omnivore, StockNonHumanDietProfile.Piscivore],
				["Macaw"] = [StockNonHumanDietProfile.GeneralHerbivore, StockNonHumanDietProfile.Nectarivore, StockNonHumanDietProfile.Omnivore],
				["Toucan"] = [StockNonHumanDietProfile.Omnivore],
				["Hummingbird"] = [StockNonHumanDietProfile.Nectarivore, StockNonHumanDietProfile.Insectivore],
				["Condor"] = [StockNonHumanDietProfile.Carnivore, StockNonHumanDietProfile.ScavengerOmnivore],
				["Rhea"] = [StockNonHumanDietProfile.GeneralHerbivore, StockNonHumanDietProfile.Omnivore],
				["Hoatzin"] = [StockNonHumanDietProfile.Browser, StockNonHumanDietProfile.GeneralHerbivore],
				["Cockatoo"] = [StockNonHumanDietProfile.GeneralHerbivore, StockNonHumanDietProfile.Omnivore],
				["Kookaburra"] = [StockNonHumanDietProfile.Carnivore, StockNonHumanDietProfile.Insectivore],
				["Cassowary"] = [StockNonHumanDietProfile.GeneralHerbivore, StockNonHumanDietProfile.Omnivore],
				["Lyrebird"] = [StockNonHumanDietProfile.Insectivore, StockNonHumanDietProfile.Omnivore],
				["Kiwi"] = [StockNonHumanDietProfile.Insectivore],
				...
				["Chameleon"] = [StockNonHumanDietProfile.Insectivore],
				["Komodo Dragon"] = [StockNonHumanDietProfile.Carnivore, StockNonHumanDietProfile.ScavengerOmnivore],
				["Tegu"] = [StockNonHumanDietProfile.Omnivore, StockNonHumanDietProfile.Carnivore],
				["Caiman"] = [StockNonHumanDietProfile.Carnivore, StockNonHumanDietProfile.Piscivore],
				["Frilled Lizard"] = [StockNonHumanDietProfile.Insectivore],
				["Thorny Devil"] = [StockNonHumanDietProfile.Insectivore],
				["Blue-Tongued Skink"] = [StockNonHumanDietProfile.Insectivore, StockNonHumanDietProfile.GeneralHerbivore],
				["Bearded Dragon"] = [StockNonHumanDietProfile.Insectivore, StockNonHumanDietProfile.GeneralHerbivore],
				["Gila Monster"] = [StockNonHumanDietProfile.Carnivore, StockNonHumanDietProfile.Insectivore],
				["Basilisk Lizard"] = [StockNonHumanDietProfile.Insectivore],
