...
This package can be run multiple times as I add more options.";
        ...
        IReadOnlyDictionary<string, string> questionAnswers)
    {
        ...
        context.SaveChanges();
        FutureProg isFemaleProg = context.FutureProgs.First(x => x.FunctionName == "IsFemale");
        int rankNumber = 0;
        long memberPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
                                 ClanPrivilegeType.CanViewClanOfficeHolders | ClanPrivilegeType.CanViewMembers);
        long retainerPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
                                   ClanPrivilegeType.CanViewClanOfficeHolders | ClanPrivilegeType.CanViewMembers |
        ...
        Rank esquireRank = rank;

        long knightPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
                                 ClanPrivilegeType.CanViewClanOfficeHolders | ClanPrivilegeType.CanViewMembers |
        ...
        long higherknightPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
                                 ClanPrivilegeType.CanViewClanOfficeHolders | ClanPrivilegeType.CanViewMembers |
                                 ClanPrivilegeType.CanAccessLeasedProperties |
                                 ClanPrivilegeType.UseClanProperty |
                                 ClanPrivilegeType.CanInduct | ClanPrivilegeType.CanChangeRankPath |
        ...
        long nobilityPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
                                 ClanPrivilegeType.CanViewClanOfficeHolders | ClanPrivilegeType.CanViewMembers |
                                 ClanPrivilegeType.CanAccessLeasedProperties |
                                 ClanPrivilegeType.UseClanProperty |
                                 ClanPrivilegeType.CanInduct | ClanPrivilegeType.CanChangeRankPath |
        ...
        IReadOnlyDictionary<string, string> questionAnswers)
    {
        ...
        long seniorPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
                                 ClanPrivilegeType.CanViewClanOfficeHolders | ClanPrivilegeType.CanViewMembers |
                                 ClanPrivilegeType.CanAccessLeasedProperties |
                                 ClanPrivilegeType.UseClanProperty |
                                 ClanPrivilegeType.CanInduct | ClanPrivilegeType.CanChangeRankPath |
        ...
        IReadOnlyDictionary<string, string> questionAnswers)
    {
        ...
        foreach (Rank? paidrank in clan.Ranks.Where(x =>
                     ...
                     !x.Name.Contains("Centurio", StringComparison.InvariantCultureIgnoreCase)))
        {
            if (!paidrank.Name.In("Pedes", "Tessarius Cohortis"))
            {
                continue;
            }
        ...
        foreach (Rank? paidrank in clan.Ranks.Where(x =>
                     ...
                     !x.Name.Contains("Centurio", StringComparison.InvariantCultureIgnoreCase)))
        {
            if (!paidrank.Name.In("Legio", "Tessarius"))
            {
                continue;
            }
        ...
        foreach (Rank? paidrank in clan.Ranks.Where(x =>
                     ...
                     !x.Name.Contains("Centurio", StringComparison.InvariantCultureIgnoreCase)))
        {
            if (!paidrank.Name.In("Gregalis", "Sesquiplicarius "))
            {
                continue;
            }
        ...
        IReadOnlyDictionary<string, string> questionAnswers)
    {
        ...
        long juniorPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
        ...
        long topPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
                              ClanPrivilegeType.CanViewClanOfficeHolders |
                              ClanPrivilegeType.CanViewMembers |
                              ClanPrivilegeType.CanAccessLeasedProperties |
                              ClanPrivilegeType.UseClanProperty |
        ...
        {
            Rank = ranks["Chief Superintendent"],
            Order = 0,
            FutureProg = prog,
            Title = "Detective Chief Superintendent"
        });
    ...
    private void SetupMilitaryClan(FuturemudDatabaseContext context,
        IReadOnlyDictionary<string, string> questionAnswers)
    {
        Clan? existingClan = context.Clans.FirstOrDefault(x => x.Name == "Army Template");
    ...
    private void SetupRomanCity(FuturemudDatabaseContext context, IReadOnlyDictionary<string, string> questionAnswers)
    {
        ...
        FutureProg isMaleProg = context.FutureProgs.First(x => x.FunctionName == "IsMale");
        FutureProg isFemaleProg = context.FutureProgs.First(x => x.FunctionName == "IsFemale");
        ...
        long civesPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
                                ClanPrivilegeType.CanViewClanOfficeHolders | ClanPrivilegeType.CanViewMembers |
                                ClanPrivilegeType.CanAccessLeasedProperties | ClanPrivilegeType.UseClanProperty |
                                ClanPrivilegeType.CanReportDead);
        ...
        FutureProg isPatricianProg = new()
        {
        ...
        context.SaveChanges();
        FutureProg isPatricianMaleProg = new()
        {
        ...
        context.SaveChanges();
        FutureProg isNotPatricianProg = new()
        {
        ...
        long senatorialPrivs = (long)(ClanPrivilegeType.CanViewClanStructure |
                                     ClanPrivilegeType.CanViewClanOfficeHolders | ClanPrivilegeType.CanViewMembers |
                                     ClanPrivilegeType.CanAccessLeasedProperties | ClanPrivilegeType.UseClanProperty |
                                     ClanPrivilegeType.CanReportDead |
