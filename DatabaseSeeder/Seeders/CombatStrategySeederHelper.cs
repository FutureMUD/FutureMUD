...
internal static class CombatStrategySeederHelper
{
	...
	{
		var existing = context.CharacterCombatSettings.FirstOrDefault(x => x.Name == strategyName);
		...
		var humanoidProg = context.FutureProgs.First(x => x.FunctionName == "IsHumanoid");
