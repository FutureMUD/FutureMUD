...
public partial class CoreDataSeeder : IDatabaseSeeder
{
	...
	public string SeedData(FuturemudDatabaseContext context, IReadOnlyDictionary<string, string> questionAnswers)
	{
        ...
        // Email Templates
        string gameName = questionAnswers["gamename"];
        string condensedGameName = gameName.Pascalize();
        ...
        // Progs
        SeedCoreProgs(context, out FutureProg? isadminprog, out FutureProg? cancreateclanprog, out FutureProg? oncreateclanprog);
        ...
        GameItemComponentProto holdablecomp = new()
        {
            Name = "Holdable",
            Type = "Holdable",
            RevisionNumber = 0,
        ...
        GameItemComponentProto currencycomp = new()
        {
            Name = "CurrencyPile",
            Type = "Currency Pile",
            RevisionNumber = 0,
        ...
        GameItemProto currencyItem = new()
        {
            Id = 1,
            RevisionNumber = 0,
            Name = "Currency",
        ...
        GameItemComponentProto corpseComponent = new()
        {
            Name = "Corpse",
            Type = "Corpse",
            RevisionNumber = 0,
        ...
        GameItemComponentProto bodypartComponent = new()
        {
            Name = "Bodypart",
            Type = "Bodypart",
            RevisionNumber = 0,
        ...
        GameItemProto bodypartItem = new()
        {
            Id = 3,
            RevisionNumber = 0,
            Name = "Bodypart",
        ...
        GameItemComponentProto activeCraftComp = new()
        {
            Name = "ActiveCraft",
            Type = "ActiveCraft",
            RevisionNumber = 0,
        ...
        GameItemProto activeCraftItem = new()
        {
            Id = 4,
            RevisionNumber = 0,
            Name = "ActiveCraft",
        ...
        GameItemComponentProto pileComp = new()
        {
            Name = "Pile",
            Type = "Pile",
            RevisionNumber = 0,
        ...
        GameItemComponentProto commodityComp = new()
        {
            Name = "Commodity",
            Type = "Commodity",
            RevisionNumber = 0,
        ...
        GameItemProto commodityItem = new()
        {
            Id = 6,
            RevisionNumber = 0,
            Name = "pile",
   ...
   <ItemName>items</ItemName>
        ...
        // Add guest lounge
        CellOverlayPackage package = new()
        {
        ...
        SkyDescriptionTemplate skyTemplate = new()
        {
            Id = 1,
            Name = "OOC Sky"
        };
        ...
        SkyDescriptionTemplate earthSkyTemplate = new()
        {
            Id = 2,
            Name = "Earth's Sky"
        };
        ...
        CharacteristicDefinition chardef = new()
        {
...
9) Sets up units of measure";
    ...
    private static void SeedSocials(FuturemudDatabaseContext context)
    {
        ...
        {
            Name = "bow",
            NoTargetEcho = "@ bow|bows",
            OneTargetEcho = "@ bow|bows to $1",
            DirectionTargetEcho = "@ bow|bows towards {0}",
            MultiTargetEcho = "@ bow|bows to {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "chuckle",
            NoTargetEcho = "@ chuckle|chuckles",
            OneTargetEcho = "@ chuckle|chuckles at $1",
            DirectionTargetEcho = null,
            MultiTargetEcho = "@ chuckle|chuckles at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "cough",
            NoTargetEcho = "@ cough|coughs",
            OneTargetEcho = "@ cough|coughs at $1",
            DirectionTargetEcho = "@ cough|coughs towards {0}",
            MultiTargetEcho = "@ cough|coughs at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "frown",
            NoTargetEcho = "@ frown|frowns",
            OneTargetEcho = "@ frown|frowns at $1",
            DirectionTargetEcho = "@ frown|frowns towards {0}",
            MultiTargetEcho = "@ frown|frowns at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "gan",
            NoTargetEcho = "@ grin|grins and nod|nods",
            OneTargetEcho = "@ grin|grins and nod|nods at $1",
            DirectionTargetEcho = null,
            MultiTargetEcho = "@ grin|grins and nod|nods to {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "gasp",
            NoTargetEcho = "@ gasp|gasps",
            OneTargetEcho = "@ gasp|gasps at $1",
            DirectionTargetEcho = "@ gasp|gasps towards {0}",
            MultiTargetEcho = "@ gasp|gasps at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "glare",
            NoTargetEcho = "@ glare|glares",
            OneTargetEcho = "@ glare|glares at $1",
            DirectionTargetEcho = "@ glare|glares towards {0}",
            MultiTargetEcho = "@ glare|glares at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "grin",
            NoTargetEcho = "@ grin|grins",
            OneTargetEcho = "@ grin|grins at $1",
            DirectionTargetEcho = null,
            MultiTargetEcho = "@ grin|grins at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "grunt",
            NoTargetEcho = "@ grunt|grunts",
            OneTargetEcho = "@ grunt|grunts at $1",
            DirectionTargetEcho = "@ grunt|grunts towards {0}",
            MultiTargetEcho = "@ grunt|grunts at {0} collectively"
        });
        context.Socials.Add(new Social
        {
            Name = "hug",
            NoTargetEcho = "",
            OneTargetEcho = "@ hug|hugs $1",
            DirectionTargetEcho = null,
        ...
        {
            Name = "laugh",
            NoTargetEcho = "@ laugh|laughs",
            OneTargetEcho = "@ laugh|laughs at $1",
            DirectionTargetEcho = null,
            MultiTargetEcho = "@ laugh|laughs at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "nod",
            NoTargetEcho = "@ nod|nods",
            OneTargetEcho = "@ nod|nods to $1",
            DirectionTargetEcho = "@ nod|nods towards {0}",
            MultiTargetEcho = "@ nod|nods to {0} each in turn"
        });
        context.Socials.Add(new Social
        {
            Name = "pet",
            NoTargetEcho = "",
            OneTargetEcho = "@ pet|pets $1 affectionately",
            DirectionTargetEcho = null,
            MultiTargetEcho = null
        });
        context.Socials.Add(new Social
        {
            Name = "salute",
            NoTargetEcho = "@ salute|salutes",
            OneTargetEcho = "@ salute|salutes $1",
            DirectionTargetEcho = "@ salute|salutes towards {0}",
            MultiTargetEcho = "@ salute|salutes {0} each in turn"
        });
        context.Socials.Add(new Social
        {
            Name = "scoff",
            NoTargetEcho = "@ scoff|scoffs",
            OneTargetEcho = "@ scoff|scoffs at $1",
            DirectionTargetEcho = null,
            MultiTargetEcho = "@ scoff|scoffs at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "shake",
            NoTargetEcho = "@ shake|shakes &0's head",
            OneTargetEcho = "@ shake|shakes &0's head at $1",
            DirectionTargetEcho = null,
            MultiTargetEcho = "@ shake|shakes &0's head at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "shrug",
            NoTargetEcho = "@ shrug|shrugs",
            OneTargetEcho = "@ shrug|shrugs at $1",
            DirectionTargetEcho = "@ shrug|shrugs towards {0}",
            MultiTargetEcho = "@ shrug|shrugs at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "sigh",
            NoTargetEcho = "@ sigh|sighs",
            OneTargetEcho = "@ sigh|sighs at $1",
            DirectionTargetEcho = "@ sigh|sighs and gazes towards {0}",
            MultiTargetEcho = "@ sigh|sighs at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "smile",
            NoTargetEcho = "@ smile|smiles",
            OneTargetEcho = "@ smile|smiles at $1",
            DirectionTargetEcho = null,
            MultiTargetEcho = "@ smile|smiles at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "smirk",
            NoTargetEcho = "@ smirk|smirks",
            OneTargetEcho = "@ smirk|smirks at $1",
            DirectionTargetEcho = "@ smirk|smirks towards {0}",
            MultiTargetEcho = "@ smirk|smirks at {0}"
        });
        context.Socials.Add(new Social
        {
            Name = "wink",
            NoTargetEcho = "@ wink|winks",
            OneTargetEcho = "@ wink|winks at $1",
            DirectionTargetEcho = "@ wink|winks towards {0}",
            MultiTargetEcho = "@ wink|winks at {0}"
        });
    }
    ...
    {
        // Add static strings
        foreach (KeyValuePair<string, string> ss in DefaultStaticSettings.DefaultStaticStrings)
        {
        ...
        {
            Id = "CreateAccountCulture",
            Text = @"#3Culture Settings#0
...
Please select your GMT Offset: "
        ...
        context.StaticStrings.Add(new StaticString
        {
            Id = "CreateAccountLineWrap",
            Text = @"#3Line Wrap Width#0
...
Please enter your desired line wrap width: "
        ...
        context.StaticStrings.Add(new StaticString
        {
            ...
            Text = @"#3Account Name Selection#0
...
Please select the number of your desired Timezone, or enter the code for it directly if you know it:"
        ...
        context.StaticStrings.Add(new StaticString
        {
            Id = "CreateAccountUnicode",
            Text = @"#3Unicode Support#0
...
Please select your preference for unit systems: "
        ...
        context.StaticStrings.Add(new StaticString
        {
            Id = "DefaultTableCannotFlipTraitMessage",
            Text = @"@ try|tries to flip $1, but are|is not strong enough."
        });
...
X) Disconnect from the game"
        ...
        context.StaticStrings.Add(new StaticString
        {
            Id = "LoggedInMenuMaintenanceNoChargen",
            Text = @"Welcome, {0}!
...
X) Disconnect from the game"
        ...
        context.StaticStrings.Add(new StaticString
        {
            Id = "LoggedInMenuMaintenanceNoLogin",
            Text = @"Welcome, {0}!
...
X) Disconnect from the game"
        ...
        context.StaticStrings.Add(new StaticString
        {
            Id = "LoggedInMenuMaintenanceNoLoginBothChargens",
            Text = @"Welcome, {0}!
...
X) Disconnect from the game"
        ...
        context.StaticStrings.Add(new StaticString
        {
            Id = "LoggedInMenuMaintenanceNoLoginResume",
            Text = @"Welcome, {0}!
...
P) Change your password"
        ...
        context.StaticStrings.Add(new StaticString
        {
            Id = "LoggedInMenuMaintenanceNoLoginSubmitted",
            Text = @"Welcome, {0}!
...
R) Recover a lost account"
	   ...
	   :    .------.    :
        ...
        {
            Id = "WhoText",
            Text = @"There are currently {0} players online.{4} Our record is {1}, last seen on {2}.{3}"
        });
        context.StaticStrings.Add(new StaticString
        {
        ...
        out FutureProg cancreateclanprog, out FutureProg oncreateclanprog)
    {
        ...
        FutureProg alwaysfalseprog = new()
        {
        ...
        FutureProg alwaysonehundredprog = new()
        {
