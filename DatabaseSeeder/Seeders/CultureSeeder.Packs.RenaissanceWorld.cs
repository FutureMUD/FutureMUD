...
///
/// Integration point: call from the Earth-RenaissanceWorldExpansion culture pack in <c>CultureSeeder.Packs.cs</c>:
/// <code>SeedRenaissanceWorld(questionAnswers);</code>
/// </remarks>
public partial class CultureSeeder
{
	...
	private void SeedRenaissanceWorld(IReadOnlyDictionary<string, string> questionAnswers)
	{
		if (questionAnswers["seednames"].EqualToAny("y", "yes"))
		{
			SeedRenaissanceWorldNames();
		}

		if (questionAnswers.TryGetValue("seedlanguages", out string? seedLanguages) &&
			seedLanguages.EqualToAny("y", "yes"))
		{
			SeedRenaissanceWorldLanguages();
		}

		if (questionAnswers["seedheritage"].EqualToAny("y", "yes"))
		{
			SeedRenaissanceWorldHeritage();
		}
	}

	private void SeedRenaissanceWorldNames()
	{
	...
	private void SeedRenaissanceWorldHeritage()
	{
		foreach (RenaissanceWorldSeed seed in RenaissanceWorldSeeds)
		{
			ValidateRenaissanceWorldSeed(seed);
		...
		SeedRenaissanceWorldHeritageCoverage();
		_context.SaveChanges();
	}
