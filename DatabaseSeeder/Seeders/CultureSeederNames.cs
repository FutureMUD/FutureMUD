...
public partial class CultureSeeder
{
    ...
    {
        string definition = new XElement("Definition",
    ...
    {
        NameCulture simpleName = AddNameCulture("Simple",
        ...
        RandomNameProfile random = AddRandomNameProfile("Wild Animal (Male)", Gender.Male, simpleName);
