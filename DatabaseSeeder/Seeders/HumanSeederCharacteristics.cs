...
public partial class HumanSeeder
{
    ...
    private void SetupCharacteristics(bool useDistinctive, Race humanRace)
    {
        ...
        BodypartShape eyeShape = _context.BodypartShapes.First(x => x.Name == "Eye");
        BodypartShape noseShape = _context.BodypartShapes.First(x => x.Name == "Nose");
        BodypartShape earShape = _context.BodypartShapes.First(x => x.Name == "Ear");

        #endregion

        #region Characteristic Definitions

        CharacteristicDefinition colourDef = _context.CharacteristicDefinitions.First(x => x.Name == "Colour");
        CharacteristicDefinition eyeColourDef = new()
        {
            Name = "Eye Colour",
            Type = 2,
            Pattern = "^eyecolou?r",
        ...
        CharacteristicDefinition eyeShapeDef = new()
        {
            Name = "Eye Shape",
            Type = 3,
            Pattern = "^eyeshape",
        ...
        CharacteristicDefinition noseDef = new()
        {
            Name = "Nose",
            Type = 3,
            Pattern = "^nose",
        ...
        CharacteristicDefinition earDef = new()
        {
            Name = "Ears",
            Type = 3,
            Pattern = "^ears",
        ...
        CharacteristicDefinition hairColourDef = new()
        {
            Name = "Hair Colour",
            Type = 2,
            Pattern = "^haircolou?r",
        ...
        CharacteristicDefinition facialHairColourDef = new()
        {
        ...
        CharacteristicDefinition hairStyleDef = new()
        {
            Name = "Hair Style",
            Type = 4,
            Pattern = "^hairstyle",
        ...
        CharacteristicDefinition facialHairStyleDef = new()
        {
        ...
        CharacteristicDefinition skinColourDef = new()
        {
            Name = "Skin Colour",
            Type = 3,
        ...
        CharacteristicDefinition frameDef = new()
        {
            Name = "Frame",
            Type = 3,
            Pattern = "^frame",
        ...
        CharacteristicDefinition personDef = new()
        {
            Name = "Person Word",
            Type = 3,
            Pattern = "^person",
        ...
        _context.CharacteristicProfiles.Add(new CharacteristicProfile
        {
            Name = "Brown_Blonde_Red_Grey_Hair",
            Type = "compound",
            TargetDefinition = hairColourDef,
        ...
        _context.CharacteristicProfiles.Add(new CharacteristicProfile
        {
            Name = "Black_Brown_Blonde_Grey_Hair",
            Type = "compound",
            TargetDefinition = hairColourDef,
        ...
        bool useNB = _questionAnswers["nonbinary"].EqualToAny("yes", "y");
        FutureProg humanProg = new()
        {
        ...
        FutureProg humanFemaleProg = new()
        {
        ...
        FutureProg humanNonFemaleProg = new()
        {
        ...
        FutureProg underweightProg = new()
        {
        ...
        FutureProg normalWeightProg = new()
        {
...
return @bmi > 24 and @bmi < 35"
        ...
        FutureProg isYoungWomanProg = new()
        {
        ...
        FutureProg isYoungAdultProg = new()
        {
        ...
        FutureProg isAdultWomanProg = new()
        {
        ...
        FutureProg isOldPersonProg = new()
        {
        ...
        if (useDistinctive)
        {
            CharacteristicDefinition distinctiveDef = new()
            {
