...
return ""You need at least {minimumTraitValue.Value.ToString(System.Globalization.CultureInfo.InvariantCulture)} in {traitText} to do that craft.""";
	...
	private void SeedCraftsLegacy()
	{
		...
		AddCraft("select seed stock", "Farming", "select viable seed or planting stock from a tagged agricultural yield commodity", "selecting seed stock", "a seed selection process", "HasFarming", null, null, null, _traits["Farming"] ?? _traits["Foraging"] ?? _traits["Forage"] ?? _traits.First().Value, Difficulty.Easy, Outcome.MinorFail, 5, 2, false, [(30, "$0 sort|sorts through $i1, discarding poor material and setting aside viable seed stock.", "$0 sort|sorts through $i1, but fail|fails to find much that looks viable."), (30, "$0 finish|finishes selecting $p1 from the agricultural yield.", "$0 finish|finishes with little useful seed stock to show for the effort.")], ["CommodityTag - 5 kilograms of a material tagged as Agriculture Seedable; tag Seeded Yield"], [], ["ScrapInput - 25.00% by weight of 5 kilograms of a material tagged as Agriculture Seedable ($i1); tag Seeds"], ["ScrapInput - 5.00% by weight of 5 kilograms of a material tagged as Agriculture Seedable ($i1); tag Seeds"]);
		...
		AddCraft("make long bow", "Weaponcrafting", "make a long bow", "making a long bow", "an unfinished bow assembly", "hascarpentry", null, null, null, _traits["Carpentry"] ?? _traits["Woodcraft"] ?? _traits.First().Value, Difficulty.Hard, Outcome.MinorFail, 5, 6, false, [(35, "$0 begin|begins the process of making a recurve bow by using $t1 to split $i1 into long, thin strips.", "$0 begin|begins the process of making a recurve bow by using $t1 to split $i1 into long, thin strips."), (30, "$0 place|places the edge of $t1 against one side of $i2 and repeat|repeats the process of refining things down into long, thin strips, using $t2 to tap the bottom of $t1, wedging the edge into splitting the hard material.", "$0 place|places the edge of $t1 against one side of $i2 and repeat|repeats the process of refining things down into long, thin strips, using $t2 to tap the bottom of $t1, wedging the edge into splitting the hard material."), (55, "Setting the thin, split pieces of material aside, $0 place|places $i3 in $i4, leaving it to soak.", "Setting the thin, split pieces of material aside, $0 place|places $i3 in $i4, leaving it to soak."), (30, "$0 begin|begins to assemble the bow, layering pieces of $i1, $i2 and wet, flat clumps of $i3 together.", "$0 begin|begins to assemble the bow, layering pieces of $i1, $i2 and wet, flat clumps of $i3 together."), (60, "Eventually, $0 finish|finishes the tedious process of layering the wood, tusk and sinew, and sit|sits back to let the bow set for a time.", "Eventually, $0 finish|finishes the tedious process of layering the wood, tusk and sinew, and sit|sits back to let the bow set for a time."), (20, "Finally, $0 take|takes up the bow and bend|bends it, stringing it with $i5 once successful, and set|sets aside $p1.", "Finally, $0 take|takes up the bow and attempt|attempts to bend it as a test, but the bow falls apart and leaves only $f1 behind, unused.")], ["Tag - 2x an item with the Branch tag", "Tag - 2x an item with the Tusk tag", "Tag - 10x an item with the String tag", "LiquidUse - 200 millilitres of Water", "Tag - 1x an item with the String tag"], ["TagTool - InRoom - an item with the Knife tag", "TagTool - InRoom - an item with the Hammer tag"], ["SimpleProduct - 1x &a_an[@material] longbow (#15) "], ["SimpleProduct - 1x a frayed gut string with visible wear (#546)"], [(1, 1)]);
