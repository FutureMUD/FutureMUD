...
return ""There is no useful clay that is accessible in the biome you're in.""");
        ...
        AddProg("HasFarming", "Crafting", "Access", ProgVariableTypes.Boolean, "", [(ProgVariableTypes.Character, "ch")], $@"return @ch.Skills.Any(x, @x.Id == {_traits["Farming"]?.Id ?? _traits["Agriculture"]?.Id ?? _traits.First().Value.Id})");
