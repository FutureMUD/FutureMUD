...
Please choose either #6simple#0 or #6complex#0: ", (context, answers) => true,
    ...
    private IEnumerable<SkillDetails> FunctionalCraftSkills =>
        new[]
        {
            ...
            new SkillDetails("Silversmithing", "Silversmith", "Crafting", "min(99,3*int + 2*wil)", "Crafting",
                "General", true, 1.0),
            new SkillDetails("Goldsmithing", "Goldsmith", "Crafting", "min(99,3*int + 2*wil)", "Crafting",
                "General", true, 1.0),
            ...
            new SkillDetails("Weaving", "Weaver", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General", true,
                1.0),
            new SkillDetails("Spinning", "Spinner", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General", true,
                1.0),
            ...
            new SkillDetails("Glassblowing", "Glassblower", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General", true, 1.0),
            new SkillDetails("Gemcraft", "Gemcraft", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General", true, 1.0),
            new SkillDetails("Lapidary", "Gemcutting", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General", true, 1.0),
            ...
            new SkillDetails("Carpentry", "Woodcraft", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General", true,
                1.0),
            new SkillDetails("Basketry", "Basketmaker", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Coopering", "Cooper", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Ropemaking", "Ropemaker", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Fulling", "Fuller", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Lacquerwork", "Lacquerer", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            ...
            new SkillDetails("Scrimshawing", "Scrimshaw", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General", true, 1.0),
			new SkillDetails("Bonecarving", "Bonecarver", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General", true, 1.0),
            ...
            new SkillDetails("Leathermaking", "Hideworking", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Parchmentmaking", "Parchmenter", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Papermaking", "Papermaker", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Bookbinding", "Bookbinder", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Calligraphy", "Calligrapher", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Scribing", "Scribe", "Crafting", "min(99,3*int + 2*wil)", "Crafting", "General",
                true, 1.0),
            new SkillDetails("Woodblock Printing", "Block Printer", "Crafting", "min(99,3*int + 2*wil)", "Crafting",
                "General", true, 1.0),
            new SkillDetails("Movable Type Printing", "Printer", "Crafting", "min(99,3*int + 2*wil)", "Crafting",
                "General", true, 1.0),
            new SkillDetails("Gunsmithing", "Gunsmith", "Crafting", "min(99,3*int + 2*wil)", "Crafting",
                "General", true, 1.0),
            new SkillDetails("Powdermaking", "Powdermaker", "Crafting", "min(99,3*int + 2*wil)", "Crafting",
                "General", true, 1.0),
            new SkillDetails("Lensmaking", "Lensmaker", "Crafting", "min(99,3*int + 2*wil)", "Crafting",
                "General", true, 1.0),
            new SkillDetails("Clockmaking", "Clockmaker", "Crafting", "min(99,3*int + 2*wil)", "Crafting",
                "General", true, 1.0),
            new SkillDetails("Instrument Making", "Instrument Maker", "Crafting", "min(99,3*int + 2*wil)", "Crafting",
                "General", true, 1.0),
            new SkillDetails("Navigation", "Navigator", "Professional", "min(99,3*int + 2*per)", "Professional",
                "General", true, 1.0),
            new SkillDetails("Cartography", "Cartographer", "Professional", "min(99,3*int + 2*per)", "Professional",
                "General", true, 1.0),
            new SkillDetails("Surveying", "Surveyor", "Professional", "min(99,3*int + 2*per)", "Professional",
                "General", true, 1.0),
            new SkillDetails("Engraving", "Engraver", "Crafting", "min(99,3*dex + 2*int)", "Crafting",
                "General", true, 1.0),
    ...
    private IEnumerable<SkillDetails> UniversalProfessionalSkills =>
        new[]
        {
            ...
            new SkillDetails("Quarrying", "Quarry", "Professional", "min(99,3*str + 2*con)", "Professional", "General", true, 1.0),
