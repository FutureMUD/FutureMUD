...
namespace DatabaseSeeder.Seeders
{
    public partial class UsefulSeeder
    {
        ...
        private void SeedTags(FuturemudDatabaseContext context, ICollection<string> errors)
        {
            ...
            AddTag(context, "Iron Resource", "Mineral Resource");
            AddTag(context, "Bog Iron Resource", "Iron Resource");
            AddTag(context, "Magnetite Sands Resource", "Iron Resource");
            AddTag(context, "Copper Resource", "Mineral Resource");
            AddTag(context, "Native Copper Resource", "Copper Resource");
            AddTag(context, "Azurite Resource", "Copper Resource");
            AddTag(context, "Chalcopyrite Resource", "Copper Resource");
            AddTag(context, "Gold Resource", "Mineral Resource");
            AddTag(context, "Placer Gold Resource", "Gold Resource");
            AddTag(context, "Evaporite Resource", "Mineral Resource");
            AddTag(context, "Rock Salt Resource", "Evaporite Resource");
            AddTag(context, "Salt Pan Resource", "Evaporite Resource");
            AddTag(context, "Alum Resource", "Evaporite Resource");
            AddTag(context, "Saltpeter Resource", "Evaporite Resource");
            AddTag(context, "Vitriol Copperas Resource", "Evaporite Resource");
            AddTag(context, "Clay Resource", "Primary Production Resource");
            AddTag(context, "Kaolin Resource", "Clay Resource");
            AddTag(context, "Pozzolan Resource", "Mineral Resource");
            AddTag(context, "Volcanic Ash Pozzolana Resource", "Pozzolan Resource");
            AddTag(context, "Lime Resource", "Primary Production Resource");
            AddTag(context, "Shell Lime Resource", "Lime Resource");
            AddTag(context, "Coral Lime Resource", "Lime Resource");
            AddTag(context, "Gemstone Resource", "Mineral Resource");
            AddTag(context, "Jade Greenstone Resource", "Gemstone Resource");
            AddTag(context, "Obsidian Resource", "Gemstone Resource");
            AddTag(context, "Turquoise Resource", "Gemstone Resource");
            AddTag(context, "Lapis Resource", "Gemstone Resource");
            AddTag(context, "Bog Iron Deposit", "Visible Resource Deposit");
            AddTag(context, "Magnetite Sands Deposit", "Visible Resource Deposit");
            AddTag(context, "Native Copper Deposit", "Visible Resource Deposit");
            AddTag(context, "Azurite Deposit", "Visible Resource Deposit");
            AddTag(context, "Chalcopyrite Deposit", "Visible Resource Deposit");
            AddTag(context, "Placer Gold Deposit", "Visible Resource Deposit");
            AddTag(context, "Rock Salt Deposit", "Visible Resource Deposit");
            AddTag(context, "Salt Pan Deposit", "Visible Resource Deposit");
            AddTag(context, "Kaolin Deposit", "Visible Resource Deposit");
            AddTag(context, "Volcanic Ash Pozzolana Deposit", "Visible Resource Deposit");
            AddTag(context, "Shell Lime Deposit", "Visible Resource Deposit");
            AddTag(context, "Coral Lime Deposit", "Visible Resource Deposit");
            AddTag(context, "Jade Greenstone Deposit", "Visible Resource Deposit");
            AddTag(context, "Obsidian Deposit", "Visible Resource Deposit");
            AddTag(context, "Turquoise Deposit", "Visible Resource Deposit");
            AddTag(context, "Lapis Deposit", "Visible Resource Deposit");
            AddTag(context, "Alum Deposit", "Visible Resource Deposit");
            ...
            AddTag(context, "High Grade Ore Commodity", "Raw Ore Commodity");
            AddTag(context, "Bog Iron Ore Commodity", "Low Grade Ore Commodity");
            AddTag(context, "Magnetite Sand Commodity", "High Grade Ore Commodity");
            AddTag(context, "Native Copper Ore Commodity", "High Grade Ore Commodity");
            AddTag(context, "Copper Carbonate Ore Commodity", "Medium Grade Ore Commodity");
            AddTag(context, "Copper Sulphide Ore Commodity", "Medium Grade Ore Commodity");
            AddTag(context, "Placer Concentrate Commodity", "Primary Production Commodity");
            AddTag(context, "Evaporite Commodity", "Primary Production Commodity");
            AddTag(context, "Rock Salt Commodity", "Evaporite Commodity");
            AddTag(context, "Salt Commodity", "Evaporite Commodity");
            AddTag(context, "Kaolin Commodity", "Primary Production Commodity");
            AddTag(context, "Pozzolana Commodity", "Primary Production Commodity");
            AddTag(context, "Gem Rough Commodity", "Primary Production Commodity");
            AddTag(context, "Obsidian Rough Commodity", "Gem Rough Commodity");
            AddTag(context, "Greenstone Rough Commodity", "Gem Rough Commodity");
            AddTag(context, "Turquoise Rough Commodity", "Gem Rough Commodity");
            AddTag(context, "Lapis Rough Commodity", "Gem Rough Commodity");
            AddTag(context, "Alum Commodity", "Primary Production Commodity");
            AddTag(context, "Saltpeter Commodity", "Primary Production Commodity");
            AddTag(context, "Copperas Commodity", "Primary Production Commodity");
            AddTag(context, "Alkali Commodity", "Primary Production Commodity");
            AddTag(context, "Potash Commodity", "Alkali Commodity");
            AddTag(context, "Soda Ash Commodity", "Alkali Commodity");
            AddTag(context, "Barilla Ash Commodity", "Alkali Commodity");
            AddTag(context, "Kelp Ash Commodity", "Alkali Commodity");
            AddTag(context, "Lye Commodity", "Alkali Commodity");
            AddTag(context, "Binder Commodity", "Primary Production Commodity");
            AddTag(context, "Quicklime Commodity", "Binder Commodity");
            AddTag(context, "Shell Lime Commodity", "Binder Commodity");
            AddTag(context, "Coral Lime Commodity", "Binder Commodity");
            AddTag(context, "Slaked Lime Commodity", "Binder Commodity");
            AddTag(context, "Plaster Commodity", "Binder Commodity");
            AddTag(context, "Mortar Commodity", "Binder Commodity");
            AddTag(context, "Bloom Commodity", "Primary Production Commodity");
            AddTag(context, "Iron Bloom Commodity", "Bloom Commodity");
            AddTag(context, "Steel Bloom Commodity", "Bloom Commodity");
            ...
            AddTag(context, "Primary Production Tools", "Tools");
            AddTag(context, "Bloomery Furnace", "Primary Production Tools");
            AddTag(context, "Tatara Furnace", "Primary Production Tools");
            AddTag(context, "Solar Salt Pan", "Primary Production Tools");
            AddTag(context, "Lime Kiln", "Primary Production Tools");
            AddTag(context, "Ore Washing Trough", "Primary Production Tools");
            AddTag(context, "Ash Hopper", "Primary Production Tools");
            AddTag(context, "Leaching Tub", "Primary Production Tools");
            AddTag(context, "Evaporating Pan", "Primary Production Tools");
            AddTag(context, "Quarry Wedges", "Primary Production Tools");
