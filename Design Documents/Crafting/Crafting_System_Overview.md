...
| Seeder and examples | Stock FutureProgs and seeded craft definitions that demonstrate common patterns | `DatabaseSeeder/Seeders/ItemSeeder/ItemSeeder.Crafting.cs` |
