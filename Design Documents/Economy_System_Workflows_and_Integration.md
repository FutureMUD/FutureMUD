...
13. Decide whether estates are enabled for each zone, then add probate offices if players should interact with estates in the zone.
14. Add morgue office and morgue storage cells if the world will use corpse recovery and morgue claim workflows.
