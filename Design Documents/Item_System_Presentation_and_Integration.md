...
- `NetworkAdapter` decorates the full description with its switch state, power state, connected host, attached telecommunications grid, canonical published address, and whether it is currently network-ready
