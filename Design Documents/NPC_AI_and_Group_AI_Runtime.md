...
The current stock inventory covers 136 normal animal races and 36 mythical animal races. Aquatic templates use `water immerse` or `water surface` where terrain-water hydration is the better default than drinking from containers. Amphibious templates can travel over land and water while applying a water-bias for ambient movement. Sapient mythical folk use a passive placeholder because social, occupational, conversational, legal, or faction behavior should be composed with more specific non-animal AIs.
