...
- `AgricultureSeeder` installs repair-capable stock agriculture profiles, crop/herd/woodland definitions, operations, and backing local project templates by stable names.
