...
| `medieval_writing_desk_drawers` | `desk` | a small writing desk | `oak` | `Large` / `Good` | 12000.0g / 85.0m | `Holdable`<br>`Destroyable_Furniture`<br>`Container_Writing_Desk_Drawers` | `Functions / Container`<br>`Functions / Writing Goods`<br>`Functions / Household Items / Household Wares`<br>`Market / Professional Tools / Standard Tools` |
