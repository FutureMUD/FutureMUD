...
This is the canonical source contract for 150 stock item prototypes owned by the Pre-industrial item-seeder branch. It covers 60 jewellery and devotional forms plus 90 doors, locks, gates, latches, keys, and fittings. The companion CSV and FDesc CSV are authoritative for every literal `CreateItem(...)` call.
