...
This is the canonical source contract for 910 stock item prototypes owned by the Renaissance item-seeder branch. It covers 0 jewellery and devotional forms plus 910 doors, locks, gates, latches, keys, and fittings. The companion CSV and FDesc CSV are authoritative for every literal `CreateItem(...)` call.
