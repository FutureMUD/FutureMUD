...
Regional dishes, feasts, sweets, dairy processing, cheese, butter, mead, vinegar, dried fruit, specialist condiments, and culture-specific beverages remain outside this generic subsistence foundation. Civilian transport and draft tack are supplied by the pre-industrial vehicle catalogue, and the shared pre-industrial leisure catalogue now supplies board games, dice, counters, and simple toys across Medieval, Renaissance, and Early Modern installations. The remaining Medieval craft launchers are active material-based routes.
