...
- `medieval_military_plain_short_spear` - a plain short spear; noun: `spear`; material: `carbon steel`; size/quality: `Normal`/`Standard`; weight/cost: 1450.0g/44.0m; components: `Holdable`, `Melee_Short Spear`, `Destroyable_Weapon`.
