...
Direct physical operations use the configured Immediate band. Inventory-plan scouting and execution, connection and installation reach checks, restraint application and removal, dragging and drag assistance, medical application, injection and feeding, prosthetic attachment and removal, manipulation of another character's containers or external implants, combat item retrieval, party movement membership, pursuit, and local-project participation therefore revalidate the participants' effective coordinates before starting and when a delayed action commits. Visibility at Distant or Very Distant range does not imply manipulation reach. Ordinary cells retain their historic same-cell and same-layer behavior.
