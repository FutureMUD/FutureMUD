...
namespace MudSharp_Unit_Tests
{
    ...
    public class CircularRangeTests
    {
        ...
        public void Constructor_InitializesRangesCorrectly()
        {
            ...
            // Act
            CircularRange<string> circularRange = new(24, items);
        ...
        public void RangeFraction_ReturnsCorrectFraction()
        {
            ...
            double fractionAtHour4 = circularRange.RangeFraction(4);

            // For hour 10 => within "Work" range [8..18). The fraction is (10 - 8) / (18 - 8) = 2 / 10 = 0.2
            double fractionAtHour10 = circularRange.RangeFraction(10);

            // For hour 21 => within "Play" range [18..24). The fraction is (21 - 18) / (24 - 18) = 3 / 6 = 0.5
            double fractionAtHour21 = circularRange.RangeFraction(21);
        ...
        {
            // Arrange
            CircularRange<string> circularRange = new();
            ...
            List<BoundRange<string>> sorted = circularRange.Ranges.ToList();
        ...
        public void Get_HandlesNaNAndLargeValuesGracefully()
        {
            ...
            CircularRange<string> circularRange = new(25, items); // 0..25

            // Act
            string nanResult = circularRange.Get(double.NaN);
            string largePositiveResult = circularRange.Get(2500.0);  // multiple wraps
            string largeNegativeResult = circularRange.Get(-2500.0); // multiple wraps
