...
public class NumberTests
{
    ...
    {
        List<double> distribution = NumberUtilities.GetPowerLawDistribution(100.0, 0.2, 10).ToList();
        ...
        List<double> edge = NumberUtilities.GetPowerLawDistribution(100.0, 1.0, 5).ToList();
