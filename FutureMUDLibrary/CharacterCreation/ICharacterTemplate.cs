...
namespace MudSharp.CharacterCreation
{
    public interface ICharacterTemplate : IProgVariable, IHaveFuturemud, IHaveTraits, IHaveCharacteristics
    {
        ...
        {
            ICharacteristicDefinition definition = GetCharacteristicDefinition(type).Item1;
            if (definition == null)
            {
        ...
        {
            Tuple<ICharacteristicDefinition, CharacteristicDescriptionType> definition = GetCharacteristicDefinition(type);
