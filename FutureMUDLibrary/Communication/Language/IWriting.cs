...
namespace MudSharp.Communication.Language
{
    ...
    public static class WritingExtensions
    {
        ...
        public static string Describe(this WritingStyleDescriptors type)
        {
            ...
            List<WritingStyleDescriptors> flags = type.GetFlags().OfType<WritingStyleDescriptors>().ToList();
    ...
    public interface IWriting : ICanBeRead, IProgVariable
    {
        ...
        Difficulty WritingDifficulty(ICharacter actor)
        {
            ...
            {
                Difficulty mutual = actor.Languages.Select(x => x.MutualIntelligability(Language)).DefaultIfEmpty(Difficulty.Impossible).Min();
