...
public static class EmploymentActionCatalog
{
	...
	[
		...
		Executable("load", EmploymentActionCategory.Logistics,
			"tasks step load all into <item id|tag <tag>> [at <here|cell id>]",
		...
		Executable("unload", EmploymentActionCategory.Logistics,
			"tasks step unload <item id|tag <tag>> [at <here|cell id>]",
		...
		Executable("return", EmploymentActionCategory.Logistics,
			"tasks step return container <item id|tag <tag>> to <here|cell id> [container <item id>|containertag <tag>]",
