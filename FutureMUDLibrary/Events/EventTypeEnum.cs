...
namespace MudSharp.Events {
	...
	public enum EventType {
		...
		/// </summary>
		[EventInfo("Hooks to a character when they leave the room they started in, but fires on their inventory items", new[] { "character", "location", "exit", "item" }, new[] { "mover", "origin", "exit", "item" }, new[] { FutureProgVariableTypes.Character, FutureProgVariableTypes.Location, FutureProgVariableTypes.Exit, FutureProgVariableTypes.Item })]
		...
		/// </summary>
		[EventInfo("Hooks to a character when they begin to move, but fires on their inventory items", new[] { "character", "location", "exit", "item" }, new[] { "mover", "origin", "exit", "item" }, new[] { FutureProgVariableTypes.Character, FutureProgVariableTypes.Location, FutureProgVariableTypes.Exit, FutureProgVariableTypes.Item })]
		...
		/// </summary>
		[EventInfo("Hooks to a character when they move into a room, but fires on their inventory items", new[] { "character", "location", "exit", "item" }, new[] { "mover", "destination", "exit", "item" }, new[] { FutureProgVariableTypes.Character, FutureProgVariableTypes.Location, FutureProgVariableTypes.Exit, FutureProgVariableTypes.Item })]
