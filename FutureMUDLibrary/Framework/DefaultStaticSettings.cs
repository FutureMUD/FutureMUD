...
public static class DefaultStaticSettings
{
    ...
    public static readonly IReadOnlyDictionary<string, string> DefaultStaticConfigurations =
        new Dictionary<string, string>
        {
			...
			{ "RangedAimStandingMultiplier", "1.0" },
			{ "RangedAimKneelingMultiplier", "1.10" },
			{ "RangedAimProneMultiplier", "1.25" },
			{ "CombatAimFailMultiplier", "0.03" },
			{ "CombatAimMinorFailMultiplier", "0.10" },
			{ "CombatAimMinorPassMultiplier", "0.20" },
			{ "CombatAimPassMultiplier", "0.30" },
			{ "CombatAimMajorPassMultiplier", "0.50" },
			{ "OutOfCombatAimMajorFailMultiplier", "0.05" },
			{ "OutOfCombatAimFailMultiplier", "0.10" },
			{ "OutOfCombatAimMinorFailMultiplier", "0.20" },
			{ "OutOfCombatAimMinorPassMultiplier", "0.30" },
			{ "OutOfCombatAimPassMultiplier", "0.50" },
			{ "OutOfCombatAimMajorPassMultiplier", "1.0" },
			{ "RangedAimShooterMovementLoss", "0.33" },
			{ "RangedAimTargetMovementLoss", "0.33" },
			{ "RangedAimTargetMovingTowardLoss", "0.15" },
			{ "ArtilleryLoadCheckDifficulty", "4" },
            ...
            { "WeaponPoisonApplyDefaultCapacityFraction", "0.25" },
            { "WeaponPoisonDipCapacityFraction", "1.0" },
            { "WeaponPoisonDosePerHitCapacityFraction", "0.20" },
            { "WeaponPoisonDeliveryMinimumChance", "0.05" },
            { "WeaponPoisonDeliveryMaximumChance", "0.95" },
            { "DrugDependenceEnabled", "true" },
            { "DrugCoagulationMinimumMultiplier", "0.25" },
            { "DrugCoagulationMaximumMultiplier", "3.0" },
            { "DrugRespirationMinimumMultiplier", "0.25" },
            { "DrugRespirationMaximumMultiplier", "3.0" },
            { "WeaponPoisonDipDifficultyStepsEasier", "2" },
            { "WeaponPoisonInjectedDamageMultiplierSlashing", "0.75" },
            { "WeaponPoisonInjectedDamageMultiplierChopping", "0.75" },
            { "WeaponPoisonInjectedDamageMultiplierCrushing", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierPiercing", "1.0" },
            { "WeaponPoisonInjectedDamageMultiplierBallistic", "0.75" },
            { "WeaponPoisonInjectedDamageMultiplierBurning", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierFreezing", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierChemical", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierShockwave", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierBite", "0.75" },
            { "WeaponPoisonInjectedDamageMultiplierClaw", "0.75" },
            { "WeaponPoisonInjectedDamageMultiplierElectrical", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierHypoxia", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierCellular", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierSonic", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierShearing", "0.75" },
            { "WeaponPoisonInjectedDamageMultiplierBallisticArmourPiercing", "1.0" },
            { "WeaponPoisonInjectedDamageMultiplierWrenching", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierShrapnel", "0.75" },
            { "WeaponPoisonInjectedDamageMultiplierNecrotic", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierFalling", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierEldritch", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierArcane", "0.0" },
            { "WeaponPoisonInjectedDamageMultiplierArmourPiercing", "1.0" },
            { "WeaponPoisonContactDamageMultiplier", "1.0" },
            { "WeaponPoisonSeverityMultiplierNone", "0.0" },
            { "WeaponPoisonSeverityMultiplierSuperficial", "0.20" },
            { "WeaponPoisonSeverityMultiplierMinor", "0.35" },
            { "WeaponPoisonSeverityMultiplierSmall", "0.50" },
            { "WeaponPoisonSeverityMultiplierModerate", "0.70" },
            { "WeaponPoisonSeverityMultiplierSevere", "0.85" },
            { "WeaponPoisonSeverityMultiplierVerySevere", "0.95" },
            { "WeaponPoisonSeverityMultiplierGrievous", "0.95" },
            { "WeaponPoisonSeverityMultiplierHorrifying", "0.95" },
            { "WeaponPoisonExternalBleedingWoundMultiplier", "1.10" },
            { "WeaponPoisonExternalNonBleedingWoundMultiplier", "1.0" },
            { "WeaponPoisonInternalWoundMultiplier", "0.60" },
			...
			{ "EnvironmentalMagicActiveSeconds", "60" },
			{ "EnvironmentalMagicAuditSeconds", "3600" },
			{ "EnvironmentalMagicMaximumCellVisits", "1024" },
			{ "EnvironmentalMagicMaximumOutputWork", "8192" },
			{ "EnvironmentalMagicBudgetMilliseconds", "5" },
            ...
            { "PushbackCombatDelayBaseSeconds", "1.0" },
            { "PushbackCombatDelayPerDegreeSeconds", "0.75" },
            { "PushbackMoveOnGoodFailDelay", "0.5" },
