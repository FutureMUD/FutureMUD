...
namespace MudSharp.Framework
{
    public static class DefaultStaticSettings
    {
        ...
        public static readonly IReadOnlyDictionary<string, string> DefaultStaticConfigurations = new Dictionary<string, string> {
            { "CPRAllowed", "true" },
            { "PlayersCanJunk", "true" },
            ...
            { "RangedCombatTargetBodypartExpression", "Min(-3, -3 * Pow(average/Max(chance/(range*0.5 + 1),0.000001),0.7))" },
            ...
            { "CharacterFallDamageExpression", "drand(0.4,1.0) * if(rooms>1,rooms*rooms,rooms) * weight / (5000 * (1.0+success))" },
            ...
            { "RelativeStrengthDefenseStaminaCostExpression", "if(attacker>defender,1+pow(attacker-defender,0.5),1*pow(attacker/defender,0.5))" },
            ...
            { "DefaultIdentityObscurerRemovalEcho", "revealing &his $eyecolour eyes, $nose,$?facialhairstyle[ $facialhaircolour $facialhairstyle,][] and $haircolour $hairstyle." },
            { "DefaultIdentityObscurerShortDescription", "&a_an[$?height[$height[@, ]]$frame] @key figure" },
            { "DefaultIdentityObscurerFullDescription", "This individual has their identity obscured on account of the fact that they are wearing @item. You can still tell however that they are &height tall and $framefancy." },
            ...
            { "DrawingTraitId", "0" },
            { "EmailServer", @"<Definition>  <Host>mail.yourserver.com</Host>  <Port>26</Port>  <EnableSSL>false</EnableSSL><UseDefaultCredentials>false</UseDefaultCredentials>  <Credentials Username=""staff@yoursever.com"" Password=""password""/></Definition>" },
            { "ForgerySkillId", "0" },
            ...
            { "LightModel", @"<Definition> <SightDifficulties> <SightDifficulty Difficulty=""10"" Lower=""0"" Upper=""0.0001""/> <SightDifficulty Difficulty=""9"" Lower=""0.0001"" Upper=""0.001""/> <SightDifficulty Difficulty=""8"" Lower=""0.001"" Upper=""0.108""/> <SightDifficulty Difficulty=""7"" Lower=""0.108"" Upper=""2""/> <SightDifficulty Difficulty=""6"" Lower=""2"" Upper=""10""/> <SightDifficulty Difficulty=""5"" Lower=""10"" Upper=""45""/> <SightDifficulty Difficulty=""4"" Lower=""45"" Upper=""75""/> <SightDifficulty Difficulty=""3"" Lower=""75"" Upper=""120""/> <SightDifficulty Difficulty=""2"" Lower=""120"" Upper=""250""/> <SightDifficulty Difficulty=""1"" Lower=""250"" Upper=""1000""/> <SightDifficulty Difficulty=""0"" Lower=""1000"" Upper=""1000000""/> </SightDifficulties> <Descriptions> <Description Lower=""0"" Upper=""0.0001""> <![CDATA[Pitch black]]> </Description> <Description Lower=""0.0001"" Upper=""0.0011""> <![CDATA[Almost completely dark]]> </Description> <Description Lower=""0.0011"" Upper=""1""> <![CDATA[Extremely dark]]> </Description> <Description Lower=""1"" Upper=""8""> <![CDATA[Very Dark]]> </Description> <Description Lower=""8"" Upper=""50""> <![CDATA[Dark]]> </Description> <Description Lower=""50"" Upper=""100""> <![CDATA[Dim]]> </Description> <Description Lower=""100"" Upper=""250""> <![CDATA[Soft]]> </Description> <Description Lower=""250"" Upper=""750""> <![CDATA[Normal]]> </Description> <Description Lower=""750"" Upper=""5000""> <![CDATA[Bright]]> </Description> <Description Lower=""5000"" Upper=""100000""> <![CDATA[Very bright]]> </Description> <Description Lower=""100000"" Upper=""1000000""> <![CDATA[Extremely bright]]> </Description> </Descriptions> <RoomDescriptions> <Description Lower=""0"" Upper=""0.0001""> <![CDATA[#3Currently, it is pitch black here.#0]]> </Description> <Description Lower=""0.0001"" Upper=""0.0011""> <![CDATA[#3It is almost completely dark here.#0]]> </Description> <Description Lower=""0.0011"" Upper=""1""> <![CDATA[#3Currently, it is extremely dark here.#0]]> </Description> <Description Lower=""1"" Upper=""8""> <![CDATA[#3Currently, it is very dark here.#0]]> </Description> <Description Lower=""8"" Upper=""50""> <![CDATA[#3Currently, it is dark here.#0]]> </Description> <Description Lower=""50"" Upper=""100""> <![CDATA[#3Currently, the lighting here is dim.#0]]> </Description> <Description Lower=""100"" Upper=""250""> <![CDATA[#3Currently, the lighting here is soft.#0]]> </Description> <Description Lower=""250"" Upper=""750""> <![CDATA[#3There is a normal amount of lighting here.#0]]> </Description> <Description Lower=""750"" Upper=""5000""> <![CDATA[#3Currently, the lighting is bright here.#0]]> </Description> <Description Lower=""5000"" Upper=""100000""> <![CDATA[#3Currently, the lighting is very bright here.#0]]> </Description> <Description Lower=""100000"" Upper=""1000000""> <![CDATA[#3The lighting here is currently extremely bright.#0]]> </Description> </RoomDescriptions> </Definition>" },
