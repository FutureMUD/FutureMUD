...
namespace MudSharp.Framework {
    ...
    //     By default the System.Data.Entity.Infrastructure.Pluralization.EnglishPluralizationService
    //     is used, but the pluralization service to use can be set in a class derived from
    //     System.Data.Entity.DbConfiguration.

    //
    // Summary:
    //     Represents a collection of the singular and plural forms of words.

    internal class FuturemudPluralizationService : ICustomPluralizationMapping, IFutureMUDPluralizationService
    {
        //
        // Summary:
        //     Gets or sets the System.Data.Entity.Design.PluralizationServices.PluralizationService
        //     culture.
        //
        // Returns:
        ...
        private readonly string[] _uninflectiveSuffixList =
            { "fish", "ois", "sheep", "deer", "pos", "itis", "ism", "ous", "ful" };
        ...
        private readonly string[] _uninflectiveWordList =
            {
                ...
                "molasses", "shambles", "shingles", "willpower"};
        ...
        private readonly Dictionary<string, string> _irregularPluralsDictionary =
            new()
            {
                    ...
                    {"lens", "lenses"}, {"alias","aliases"}, {"die", "dice"},
        ...
        private readonly Dictionary<string, string> _classicalInflectionDictionary =
                    new()
                    {
                        ...
                        {"goy", "goyim"}, {"seraph", "seraphim"}, {"alumnus", "alumni"}, {"denarius", "denarii"}, {"sestertius", "sestertii"}, {"quinarius", "quinarii"}, {"dupondius", "dupondii"}, {"asarius", "asarii"}, {"teruncius", "teruncii"}, {"quadrans", "quadrantes"}, {"semuncia", "seumnciae"}, {"uncia", "unciae"}, {"semi", "semisses"}, {"aureus", "aurei"}
                    };
