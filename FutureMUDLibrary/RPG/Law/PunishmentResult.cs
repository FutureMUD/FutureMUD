...
public class PunishmentResult
{
	...
	public MudTimeSpan CustodialSentence {  get; init; } = TimeAndDate.MudTimeSpan.Zero;
	public MudTimeSpan GoodBehaviourBondLength { get; init;} = TimeAndDate.MudTimeSpan.Zero;
