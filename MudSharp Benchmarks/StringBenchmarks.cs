...
public class JsonEscapeBenchmarks
{
    ...
    public string Naive()
    {
        return SampleText.EscapeForJsonNaive();
    }
...
You are standing."
    ...
    {
        return SanitiseText.ConvertToLatin1();
    }
}
...
public class MxpBenchmarks
{
    ...
    [Benchmark]
    public string SanitiseMxp()
    {
        return DirtyString.SanitiseMXP(MxpSupport);
    }
}
...
public class ShuffleBenchmarks
{
    ...
    [Benchmark]
    public List<int> ShuffleValues()
    {
        return Values.Shuffle().ToList();
    }

    [Benchmark]
    public List<int> OldShuffleValues()
    {
        return Values.OldShuffle().ToList();
    }

    [Benchmark]
    public List<Tag> ShuffleObjects()
    {
        return ObjectCollection.Shuffle().ToList();
    }

    [Benchmark]
    public List<Tag> OldShuffleObjects()
    {
        return ObjectCollection.OldShuffle().ToList();
    }
}
