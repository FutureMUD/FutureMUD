...
public class ArenaBettingServiceTests
{
    ...
    {
        List<IArenaEventTypeSide> sides = Enumerable.Range(0, Math.Max(1, sideCount))
            .Select(index =>
            {
    ...
    public void CanBet_ReturnsFalse_WhenStateClosed()
    {
        ...
        (bool Truth, string Reason) result = service.CanBet(actor.Object, evt.Object);
    ...
    public void PlaceBet_FixedOdds_CreatesBetAndCreditsArena()
    {
        ...
        ArenaBet bet = context.ArenaBets.Single();
    ...
    public void GetQuote_FixedOdds_FavoursHigherRatedSide()
    {
        ...
        Mock<ICombatArena> arena = new();
        IArenaParticipant[] participants = new[]
        {
        ...
        IArenaEvent evt = BuildEvent(arena, BettingModel.FixedOdds, ArenaEventState.RegistrationOpen, participants, sideCount: 2);

        decimal? side0Quote = service.GetQuote(evt, 0).FixedOdds;
        decimal? side1Quote = service.GetQuote(evt, 1).FixedOdds;
    ...
    public void Settle_PariMutuelSingleWinningBet_ReturnsStakeWithoutTake()
    {
        ...
        { { 15L, actor.Object } };
        ArenaBettingService service = CreateService(context, financeMock, paymentMock, characters);
        IArenaEvent evt = BuildEvent(arena, BettingModel.PariMutuel, ArenaEventState.RegistrationOpen);
    ...
    public void GetBetHistory_IgnoresNonBetPayoutTypesInResultTotals()
    {
        ...
        ArenaBettingService service = CreateService(context, financeMock, paymentMock, new Dictionary<long, ICharacter> { { 55L, actor.Object } });
    ...
    public void GetOutstandingPayouts_IncludesPayoutTypeInSummaries()
    {
        ...
        ArenaBettingService service = CreateService(context, financeMock, paymentMock, new Dictionary<long, ICharacter> { { 88L, actor.Object } });

        List<ArenaBetPayoutSummary> payouts = service.GetOutstandingPayouts(actor.Object).ToList();
