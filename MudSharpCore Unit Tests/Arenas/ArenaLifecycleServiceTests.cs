...
public class ArenaLifecycleServiceTests
{
    ...
    {
        Mock<IArenaEvent> arenaEvent = BuildEvent(ArenaEventState.Scheduled);
    ...
    {
        Mock<IArenaEvent> arenaEvent = BuildEvent(ArenaEventState.RegistrationOpen);
    ...
    {
        Mock<IArenaEvent> arenaEvent = BuildEvent(ArenaEventState.Preparing);
    ...
    {
        Mock<IArenaEvent> arenaEvent = BuildEvent(ArenaEventState.Cleanup);
    ...
    {
        Mock<IArenaEvent> arenaEvent = BuildEvent(ArenaEventState.Live);
    ...
    {
        ArenaEventState state = initialState;
