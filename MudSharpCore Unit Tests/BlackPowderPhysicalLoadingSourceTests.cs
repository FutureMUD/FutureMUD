...
public class BlackPowderPhysicalLoadingSourceTests
{
	...
	public void MusketLoading_SplitsLocatedCommodityAndKeepsPhysicalConsumables()
	{
		...
		StringAssert.Contains(source, "ReleaseSplitSourceFromHands(loader, wadSource, wad)");
		StringAssert.Contains(source, "ReleaseSplitSourceFromHands(loader, ballSource, ball)");
		...
		StringAssert.Contains(prototypeSource, "DesiredItemState.InRoom");
		StringAssert.Contains(prototypeSource, "null, 0, originalReference: \"ball\"");
		StringAssert.Contains(prototypeSource, "null, 0, originalReference: \"wad\"");
		StringAssert.Contains(prototypeSource, "null, 0, originalReference: \"cartridge\"");
		StringAssert.Contains(prototypeSource, "null, 0, originalReference: \"matchcord\"");
