...
public class ChangingNeedsModelBaseTests
{
	...
	{
		var result = ChangingNeedsModelBase.ApplySatiationReserveFromFulfiller(-3.0, 8.0, 8.0);
	...
	{
		var result = ChangingNeedsModelBase.ApplySatiationReserveFromFulfiller(-3.0, 0.0, 8.0);
	...
	{
		var result = ChangingNeedsModelBase.ApplySatiationReserveFromFulfiller(1.25, 10.0, -2.0);
