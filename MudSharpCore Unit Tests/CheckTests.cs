...
public class CheckTests
{
    ...
    {
        Dictionary<Difficulty, CheckOutcome> outcomes1 = new()
        {
        ...
        Dictionary<Difficulty, CheckOutcome> outcomes2 = new()
        {
            { Difficulty.Automatic, new CheckOutcome {Outcome = Outcome.MajorPass}},
            { Difficulty.Trivial, new CheckOutcome {Outcome = Outcome.MajorPass}},
        ...
        Dictionary<Difficulty, CheckOutcome> outcomes3 = new()
        {
            { Difficulty.Automatic, new CheckOutcome {Outcome = Outcome.MajorPass}},
            { Difficulty.Trivial, new CheckOutcome {Outcome = Outcome.MajorPass}},
            { Difficulty.ExtremelyEasy, new CheckOutcome {Outcome = Outcome.Pass}},
        ...
        OpposedOutcome outcome = new(outcomes1, outcomes2, Difficulty.Normal, Difficulty.Normal);
