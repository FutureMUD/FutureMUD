...
public class CombatSettingsSourceTests
{
	...
	{
		var source = File.ReadAllText(GetSourcePath("MudSharpCore", "Commands", "Modules", "CombatModule.cs"));
	...
	{
		var source = File.ReadAllText(GetSourcePath("MudSharpCore", "Combat", "CharacterCombatSettings.cs"));
	...
	{
		var raceSource = File.ReadAllText(GetSourcePath("MudSharpCore", "Character", "Heritage", "RaceBuilding.cs"));
		var npcSource = File.ReadAllText(GetSourcePath("MudSharpCore", "NPC", "Templates", "NPCTemplateBase.cs"));
