...
namespace MudSharp_Unit_Tests
{
    ...
    public class DateTimeTests
    {
        ...
        public void TestIntervals() {
            ...
            var listener2 = new DateListener(_testCalendar, 28, "jung", 34, 1, objs => assertionHit1 = true, new object[] { });
            var listener1 = new DateListener(_testCalendar, 1, "kepler", 34, 1, objs => assertionHit2 = true, new object[] { });
