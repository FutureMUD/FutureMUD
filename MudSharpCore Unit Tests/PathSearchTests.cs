...
namespace MudSharp_Unit_Tests {
    ...
    public class PathSearchTests {
        ...
        public void TestASharpPath() {
            var path = Person1Flight.PathBetween(Person2Flight, 15, true);
            ...
            path = Person1Flight.PathBetween(Person3Flight, 1, true);
        ...
        public void TestASharpFlight() {
            var cellsunder = Person1Flight.CellsUnderneathFlight(Person2Flight, 15);
