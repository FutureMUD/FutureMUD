...
public class ProgLookupFromBuilderInputTests
{
    ...
    {
        Mock<IFutureProg> prog = CreateProg(publicProg: false);
        Mock<ICharacter> actor = CreateActor(isAdministrator: false, prog.Object);

        IFutureProg? result = InvokeLookupProg(actor.Object, "eligibility");
    ...
    {
        Mock<IFutureProg> prog = CreateProg(publicProg: false);
        Mock<ICharacter> actor = CreateActor(isAdministrator: true, prog.Object);
    ...
    {
        ProgVariableTypes[] requiredParameters = new[]
        {
    ...
    private static Mock<ICharacter> CreateActor(bool isAdministrator, IFutureProg prog)
    {
        ...
        Mock<IUneditableAll<IFutureProg>> progCollection = new();
    ...
    private static IFutureProg? InvokeLookupProg(ICharacter actor, string builderInput)
    {
        ...
        Type type = typeof(MudSharp.Economy.Shops.Shop).Assembly.GetType("MudSharp.FutureProg.ProgLookupFromBuilderInput", throwOnError: true)!;
        ConstructorInfo constructor = type.GetConstructor(
            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
            null,
            new[] { typeof(ICharacter), typeof(string), typeof(ProgVariableTypes), typeof(IEnumerable<ProgVariableTypes>) },
            null)!;
        object instance = constructor.Invoke(new object[] { actor, builderInput, ProgVariableTypes.Boolean, requiredParameters });
        MethodInfo method = type.GetMethod("LookupProg", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic)!;
