...
public class SystemDateTimeTests
{
    ...
    public void GetDateOrder_MonthFirst_Cultures_ReturnsMonthFirst()
    {
        ...
        foreach (CultureInfo culture in cultures)
        {
            ...
            {
                DateUtilities.DateOrder result = DateUtilities.GetDateOrder(culture);
    ...
    public void GetDateOrder_AmbiguousOrUncommonPatterns_ReturnsExpected()
    {
        ...
        DateUtilities.DateOrder resultInvariant = DateUtilities.GetDateOrder(invariantCulture);
        ...
        DateUtilities.DateOrder resultCustom = DateUtilities.GetDateOrder(customCulture);
        ...
        CultureInfo monthDayOnlyCulture = (CultureInfo)CultureInfo.InvariantCulture.Clone();
        monthDayOnlyCulture.DateTimeFormat.MonthDayPattern = "MM/dd";
        monthDayOnlyCulture.DateTimeFormat.YearMonthPattern = "MM/yy";
        DateUtilities.DateOrder resultMonthDayOnly = DateUtilities.GetDateOrder(monthDayOnlyCulture);
        ...
        CultureInfo dayMonthOnlyCulture = (CultureInfo)CultureInfo.InvariantCulture.Clone();
        dayMonthOnlyCulture.DateTimeFormat.MonthDayPattern = "dd/MM";
        dayMonthOnlyCulture.DateTimeFormat.YearMonthPattern = "MM/yy";
        DateUtilities.DateOrder resultDayMonthOnly = DateUtilities.GetDateOrder(dayMonthOnlyCulture);
    ...
    {
        // Arrange
        CultureInfo invalidCulture = (CultureInfo)CultureInfo.InvariantCulture.Clone();
