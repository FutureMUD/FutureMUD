...
public class ThermalImbalanceConsequenceModelTests
{
	...
	{
		var result = ThermalImbalanceConsequenceModel.MovementDelayMultiplier(
	...
	{
		var result = ThermalImbalanceConsequenceModel.StaminaMultiplier(
	...
	{
		var result = ThermalImbalanceConsequenceModel.StaminaRegenerationMultiplier(
	...
	{
		var result = ThermalImbalanceConsequenceModel.OrganPenaltySeverity(
			BodyTemperatureStatus.SevereHyperthermia,
			0.0,
			1800.0,
			-1800.0,
	...
	{
		var halfway = ThermalImbalanceConsequenceModel.OrganPenaltySeverity(
			BodyTemperatureStatus.CriticalHyperthermia,
			7200.0,
			1800.0,
			-1800.0,
			0.1,
			8.0);
		var capped = ThermalImbalanceConsequenceModel.OrganPenaltySeverity(
