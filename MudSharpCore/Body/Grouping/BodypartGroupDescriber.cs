...
public abstract class BodypartGroupDescriber : SaveableItem, IBodypartGroupDescriber
{
        ...
        where T : IBodypartGroupDescriber
    {
        ...
        BodypartGroupResult firstResult = results.First();
        List<IBodypart> remains = firstResult.Remains;
        ...
        {
            BodypartGroupResult currentResult = results.FirstOrDefault(x => x.Matches.All(remains.Contains));
