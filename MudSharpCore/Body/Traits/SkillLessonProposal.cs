...
public class SkillLessonProposal : LessonProposal
{
    ...
    {
        Difficulty teachDifficulty = Skill.TeachDifficulty;
        Difficulty learnDifficulty = Skill.LearnDifficulty;
        ...
        CheckOutcome teachoutcome = Teacher.Gameworld.GetCheck(CheckType.SkillTeachCheck)
