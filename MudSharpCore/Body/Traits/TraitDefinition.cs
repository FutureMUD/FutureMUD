...
public abstract class TraitDefinition : SaveableItem, ITraitDefinition
{
    ...
    {
        ITraitDefinition definition = game.Traits.Get(trait.TraitDefinitionId);
    ...
    private bool BuildingCommandDecorator(ICharacter actor, StringStack command)
    {
        ...
        ITraitValueDecorator decorator = long.TryParse(command.SafeRemainingArgument, out long value)
