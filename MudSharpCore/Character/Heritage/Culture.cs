...
public class Culture : SaveableItem, ICulture
{
    ...
    public Culture(MudSharp.Models.Culture culture, IFuturemud gameworld)
    {
        ...
        foreach (CulturesChargenResources item in culture.CulturesChargenResources)
        {
        ...
        foreach (ChargenAdvicesCultures item in culture.ChargenAdvicesCultures)
        {
    ...
    private bool BuildingCommandCalendar(ICharacter actor, StringStack command)
    {
        ...
        ICalendar calendar = long.TryParse(command.SafeRemainingArgument, out long value)
