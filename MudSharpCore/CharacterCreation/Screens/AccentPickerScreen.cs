...
public class AccentPickerScreenStoryboard : ChargenScreenStoryboard
{
    ...
    internal class AccentPickerScreen : ChargenScreen
    {
        ...
        protected IEnumerable<IAccent> CurrentSelections => Storyboard.Gameworld.Accents
        ...
        protected void DoInitialAccentSetup()
        {
            ...
            {
                List<IAccent> accents = Storyboard.Gameworld.Accents
...
{GetSelectionFooter()}";
        ...
        {
            List<IAccent> orderedSelections = GroupedAccentMode
        ...
        public string DisplayGroupedMode()
        {
            ...
            sb.AppendLine();
            int choice = 1;
            IEnumerable<IGrouping<string, IAccent>> groupedSelections = CurrentSelections.GroupBy(x => x.Group);
            foreach (IGrouping<string, IAccent> group in groupedSelections)
            {
                sb.AppendLine();
        ...
        public override string HandleCommand(string command)
        {
            ...
            IAccent selectedAccent = GetAccentForSelection(command);
