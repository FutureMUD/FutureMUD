...
public class AgePickerScreenStoryboard : ChargenScreenStoryboard
{
        ...
        : base(dbitem, gameworld)
    {
        ...
        MinimumAgeProg = long.TryParse(definition.Element("MinimumAgeProg").Value, out long value)
    ...
    internal class AgePickerScreen : ChargenScreen
    {
        ...
        public override string HandleCommand(string command)
        {
            ...
            if (SelectedAge == 0)
            {
                ...
                int minimumValue = Convert.ToInt32(Storyboard.MinimumAgeProg.Execute(Chargen));
                int maximumValue = Convert.ToInt32(Storyboard.MaximumAgeProg.Execute(Chargen));
