...
public class MenuScreenStoryboard : ChargenScreenStoryboard
{
    ...
    internal class MenuScreen : ChargenScreen
    {
        ...
        {
            Dictionary<IChargenResource, int> costs = Chargen.ApplicationCosts;
            return
                string.Format(
        ...
        public override string HandleCommand(string command)
        {
            ...
            ChargenStage desiredStage = ChargenStage.Menu;
            ...
            {
                IEnumerable<ChargenStage> dependencies = Storyboard.Gameworld.ChargenStoryboard.StageDependencies[desiredStage];
                ...
                foreach (
                    KeyValuePair<ChargenStage, IEnumerable<ChargenStage>> stage in
