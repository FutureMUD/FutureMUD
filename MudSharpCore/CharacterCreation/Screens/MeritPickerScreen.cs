...
public class MeritPickerScreenStoryboard : ChargenScreenStoryboard
{
    ...
    public override IEnumerable<(IChargenResource Resource, int Cost)> ChargenCosts(IChargen chargen)
    {
        ...
        {
            int sum = 0;
            foreach (ICharacterMerit merit in chargen.SelectedMerits)
            {
    ...
    internal class MeritPickerScreen : ChargenScreen
    {
        ...
        public override string Display()
        {
            ...
            List<ICharacterMerit> selectedMerits = Chargen.SelectedMerits.Where(x => x.MeritType == MeritType.Merit).ToList();
            List<ICharacterMerit> selectedFlaws = Chargen.SelectedMerits.Where(x => x.MeritType == MeritType.Flaw).ToList();
        ...
        public override string HandleCommand(string command)
        {
            ...
            ICharacterMerit merit = int.TryParse(command, out int value)
