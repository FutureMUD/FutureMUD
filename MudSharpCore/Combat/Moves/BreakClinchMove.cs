...
public class BreakClinchMove : CombatMoveBase
{
    ...
    public override CombatMoveResult ResolveMove(ICombatMove defenderMove)
    {
        ...
        Dictionary<Difficulty, CheckOutcome> attackRoll = Gameworld.GetCheck(CheckType.BreakClinch)
    ...
    private CombatMoveResult ResolveClinchMove(IReadOnlyDictionary<Difficulty, CheckOutcome> attackRoll,
        string attackEmote)
    {
        Dictionary<Difficulty, CheckOutcome> dodgeCheck = Gameworld.GetCheck(CheckType.ResistBreakClinch)
        ...
        OpposedOutcome result = new(attackRoll, dodgeCheck, CheckDifficulty, Difficulty.Normal);
#if DEBUG
