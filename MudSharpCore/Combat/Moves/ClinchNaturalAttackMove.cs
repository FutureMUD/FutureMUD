...
public class ClinchNaturalAttackMove : WeaponAttackMove
{
    ...
    {
        CheckOutcome dodgeCheck = Gameworld.GetCheck(dodge.Check)
        ...
        Tuple<IDamage, IDamage> damages = GetDamagePlusSelfDamage(CharacterTarget, Bodypart, TargetBodypart, null, attackRoll.Outcome,
        ...
        string dodgeEmote = Gameworld.CombatMessageManager.GetMessageFor(CharacterTarget, Assailant, null, Attack,
