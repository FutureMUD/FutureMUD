...
public class NaturalAttackMove : WeaponAttackMove
{
        ...
        IHaveWounds defenderHaveWounds, string attackEmote, WardResult wardResult)
    {
            ...
            result.Outcome == OpposedOutcomeDirection.Stalemate)
        {
            ...
            Tuple<IDamage, IDamage> damages = GetDamagePlusSelfDamage(defenderMove.Assailant, Bodypart, TargetBodypart, null,
        ...
        else
        {
            ...
            Tuple<IDamage, IDamage> damages = GetDamagePlusSelfDamage(defenderMove.Assailant, Bodypart, null,
        ...
        IHaveWounds defenderHaveWounds, string attackEmote, WardResult wardResult)
    {
            ...
            result.Outcome == OpposedOutcomeDirection.Stalemate)
        {
            ...
            double finalAngle = Attack.Profile.BaseAngleOfIncidence * angleMultiplier;
            IBodypart bodypart = defenderMove.Assailant.Body.RandomBodyPartGeometry(Attack.Orientation, Alignment,
                Assailant.GetFacingFor(defenderMove.Assailant, true));

            Tuple<IDamage, IDamage> damages = GetDamagePlusSelfDamage(defenderMove.Assailant, Bodypart, bodypart, null,
                attackRoll[CheckDifficulty], Attack.Profile.DamageType, finalAngle, NaturalAttack, result.Degree);
            IDamage finalDamage = damages.Item1;
            IDamage selfDamage = damages.Item2;
        ...
        {
            string dodgeEmote = Gameworld.CombatMessageManager.GetMessageFor(defenderMove.Assailant, Assailant, null,
