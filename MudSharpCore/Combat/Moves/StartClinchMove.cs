...
public class StartClinchMove : WeaponAttackMove
{
    ...
    {
        Difficulty dodgeDifficulty = Difficulty.Normal;
        ...
        Dictionary<Difficulty, CheckOutcome> dodgeCheck = Gameworld.GetCheck(CheckType.ResistClinch)
        ...
        OpposedOutcome result = new(attackRoll, dodgeCheck, CheckDifficulty, dodgeDifficulty);
#if DEBUG
        ...
        {
            string dodgeEmote = Gameworld.CombatMessageManager.GetFailMessageFor(CharacterTarget, Assailant, null, null,
        ...
        {
            string dodgeEmote = Gameworld.CombatMessageManager.GetMessageFor(CharacterTarget, Assailant, null, null,
                BuiltInCombatMoveType.ResistClinch, dodgeCheck[dodgeDifficulty], null);
            Assailant.OutputHandler.Handle(
                new EmoteOutput(
                    new Emote(
