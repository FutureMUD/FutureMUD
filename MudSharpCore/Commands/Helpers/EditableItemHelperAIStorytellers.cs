...
public partial class EditableItemHelper
{
    public static EditableItemHelper AIStorytellerHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            AIStoryteller storyteller = new(actor.Gameworld, name);
    ...
    public static EditableItemHelper AIStorytellerReferenceDocumentHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            AIStorytellerReferenceDocument document = new(actor.Gameworld, name, "A reference document",
        ...
        CustomSearch = (items, keyword, gameworld) =>
        {
            ...
            string[] parts = keyword.Split(':', 2, StringSplitOptions.TrimEntries);
            if (parts.Length == 2)
            {
                string selector = parts[0].ToLowerInvariant();
                ...
                switch (selector)
                {
                    ...
                    case "storyteller":
                        {
                            IAIStoryteller storyteller = gameworld.AIStorytellers.GetByIdOrName(value);
