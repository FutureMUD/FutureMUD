...
public partial class EditableItemHelper
{
    public static EditableItemHelper EntityDescriptionHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            IFutureProg prog = new ProgLookupFromBuilderInput(actor, input.PopSpeech(), ProgVariableTypes.Boolean, [ProgVariableTypes.Toon]).LookupProg();
            if (prog is null)
            {
                return;
            }
            ...
            if (input.IsFinished)
            {
                ...
                actor.EditorMode((text, handler, _) =>
                    {
                        EntityDescriptionPattern desc = new(actor.Gameworld, text, type, prog);
            ...
            string pattern = input.SafeRemainingArgument;
            EntityDescriptionPattern desc = new(actor.Gameworld, pattern, type, prog);
            actor.Gameworld.Add(desc);
            actor.RemoveAllEffects(x => x.IsEffectType<IBuilderEditingEffect<IEntityDescriptionPattern>>());
            actor.AddEffect(new BuilderEditingEffect<IEntityDescriptionPattern>(actor) { EditingItem = desc });
        ...
        EditableCloneAction = (actor, input) =>
        {
            ...
            IEntityDescriptionPattern template = actor.Gameworld.EntityDescriptionPatterns.GetById(input.SafeRemainingArgument);
            if (template is null)
            {
            ...
            IEntityDescriptionPattern clone = template.Clone();
    ...
    public static EditableItemHelper CharacterIntroTemplateHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            CharacterIntroTemplate cit = new(actor.Gameworld, name);
        ...
        EditableCloneAction = (actor, input) =>
        {
            ...
            ICharacterIntroTemplate template = actor.Gameworld.CharacterIntroTemplates.GetByIdOrName(input.PopSpeech());
            if (template is null)
            {
            ...
            ICharacterIntroTemplate cit = template.Clone(name);
            actor.Gameworld.Add(cit);
            actor.RemoveAllEffects(x => x.IsEffectType<IBuilderEditingEffect<ICharacterIntroTemplate>>());
            actor.AddEffect(new BuilderEditingEffect<ICharacterIntroTemplate>(actor) { EditingItem = cit });
    ...
    public static EditableItemHelper NewPlayerHintHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            {
                NewPlayerHint hint = new(actor.Gameworld, text);
    ...
    public static EditableItemHelper ChargenAdviceHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            if (!input.PopSpeech().TryParseEnum<ChargenStage>(out ChargenStage stage))
            {
                actor.OutputHandler.Send(
            ...
            {
                ChargenAdvice advice = new(actor.Gameworld, name, text, stage);
        ...
        EditableCloneAction = (actor, input) =>
        {
            ...
            IChargenAdvice target = actor.Gameworld.ChargenAdvices.GetByIdOrName(input.SafeRemainingArgument);
            if (target is null)
            {
            ...
            ChargenAdvice clone = new(target);
            actor.Gameworld.Add(clone);
            actor.RemoveAllEffects<BuilderEditingEffect<IChargenAdvice>>();
    ...
    public static EditableItemHelper MeritHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            IMerit merit = MeritFactory.LoadMeritFromBuilder(actor.Gameworld, type, name);
            if (merit is null)
            {
        ...
        EditableCloneAction = (actor, input) =>
        {
            ...
            IMerit template = actor.Gameworld.Merits.GetByIdOrName(input.PopSpeech());
            if (template is null)
            {
            ...
            IMerit merit = template.Clone(name);
            actor.Gameworld.Add(merit);
            actor.RemoveAllEffects(x => x.IsEffectType<IBuilderEditingEffect<IMerit>>());
            actor.AddEffect(new BuilderEditingEffect<IMerit>(actor) { EditingItem = merit });
