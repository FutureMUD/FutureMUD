...
public partial class EditableItemHelper
{
    public static EditableItemHelper PropertyHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            if (!zone.Currency.TryGetBaseCurrency(input.PopSpeech(), out decimal value))
            {
                actor.OutputHandler.Send(
            ...
            IFrameworkItem owner = accountTarget.AccountOwner;
            ...
            Property property = new(name, zone, actor.Location, value, owner, accountTarget);
    ...
    public static EditableItemHelper AuctionHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            AuctionHouse auctionHouse = new(zone, name, actor.Location, accountTarget);
    ...
    public static EditableItemHelper BankHelper { get; } = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            string code = input.PopSpeech().ToLowerInvariant();
            ...
            IEconomicZone zone = actor.Gameworld.EconomicZones.GetByIdOrName(input.SafeRemainingArgument);
            if (zone == null)
            {
            ...
            Bank bank = new(actor.Gameworld, name, code, zone);
        ...
        EditableCloneAction = (actor, input) =>
        {
            ...
            IBank bank = actor.Gameworld.Banks.GetByIdOrName(input.PopSpeech());
            if (bank == null)
            {
    ...
    public static EditableItemHelper CoinHelper = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            ICurrency currency = actor.Gameworld.Currencies.GetByIdOrName(input.PopSpeech());
            if (currency is null)
            {
            ...
            decimal coinValue;
            if (decimal.TryParse(input.SafeRemainingArgument, out decimal value))
            {
                if (value <= 0.0M)
                {
        ...
        EditableCloneAction = (actor, input) =>
        {
            ...
            ICoin template = actor.Gameworld.Coins.GetByIdOrName(input.PopSpeech());
            if (template == null)
            {
        ...
        CustomSearch = (protos, keyword, gameworld) =>
        {
            ...
            ICurrency currency = gameworld.Currencies.GetByIdOrName(keyword);
    ...
    public static EditableItemHelper ShopperHelper = new()
    {
        ...
        EditableNewAction = (actor, input) =>
        {
            ...
            IEconomicZone ez = actor.Gameworld.EconomicZones.GetByIdOrName(input.PopSpeech());
            if (ez is null)
            {
            ...
            IShopper shopper = ShopperBase.LoadShopper(actor.Gameworld, type, name, ez);
        ...
        EditableCloneAction = (actor, input) =>
        {
            ...
            IShopper template = actor.Gameworld.Shoppers.GetByIdOrName(input.PopSpeech());
            if (template == null)
            {
            ...
            IShopper shopper = template.Clone(name);
            actor.Gameworld.Add(shopper);
            actor.RemoveAllEffects<BuilderEditingEffect<IShopper>>();
            actor.AddEffect(new BuilderEditingEffect<IShopper>(actor) { EditingItem = shopper });
