...
public class Language : SaveableItem, ILanguage
{
    ...
    public string Show(ICharacter actor)
    {
        ...
        {
            foreach (KeyValuePair<long, Difficulty> language in _mutuallyIntelligableLanguages)
            {
                sb.AppendLine(
        ...
        foreach (IScript script in Gameworld.Scripts.Where(x => x.DesignedLanguages.Contains(this)))
        {
    ...
    private bool BuildingCommandModel(ICharacter actor, StringStack command)
    {
        ...
        ILanguageDifficultyModel model = long.TryParse(command.SafeRemainingArgument, out long value)
    ...
    private bool BuildingCommandMutual(ICharacter actor, StringStack command)
    {
        ...
        ILanguage language = long.TryParse(command.SafeRemainingArgument, out long value)
    ...
    public override void Save()
    {
        ...
        foreach (KeyValuePair<long, Difficulty> intelligible in _mutuallyIntelligableLanguages)
        {
