...
public class Script : SaveableItem, IScript
{
    ...
    public Script(MudSharp.Models.Script script, IFuturemud gameworld)
    {
        ...
        foreach (ScriptsDesignedLanguage item in script.ScriptsDesignedLanguages)
        {
    ...
    {
        Models.Script dbitem = FMDB.Context.Scripts.Find(Id);
        dbitem.Name = Name;
        ...
        foreach (ILanguage language in _designedLanguages)
        {
