...
public class ActiveOngoingJob : ActiveJobBase
{
    ...
    public override void QuitJob()
    {
        ...
        StringBuilder sb = new();
        TimeSpan duration = Listing.EconomicZone.FinancialPeriodReferenceCalendar.CurrentDateTime - JobCommenced;
    ...
    {
        IOngoingJobListing job = (IOngoingJobListing)Listing;
        DecimalCounter<ICurrency> pay = new();
