...
public class EstateAsset : SaveableItem, IEstateAsset
{
    ...
    {
        Models.EstateAsset dbitem = FMDB.Context.EstateAssets.Find(Id);
    ...
    private decimal GameItemAssumedValue(IGameItem item)
    {
        ...
        List<decimal> shopPrices = Estate.Gameworld.Shops
        ...
        List<decimal> vendingPrices = Estate.Gameworld.Items
