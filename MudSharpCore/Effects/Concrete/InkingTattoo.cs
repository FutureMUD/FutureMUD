...
public class InkingTattoo : CharacterActionWithTargetAndTool, IAffectProximity
{
    ...
    public override void ExpireEffect()
    {
        ...
        Difficulty difficulty = ((Difficulty)(int)(Tattoo.TattooistSkill / Gameworld.GetStaticDouble("TattooSkillPerDifficulty")))
        ...
        IInventoryPlan inkPlan = Tattoo.TattooTemplate.GetInkPlan(CharacterOwner);
