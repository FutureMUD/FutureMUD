...
public class NewPlayer : Effect, INewPlayerEffect
{
    ...
    public static void InitialiseEffectType()
    {
        ...
        StaticConfiguration dbitem = FMDB.Context.StaticConfigurations.Find("NewPlayerEffectLength");
        NewPlayerEffectLength = dbitem != null && int.TryParse(dbitem.Definition, out int value)
