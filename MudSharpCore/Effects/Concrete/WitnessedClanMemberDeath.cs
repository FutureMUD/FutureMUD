...
public class WitnessedClanMemberDeath : Effect
{
    ...
    public ICharacter ClanMember => _clanMember ??= Gameworld.TryGetCharacter(_clanMemberId, true);
    ...
    {
        IClanMembership membership = Clan.Memberships.FirstOrDefault(x => x.MemberId == _clanMemberId);
