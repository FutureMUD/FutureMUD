    ...
    IBodypartSpecificCharacteristicDefinition
{
    ...
    protected override void LoadFromDatabase(Models.CharacteristicDefinition definition)
    {
        ...
        XElement root = XElement.Parse(definition.Definition);
    ...
    {
        Models.CharacteristicDefinition dbitem = FMDB.Context.CharacteristicDefinitions.Find(Id);
    ...
    public override void BuildingCommand(ICharacter actor, StringStack command)
    {
        switch (command.PopForSwitch())
        {
            case "parent":
                ...
                // Check for loops
                ICharacteristicDefinition proposed = definition.Parent;
                while (proposed != null)
                {
