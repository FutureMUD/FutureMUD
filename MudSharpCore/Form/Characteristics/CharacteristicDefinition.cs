...
public class CharacteristicDefinition : FrameworkItem, ICharacteristicDefinition
{
        ...
        IFuturemud gameworld, ICharacteristicDefinition parent = null, XElement definition = null)
    {
        ...
        using (new FMDB())
        {
            Models.CharacteristicDefinition dbdef = new()
            {
                Name = name,
                Pattern = pattern,
            ...
            Models.CharacteristicProfile dbprof = new()
            {
            ...
            FMDB.Context.SaveChanges();
            ICharacteristicProfile prof = CharacteristicProfile.LoadProfile(dbprof, Gameworld);
            Gameworld.Add(prof);
        }
    }
    ...
    public virtual void BuildingCommand(ICharacter actor, StringStack command)
    {
        ...
        {
            case "name":
                string newname = command.PopSpeech();
            ...
            case "desc":
            case "description":
                string desc = command.SafeRemainingArgument;
            ...
            case "pattern":
                ...
                try
                {
                    Regex parsed = new(pattern, RegexOptions.IgnoreCase);
                    Pattern = parsed;
                }
    ...
    public virtual void Save()
    {
        using (new FMDB())
        {
            Models.CharacteristicDefinition dbdef = FMDB.Context.CharacteristicDefinitions.Find(Id);
            dbdef.Name = Name;
