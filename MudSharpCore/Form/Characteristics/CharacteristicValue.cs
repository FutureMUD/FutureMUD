...
public class CharacteristicValue : FrameworkItem, ISaveable, ICharacteristicValue
{
        ...
        bool nonsaving = false)
    {
        ...
        if (!_noSave)
        {
            using (new FMDB())
            {
                Models.CharacteristicValue dbval = new()
                {
                    Name = base.Name,
                    Value = value,
    ...
    protected CharacteristicValue(CharacteristicValue rhs, string newName, string value, string additional)
    {
        ...
        using (new FMDB())
        {
            Models.CharacteristicValue dbitem = new()
            {
                Name = newName,
                Value = value,
                AdditionalValue = additional,
    ...
    {
        ICharacteristicDefinition definition = gameworld.Characteristics.Get(value.DefinitionId);
