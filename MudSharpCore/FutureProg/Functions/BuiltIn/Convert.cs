...
internal class ConvertFunction : BuiltInFunction
{
    ...
    public static void RegisterFunctionCompiler()
    {
        ...
        // Reference Types
        foreach (ProgVariableTypes type in ProgVariableTypes.ReferenceType.GetSingleFlags())
        {
            FutureProg.RegisterBuiltInFunctionCompiler(
                new FunctionCompilerInformation(
                    "convert",
        ...
        // All Types
        foreach (ProgVariableTypes type in ProgVariableTypes.Anything.GetSingleFlags())
        {
            FutureProg.RegisterBuiltInFunctionCompiler(
                new FunctionCompilerInformation(
                    "convert",
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        IProgVariable result = FutureProg.GetVariable(ReturnType, ParameterFunctions[0].Result?.GetObject);
