...
internal class HowSeenFunction : BuiltInFunction
{
    ...
    {
        IFunction perceivableFunction = ParameterFunctions.ElementAt(0);
        IFunction perceiverFunction = ParameterFunctions.ElementAt(1);
        IFunction properFunction = ParameterFunctions.ElementAt(2);
        IFunction colourFunction = ParameterFunctions.ElementAt(3);
