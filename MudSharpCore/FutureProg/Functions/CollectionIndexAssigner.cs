...
internal class CollectionIndexAssigner : Function
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        StatementResult indexResult = IndexFunction.Execute(variables);
        ...
        int index = Convert.ToInt32(IndexFunction.Result);

        StatementResult assignmentResult = AssignmentFunction.Execute(variables);
