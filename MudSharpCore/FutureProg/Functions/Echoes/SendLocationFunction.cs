...
internal class SendLocationFunction : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        IProgVariable textResult = ParameterFunctions[1 + (UseLayerArgument ? 1 : 0)].Result;
        ...
        foreach (IFunction parameter in ParameterFunctions.Skip(2 + (UseLayerArgument ? 1 : 0)))
        {
