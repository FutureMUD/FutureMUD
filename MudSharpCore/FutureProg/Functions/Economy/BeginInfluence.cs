...
namespace MudSharp.FutureProg.Functions.Economy
{
    internal class BeginInfluence : BuiltInFunction
    {
        ...
        public override StatementResult Execute(IVariableSpace variables)
        {
            ...
            MudDateTime start = market.EconomicZone.FinancialPeriodReferenceCalendar.CurrentDateTime;
            ...
            MarketInfluence influence = new(market, template, template.Name, start, end);
