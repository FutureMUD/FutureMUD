...
internal class WithdrawGrid : BuiltInFunction
{
	...
	public static void RegisterFunctionCompiler()
	{
		FutureProg.RegisterBuiltInFunctionCompiler(
			new FunctionCompilerInformation(
				...
				new List<string>
				{
					"The ID of the grid you want to withdraw from",
	...
	protected WithdrawGrid(IList<IFunction> parameterFunctions, IFuturemud gameworld) : base(parameterFunctions)
	{
		Gameworld = gameworld;
	}
