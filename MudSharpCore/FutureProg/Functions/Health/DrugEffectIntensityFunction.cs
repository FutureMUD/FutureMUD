...
internal class DrugEffectIntensityFunction : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        ICharacter character = (ICharacter)ParameterFunctions[0].Result?.GetObject;
        if (character == null)
        {
        ...
        long? drug = (long?)(decimal?)ParameterFunctions[1].Result?.GetObject;
        if (drug == null)
        {
        ...
        DrugType drugtype = (DrugType)drug.Value;
