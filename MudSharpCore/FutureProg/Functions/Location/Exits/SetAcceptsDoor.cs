...
internal class SetAcceptsDoor : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        bool truth = (bool)(ParameterFunctions[2].Result?.GetObject ?? false);
        SizeCategory size = (SizeCategory)Convert.ToInt32(ParameterFunctions[3].Result?.GetObject ?? (int)SizeCategory.Titanic);
