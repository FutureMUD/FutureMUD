...
internal class InFunction : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        string target = ParameterFunctions[0].Result?.ToString();
        if (target == null)
        {
        ...
        foreach (IFunction parameter in ParameterFunctions.Skip(1))
        {
            string parameterValue = parameter.Result?.ToString();
