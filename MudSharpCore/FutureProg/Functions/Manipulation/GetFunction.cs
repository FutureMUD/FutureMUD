...
internal class GetFunction : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        ICharacter getter = (ICharacter)ParameterFunctions[0].Result;
        if (getter == null)
        {
...
internal class GetContainerFunction : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        ICharacter getter = (ICharacter)ParameterFunctions[0].Result?.GetObject;
        if (getter == null)
        {
        ...
        IGameItem container = (IGameItem)ParameterFunctions[2].Result?.GetObject;
        if (container == null)
        {
        ...
        int quantity = ParameterFunctions[3].ReturnType.CompatibleWith(ProgVariableTypes.Number)
            ? ((int?)(decimal?)ParameterFunctions[3].Result.GetObject ?? 0)
            : 0;

        string emoteText = ParameterFunctions[3].ReturnType.CompatibleWith(ProgVariableTypes.Number)
