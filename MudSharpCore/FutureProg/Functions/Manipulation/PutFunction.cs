...
internal class PutFunction : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        ICharacter putter = (ICharacter)ParameterFunctions[0].Result?.GetObject;
        if (putter == null)
        {
...
internal class PutContainerFunction : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        IGameItem target = (IGameItem)ParameterFunctions[0].Result?.GetObject;
        if (target == null)
        {
            ErrorMessage = "Target GameItem was null in Put function.";
            return StatementResult.Error;
...
internal class PutLocationFunction : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        ILocation location = (ILocation)ParameterFunctions[1].Result?.GetObject;
        if (location == null)
        {
