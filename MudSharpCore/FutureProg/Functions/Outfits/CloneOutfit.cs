...
internal class CloneOutfit : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        ICharacter owner = (ICharacter)ParameterFunctions[1].Result;
        if (owner == null)
        {
        ...
        string newName = ParameterFunctions[2].Result.GetObject?.ToString();
        ...
        IOutfit newOutfit = outfit.CopyOutfit(owner, newName);
