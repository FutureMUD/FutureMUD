...
internal class Substring : BuiltInFunction
{
    ...
    public override StatementResult Execute(IVariableSpace variables)
    {
        ...
        string text = ParameterFunctions[0].Result?.GetObject?.ToString();
        ...
        int index = (int)(decimal)indexVariable.GetObject;
        ...
        {
            int length = (int)(decimal)lengthVariable.GetObject;
        ...
        Result = new TextVariable(text[index..]);
        return StatementResult.Normal;
    }
}
