...
internal class AddItem : Statement
{
    ...
    {
        Match match = AddItemCompileRegex.Match(lines.First());
        ...
        ICompileInfo addItemFunctionInfo = FunctionHelper.CompileFunction(match.Groups[2].Value, variableSpace, lineNumber,
            gameworld);
        ...
        IFunction addItemFunction = (IFunction)addItemFunctionInfo.CompiledStatement;
        if (
    ...
    {
        Match match = AddItemCompileRegex.Match(line);
        return
