...
internal class AddRange : Statement
{
    ...
    {
        Match match = AddRangeCompileRegex.Match(lines.First());
        ...
        ICompileInfo addRangeFunctionInfo = FunctionHelper.CompileFunction(match.Groups["item"].Value, variableSpace, lineNumber,
            gameworld);
        ...
        IFunction addRangeFunction = (IFunction)addRangeFunctionInfo.CompiledStatement;
    ...
    {
        Match match = AddRangeCompileRegex.Match(line);
        return
