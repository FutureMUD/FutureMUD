...
internal class DeclareVariable : Statement
{
    ...
    {
        Match match = DeclareVariableCompileRegex.Match(lines.First());
        ...
        ProgVariableTypes type = FutureProg.GetTypeByName(match.Groups["type"].Value);
    ...
    {
        Match match = DeclareVariableCompileRegex.Match(line);
        return
