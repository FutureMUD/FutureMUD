...
internal class SetRegister : Statement
{
    ...
    {
        Match match = SetRegisterCompileRegex.Match(lines.First());
        ...
        IFunction typeParameter = (IFunction)compiledArgs.ElementAt(0).CompiledStatement;
        ...
        IFunction nameParameter = (IFunction)compiledArgs.ElementAt(1).CompiledStatement;
        ...
        ProgVariableTypes registeredType = gameworld.VariableRegister.GetType(typeParameter.ReturnType,
        ...
        IFunction valueParameter = (IFunction)compiledArgs.ElementAt(2).CompiledStatement;
    ...
    {
        Match match = SetRegisterCompileRegex.Match(line);
        FunctionHelper.ParameterSplit splitArgs = FunctionHelper.ParameterStringSplit(match.Groups[1].Value, ' ');
        return
