    ...
    ICanConnectToTelecommunicationsGrid
{
    ...
    public bool CanSwitch(ICharacter actor, string setting)
    {
        ...
        return TelephoneRingSettings.TryGetVolumeForSetting(setting, true, out AudioVolume volume) &&
               RingVolume != volume;
    }
    ...
    public bool Switch(ICharacter actor, string setting)
    {
        ...
        if (TelephoneRingSettings.TryGetVolumeForSetting(setting, true, out AudioVolume volume))
        {
    ...
    {
        IBody? wornBody = GetWornContainerOwner();
    ...
    private IBody? GetWornContainerOwner()
    {
        ...
        IGameItem current = Parent.ContainedIn;
        while (current != null)
        {
