...
public class ContainerGameItemComponent : GameItemComponent, IContainer, IOpenable, ILockable
{
        ...
        switch (type)
        {
            case DescriptionType.Evaluate:
                ...
                if (_prototype.OnceOnly)
                {
                    ...
                    sb.AppendLine($"It is currently {(IsOpen ? "open" : "closed")}.".Colour(Telnet.Yellow));
                }
                else
                {
                    sb.AppendLine(
            ...
            case DescriptionType.Full:
                ...
                if (_prototype.Closable)
                {
                    ...
                    {
                        sb.AppendLine(
                            "It looks like it designed to be opened a single time only.".Colour(Telnet.Yellow));
                        sb.AppendLine($"It is currently {(IsOpen ? "open" : "closed")}.".Colour(Telnet.Yellow));
                    }
                    else
                    {
    ...
    {
        _prototype = (ContainerGameItemComponentProto)newProto;
    ...
    {
        return _prototype.Closable && IsOpen && !_prototype.OnceOnly;
    }
    ...
    public ContainerGameItemComponent(ContainerGameItemComponentProto proto, IGameItem parent,
    ...
    public ContainerGameItemComponent(MudSharp.Models.GameItemComponent component,
        ContainerGameItemComponentProto proto,
    ...
    public ContainerGameItemComponent(ContainerGameItemComponent rhs, IGameItem newParent, bool temporary = false) :
