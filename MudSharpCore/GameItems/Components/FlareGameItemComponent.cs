...
public class FlareGameItemComponent : GameItemComponent, ILightable, IProduceLight
{
	protected bool _lit;
	protected FlareGameItemComponentProto _prototype;
	...
	{
		return new FlareGameItemComponent(this, newParent, temporary);
	}
		...
		bool colour, PerceiveIgnoreFlags flags)
	{
		...
		throw new NotSupportedException("Invalid Decorate type in FlareGameItemComponent.Decorate");
	}
	...
	{
		_prototype = (FlareGameItemComponentProto)newProto;
		if (_prototype.SecondsOfFuel < RemainingFuel)
		{
	...
	public FlareGameItemComponent(FlareGameItemComponent rhs, IGameItem newParent, bool temporary = false) : base(rhs,
		newParent, temporary)
	{
	...
	public FlareGameItemComponent(FlareGameItemComponentProto proto, IGameItem parent, bool temporary = false)
	...
	public FlareGameItemComponent(MudSharp.Models.GameItemComponent component, FlareGameItemComponentProto proto,
	...
	{
		return !Lit
			? $"You cannot extinguish {Parent.HowSeen(lightee)} because it is not lit."
			: $"There is no way to extinguish {Parent.HowSeen(lightee)} once it is lit.";
	}
