...
public class IdentityObscurerGameItemComponent : GameItemComponent, IObscureIdentity
{
    ...
    public string OverriddenShortDescription => KeywordSubstitutionRegex.Replace(_prototype.OverriddenShortDescription, match =>
                                                         {
    ...
    public string OverriddenFullDescription => KeywordSubstitutionRegex.Replace(_prototype.OverriddenFullDescription, match =>
                                                        {
                                                            if (match.Groups["option"].Value.EqualTo("item"))
                                                            {
                                                                return Parent.HowSeen(Parent, flags: PerceiveIgnoreFlags.IgnoreSelf);
