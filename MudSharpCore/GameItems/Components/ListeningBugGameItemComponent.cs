...
public class ListeningBugGameItemComponent : GameItemComponent, IConsumePower, ITransmit
{
        ...
        string text)
    {
        ...
        ExplodedString eText = new(text);
        double skill = _prototype.BaseListenSkill + _prototype.ListenSkillPerQuality * (int)Parent.Quality;
        ...
        int roll = RandomUtilities.ConsecutiveRoll(
            100,
            skill,
            3
        );
