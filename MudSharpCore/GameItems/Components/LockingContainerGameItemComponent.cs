...
namespace MudSharp.GameItems.Components
{
    public class LockingContainerGameItemComponent : GameItemComponent, IContainer, IOpenable, ILockable, ILock
    {
        ...
        {
            _prototype = (LockingContainerGameItemComponentProto)newProto;
        }

        #region Constructors
        public LockingContainerGameItemComponent(LockingContainerGameItemComponentProto proto, IGameItem parent, bool temporary = false) : base(parent, proto, temporary)
        {
            _prototype = proto;
        }

        public LockingContainerGameItemComponent(Models.GameItemComponent component, LockingContainerGameItemComponentProto proto, IGameItem parent) : base(component, parent)
        {
            _prototype = proto;
            _noSave = true;
        ...
        public LockingContainerGameItemComponent(LockingContainerGameItemComponent rhs, IGameItem newParent, bool temporary = false) : base(rhs, newParent, temporary)
        {
        ...
        protected void LoadFromXml(XElement root)
        {
            ...
            XElement element = root.Element("IsLocked");
            if (element != null)
            {
        ...
        {
            return new LockingContainerGameItemComponent(this, newParent, temporary);
        }
        #endregion
        ...
        public override double ComponentWeight => Contents.Sum(x => x.Weight) + Locks.Sum(x => x.Parent.Weight);
