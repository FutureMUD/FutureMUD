...
public class MediaSplitterGameItemComponent : PassiveMediaRelayGameItemComponentBase
{
	private MediaSplitterGameItemComponentProto _prototype;

	public MediaSplitterGameItemComponent(MediaSplitterGameItemComponentProto proto, IGameItem parent,
	...
	public MediaSplitterGameItemComponent(MudSharp.Models.GameItemComponent component,
		MediaSplitterGameItemComponentProto proto, IGameItem parent)
	...
	public MediaSplitterGameItemComponent(MediaSplitterGameItemComponent rhs, IGameItem newParent,
		bool temporary = false)
	...
	{
		return new MediaSplitterGameItemComponent(this, newParent, temporary);
	}

	protected override void UpdateComponentNewPrototype(IGameItemComponentProto newProto)
	{
		base.UpdateComponentNewPrototype(newProto);
		_prototype = (MediaSplitterGameItemComponentProto)newProto;
	}
