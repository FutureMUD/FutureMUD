...
public class RelaySwitchGameItemComponent : ProgPowerSupplyGameItemComponent, IRuntimeConfigurableSignalSinkComponent
{
	private RelaySwitchGameItemComponentProto _relayPrototype;
	...
	public RelaySwitchGameItemComponent(RelaySwitchGameItemComponentProto proto, IGameItem parent,
		bool temporary = false)
		: base(proto, parent, temporary)
	{
		_relayPrototype = proto;
		_binding = new LocalSignalSinkSubscription(parent, this, HandleSourceChanged);
		SwitchedOn = false;
	}

	public RelaySwitchGameItemComponent(MudSharp.Models.GameItemComponent component,
		RelaySwitchGameItemComponentProto proto, IGameItem parent)
	...
	public RelaySwitchGameItemComponent(RelaySwitchGameItemComponent rhs, IGameItem newParent,
		bool temporary = false)
		: base(rhs, newParent, temporary)
	{
		_relayPrototype = rhs._relayPrototype;
	...
	public LocalSignalBinding CurrentBinding => _runtimeBinding ?? new LocalSignalBinding(
		0L,
		string.Empty,
		_relayPrototype.SourceComponentId,
		_relayPrototype.SourceComponentName,
		_relayPrototype.SourceEndpointKey);
	public double ActivationThreshold => _runtimeActivationThreshold ?? _relayPrototype.ActivationThreshold;
	public bool ActiveWhenAboveThreshold => _runtimeActiveWhenAboveThreshold ?? _relayPrototype.ClosedWhenAboveThreshold;

	public override IGameItemComponent Copy(IGameItem newParent, bool temporary = false)
	{
		return new RelaySwitchGameItemComponent(this, newParent, temporary);
	}

	protected override void UpdateComponentNewPrototype(IGameItemComponentProto newProto)
	{
		base.UpdateComponentNewPrototype(newProto);
		_relayPrototype = (RelaySwitchGameItemComponentProto)newProto;
	}
	...
	{
		CurrentValue = value;
		SwitchedOn = SignalComponentUtilities.IsActiveSignal(value, ActivationThreshold, ActiveWhenAboveThreshold);
	}
