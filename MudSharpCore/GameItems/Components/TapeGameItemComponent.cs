...
public class TapeGameItemComponent : GameItemComponent, IAudioStorageTape
{
	...
	private void LoadFromXml(XElement root)
	{
		...
		_recordings.Clear();
		foreach (var recording in root.Element("Recordings")?.Elements("StoredRecording") ?? Enumerable.Empty<XElement>())
		{
	...
	public bool CanStoreRecording(StoredAudioRecording recording, out string error)
	{
		...
		var replacedDuration = existing?.Recording.TotalDuration ?? TimeSpan.Zero;
