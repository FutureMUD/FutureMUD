...
public abstract class ThermalSourceGameItemComponent : GameItemComponent, IProduceHeat
{
    ...
    public double CurrentHeat(Proximity proximity)
    {
        return IsProducingHeat ? ThermalPrototype.HeatFor(proximity) : 0.0;
    }
    ...
    {
        string stateText = IsProducingHeat ? ThermalPrototype.ActiveDescriptionAddendum : ThermalPrototype.InactiveDescriptionAddendum;
        return type switch
        {
