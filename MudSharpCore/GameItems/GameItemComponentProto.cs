...
public abstract class GameItemComponentProto : EditableItem, IGameItemComponentProto
{
        ...
        : base(originator)
    {
        ...
        using (new FMDB())
        {
            Models.GameItemComponentProto dbproto = new()
            {
                Id = Id,
    ...
    private bool BuildingCommand_Name(IPerceivable actor, StringStack command)
    {
        ...
        IGameItemComponentProto existing = Gameworld.ItemComponentProtos.GetByName(_name);
        ...
        Func<MudSharp.Models.GameItemComponentProto, IFuturemud, IEditableRevisableItem> function)
    {
        using (new FMDB())
        {
            Models.GameItemComponentProto dbnew = new()
            {
                Id = Id,
    ...
    public override void Save()
    {
        using (new FMDB())
        {
            Models.GameItemComponentProto dbproto = FMDB.Context.GameItemComponentProtos.Find(Id, RevisionNumber);
