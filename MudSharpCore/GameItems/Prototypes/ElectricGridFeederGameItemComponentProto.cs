...
public class ElectricGridFeederGameItemComponentProto : GameItemComponentProto, IConnectableItemProto, ICanConnectToElectricalGridPrototype, IConnectablePrototype, IConsumePowerPrototype, IProducePowerPrototype
{
    public override string TypeDescription => "ElectricGridFeeder";
    ...
    protected ElectricGridFeederGameItemComponentProto(IFuturemud gameworld, IAccount originator) : base(gameworld,
        originator, "ElectricGridFeeder")
    {
        Connections.Add(new ConnectorType(Form.Shape.Gender.Male,
            Gameworld.GetStaticConfiguration("DefaultPowerSocketType"), true));
    }

    protected ElectricGridFeederGameItemComponentProto(MudSharp.Models.GameItemComponentProto proto,
    ...
    {
        return new ElectricGridFeederGameItemComponent(this, parent, temporary);
    }

    public override IGameItemComponent LoadComponent(MudSharp.Models.GameItemComponent component, IGameItem parent)
    {
        return new ElectricGridFeederGameItemComponent(component, this, parent);
    }
    ...
    {
        manager.AddBuilderLoader("ElectricGridFeeder".ToLowerInvariant(), true,
            (gameworld, account) => new ElectricGridFeederGameItemComponentProto(gameworld, account));
    ...
    public override string ComponentDescriptionOLC(ICharacter actor)
    {
        return string.Format(actor,
            "{0} (#{1:N0}r{2:N0}, {3})\r\n\r\nThis item feeds power into a grid. It has these connections: {4}.",
            "ElectricGridFeeder Game Item Component".Colour(Telnet.Cyan),
            Id,
            RevisionNumber,
            Name,
            Connections.Select(
