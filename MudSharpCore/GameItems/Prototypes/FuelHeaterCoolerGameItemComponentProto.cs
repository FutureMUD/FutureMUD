...
public class FuelHeaterCoolerGameItemComponentProto : SwitchableThermalSourceGameItemComponentProto, IConnectableItemProto
{
    ...
    protected override void LoadFromXml(XElement root)
    {
        ...
        XElement? connection = root.Element("Connector");
    ...
    private bool BuildingCommandFuel(ICharacter actor, StringStack command)
    {
        ...
        IGas? gas = long.TryParse(command.SafeRemainingArgument, out long gasValue)
    ...
    private bool BuildingCommandConnection(ICharacter actor, StringStack command)
    {
        ...
        string genderText = command.PopSpeech();
        Gendering? gender = Gendering.Get(genderText);
        if (gender is null)
        {
    ...
    {
        string fuelText = FuelMedium == FuelHeaterCoolerFuelMedium.Liquid
