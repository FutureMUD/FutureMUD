...
public class ImplantOrganGameItemComponentProto : ImplantBaseGameItemComponentProto
{
    ...
    {
        XElement implant = SaveToXmlWithoutConvertingToString();
    ...
    private bool BuildingCommandOrgan(ICharacter actor, StringStack command)
    {
        ...
        string organName = command.SafeRemainingArgument;
        IOrganProto organ = long.TryParse(organName, out long value)
