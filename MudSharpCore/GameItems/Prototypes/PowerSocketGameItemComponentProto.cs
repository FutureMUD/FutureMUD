...
public class PowerSocketGameItemComponentProto : GameItemComponentProto
{
	...
	protected PowerSocketGameItemComponentProto(IFuturemud gameworld, IAccount originator) : base(gameworld, originator,
		"PowerSocket")
	{
	...
	protected PowerSocketGameItemComponentProto(MudSharp.Models.GameItemComponentProto proto, IFuturemud gameworld) :
	...
	{
		return new PowerSocketGameItemComponent(this, parent, temporary);
	}

	public override IGameItemComponent LoadComponent(MudSharp.Models.GameItemComponent component, IGameItem parent)
	{
		return new PowerSocketGameItemComponent(component, this, parent);
	}
	...
	{
		manager.AddBuilderLoader("PowerSocket".ToLowerInvariant(), true,
	...
	public override string ComponentDescriptionOLC(ICharacter actor)
	{
		return string.Format(
			actor,
			"{0} (#{1:N0}r{2:N0}, {3})\r\n\r\nThis item supplies power sockets, and has the following connections: {4}",
			"PowerSocket Game Item Component".Colour(Telnet.Cyan),
			Id,
			RevisionNumber,
			Name,
			Connections.Select(
