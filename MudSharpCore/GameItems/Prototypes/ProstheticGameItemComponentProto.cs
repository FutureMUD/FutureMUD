...
public class ProstheticGameItemComponentProto : GameItemComponentProto, IProstheticPrototype
{
    ...
    private bool BuildingCommandRace(ICharacter actor, StringStack command)
    {
        ...
        IRace race = long.TryParse(command.SafeRemainingArgument, out long value)
    ...
    private bool BuildingCommandTargetBody(ICharacter actor, StringStack command)
    {
        ...
        IBodyPrototype targetBody = long.TryParse(command.SafeRemainingArgument, out long value)
    ...
    private bool BuildingCommandTargetBodypart(ICharacter actor, StringStack command)
    {
        ...
        IExternalBodypart targetPart = TargetBody.AllExternalBodyparts.GetFromItemListByKeyword(command.SafeRemainingArgument, actor);
        if (targetPart == null)
        {
            actor.Send(
