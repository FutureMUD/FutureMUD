...
public abstract class ThermalSourceGameItemComponentProto : GameItemComponentProto
{
	...
	protected bool BuildingCommandStateDescription(ICharacter actor, bool active, StringStack command)
	{
		...
		var emote = new MudSharp.PerceptionEngine.Parsers.Emote(command.SafeRemainingArgument, actor, actor);
		if (!emote.Valid)
		{
