...
public class AmputationProcedure : SurgicalProcedure
{
        ...
        params object[] additionalArguments)
    {
        ...
        string amputationDescription = limb != null
    ...
    public override string DressPhaseEmote(string emote, ICharacter surgeon, ICharacter patient,
        params object[] additionalArguments)
    {
        IBodypart part = (IBodypart)additionalArguments[0];
...
".SubstituteANSIColour();
        ...
        params object[] additionalArguments)
    {
        ...
        IEnumerable<IWound> wounds = patient.SufferDamage(new Damage
        {
        ...
        params object[] additionalArguments)
    {
        ...
        GameItems.IGameItem severedPart = patient.Body.SeverBodypart(bodypart);
