...
public abstract class BoneViaBodypartProcedure : SurgicalProcedure
{
        ...
        params object[] additionalArguments)
    {
        ...
        switch (additionalArguments.Length)
        {
            case 1:
                ...
                IBone bone = patient.Body.Bones.FirstOrDefault(x => x.FullDescription().EqualTo(targetText)) ??
        ...
        params object[] additionalArguments)
    {
        ...
        IBone organ = (IBone)additionalArguments[1];
        if (bodypart == organ)
        {
