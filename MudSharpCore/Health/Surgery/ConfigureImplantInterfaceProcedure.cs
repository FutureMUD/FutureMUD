...
public class ConfigureImplantInterfaceProcedure : BodypartSpecificSurgicalProcedure
{
        ...
        params object[] additionalArguments)
    {
        ...
        IBodypart bodypart1 = patient.Body.GetTargetBodypart(additionalArguments[0].ToString());
        IBodypart bodypart2 = patient.Body.GetTargetBodypart(additionalArguments[2].ToString());
        return new object[]
        {
    ...
    public override string DescribeProcedureGerund(ICharacter surgeon, ICharacter patient,
        params object[] additionalArguments)
    {
        IBodypart bodypart1 = (IBodypart)additionalArguments[1];
        IBodypart bodypart2 = (IBodypart)additionalArguments[3];
...
".SubstituteANSIColour();
        ...
        params object[] additionalArguments)
    {
        ...
        IGameItem implantItem1 = args[0] as IGameItem;
        IGameItem implantItem2 = args[2] as IGameItem;
        IImplant implant1 = implantItem1?.GetItemType<IImplant>();
        IImplant implant2 = implantItem2?.GetItemType<IImplant>();
        ...
        IImplantNeuralLink connectImplant = implantItem1.GetItemType<IImplantNeuralLink>();
        if (connectImplant != null)
        {
            return false;
        }

        IImplantNeuralLink neural = implantItem2.GetItemType<IImplantNeuralLink>();
        if (neural == null)
        {
            return false;
        }
        ...
        params object[] additionalArguments)
    {
        ...
        IImplantNeuralLink targetImplant = implantItem1.GetItemType<IImplantNeuralLink>();
    ...
    public override void CompleteProcedure(ICharacter surgeon, ICharacter patient, CheckOutcome result,
        params object[] additionalArguments)
    {
        IGameItem implantItem1 = (IGameItem)additionalArguments[0];
        IImplant implant1 = implantItem1.GetItemType<IImplant>();
        IBodypart bodypart1 = (IBodypart)additionalArguments[1];
        IGameItem implantItem2 = (IGameItem)additionalArguments[2];
        IImplant implant2 = implantItem2.GetItemType<IImplant>();
        IBodypart bodypart2 = (IBodypart)additionalArguments[3];
        ...
        {
            string qualityDesc = "less than perfect";
        ...
        IImplant implant = implantItem1.GetItemType<IImplant>();
        IImplantNeuralLink neural = implantItem2.GetItemType<IImplantNeuralLink>();
        ...
        foreach (IImplantNeuralLink otherneural in patient.Body.Implants.OfType<IImplantNeuralLink>().Except(neural))
        {
        ...
        params object[] additionalArguments)
    {
        ...
        IGameItem implant = (IGameItem)additionalArguments[0];
