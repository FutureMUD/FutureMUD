...
".SubstituteANSIColour();
    ...
    {
        IBodypart bodypart = (IBodypart)additionalArguments[0];
        IGameItem cannulaItem = (IGameItem)additionalArguments[1];
        ...
        params object[] additionalArguments)
    {
        ...
        IBodypart bodypart = args[0] as IBodypart;
        ...
        params object[] additionalArguments)
    {
        ...
        IGameItem cannulaItem = patient.Body.Implants.Where(x => x.Parent.IsItemType<ICannula>()).Select(x => x.Parent)
