...
public class RemoveImplantProcedure : BodypartSpecificSurgicalProcedure
{
        ...
        params object[] additionalArguments)
    {
        ...
        IBodypart bodypart = patient.Body.GetTargetBodypart(additionalArguments[0].ToString());
        return new object[]
        {
...
".SubstituteANSIColour();
        ...
        params object[] additionalArguments)
    {
        ...
        IGameItem implantItem = args[0] as IGameItem;

        IImplant implant = implantItem?.GetItemType<IImplant>();
        if (implant == null)
        {
            return false;
        }
    ...
    public override void CompleteProcedure(ICharacter surgeon, ICharacter patient, CheckOutcome result,
        params object[] additionalArguments)
    {
        IGameItem implantItem = (IGameItem)additionalArguments[0];
        IImplant implant = implantItem.GetItemType<IImplant>();
        IBodypart bodypart = (IBodypart)additionalArguments[1];
