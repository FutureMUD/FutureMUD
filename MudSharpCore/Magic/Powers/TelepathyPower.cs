...
public partial class TelepathyPower : SustainedMagicPower
{
    ...
    /// <inheritdoc />
    public override string DatabaseType => "telepathy";
    ...
    protected TelepathyPower(MagicPower power, IFuturemud gameworld) : base(power, gameworld)
    {
        ...
        XElement element = root.Element("ShowFeels");
        if (element == null)
        {
        ...
        ShowThinkerDescription = long.TryParse(element.Value, out long progid)
        ...
        PowerDistance = int.TryParse(element.Value, out int value)
    ...
    public override void UseCommand(ICharacter actor, string verb, StringStack command)
    {
        ...
        ICheck check = Gameworld.GetCheck(CheckType.MagicTelepathyCheck);
        CheckOutcome result = check.Check(actor, SkillCheckDifficulty, SkillCheckTrait, null);
