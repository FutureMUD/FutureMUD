...
public class SimpleMagicResource : BaseMagicResource
{
    ...
    {
        XElement root = XElement.Parse(resource.Definition);
    ...
    private bool BuildingCommandRoomHasProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Boolean, new[] { ProgVariableTypes.Location }).LookupProg();
        if (prog is null)
        {
            return false;
        }
    ...
    private bool BuildingCommandItemHasProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Boolean, new[] { ProgVariableTypes.Item }).LookupProg();
        if (prog is null)
        {
            return false;
        }
    ...
    private bool BuildingCommandCharacterHasProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Boolean, new[] { ProgVariableTypes.Character }).LookupProg();
        if (prog is null)
        {
            return false;
        }
    ...
    private bool BuildingCommandRoomStartProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Number, new[] { ProgVariableTypes.Location }).LookupProg();
        if (prog is null)
        {
            return false;
        }
    ...
    private bool BuildingCommandItemStartProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Number, new[] { ProgVariableTypes.Item }).LookupProg();
        if (prog is null)
        {
            return false;
        }
    ...
    private bool BuildingCommandCharacterStartProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Number, new[] { ProgVariableTypes.Character }).LookupProg();
        if (prog is null)
        {
            return false;
        }
    ...
    private bool BuildingCommandResourceCapProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Number, new[] { ProgVariableTypes.MagicResourceHaver }).LookupProg();
        if (prog is null)
        {
            return false;
        }
