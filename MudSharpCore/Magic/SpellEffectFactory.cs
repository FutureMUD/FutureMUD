...
public static class SpellEffectFactory
{
    ...
    {
        (Func<StringStack, IMagicSpell, (IMagicSpellEffectTemplate Trigger, string Error)> _, string blurb, string help, bool instant, bool requiresTarget, string[] matchingTriggers) = _builderFactories[type];
        return (blurb, help, instant, requiresTarget, matchingTriggers);
    }

    public static void SetupFactory()
    {
        Type fpType = typeof(IMagicSpellEffectTemplate);
        foreach (
