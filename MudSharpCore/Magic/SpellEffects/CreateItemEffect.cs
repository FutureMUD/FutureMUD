...
public class CreateItemEffect : IMagicSpellEffectTemplate
{
        ...
        SpellPower power, IMagicSpellEffectParent parent, SpellAdditionalParameter[] additionalParameters)
    {
        ...
        IGameItemSkin skin = ItemSkin;

        ItemQuality quality = (ItemQuality)(int)Math.Floor(ItemQuality.EvaluateDoubleWith(
        ...
        {
            IContainer container = gitem.GetItemType<IContainer>();
...
Parameters for quality formula:
    ...
    private bool BuildingCommandSkin(ICharacter actor, StringStack command)
    {
        ...
        IGameItemSkin skin = Gameworld.ItemSkins.GetByIdOrName(command.SafeRemainingArgument);
        if (skin is null)
        {
    ...
    private bool BuildingCommandItem(ICharacter actor, StringStack command)
    {
        ...
        IGameItemProto proto = Gameworld.ItemProtos.GetByIdOrName(command.SafeRemainingArgument);
        if (proto is null)
        {
