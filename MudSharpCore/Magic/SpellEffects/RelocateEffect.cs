...
You can also use the traits of the caster as per #3TE HELP#0.";
        ...
        SpellPower power, IMagicSpellEffectParent parent, SpellAdditionalParameter[] additionalParameters)
    {
        ...
        double amount = HealingAmount.EvaluateWith(caster, values: new (string Name, object Value)[]
        {
            ("power", (int)power),
            ("outcome", (int)outcome)
        });

        List<IWound> wounds = tch.Body.Wounds
        ...
        while (amount > 0.0)
        {
            ...
            int difficulty = (int)wound.CanBeTreated(TreatmentType.Relocation);
