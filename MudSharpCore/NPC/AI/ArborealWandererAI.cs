...
public class ArborealWandererAI : PathingAIBase
{
    ...
    {
        if (command.IsFinished || !command.SafeRemainingArgument.TryParseEnum<RoomLayer>(out RoomLayer value) ||
    ...
    {
        ICharacter? ch = (type == EventType.EngagedInCombat ? arguments[1] : arguments[0]) as ICharacter;
