...
public class MountAI : ArtificialIntelligenceBase, IMountableAI
{
    ...
    private bool BuildingCommandWhyCantProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg? prog = new ProgLookupFromBuilderInput(actor, command.SafeRemainingArgument, ProgVariableTypes.Text, [[ProgVariableTypes.Character, ProgVariableTypes.Character], [ProgVariableTypes.Character]]).LookupProg();
        if (prog is null)
        {
            return false;
        }
    ...
    private bool BuildingCommandPermitControlProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg? prog = new ProgLookupFromBuilderInput(actor, command.SafeRemainingArgument, ProgVariableTypes.Boolean, [[ProgVariableTypes.Character, ProgVariableTypes.Character], [ProgVariableTypes.Character]]).LookupProg();
        if (prog is null)
        {
            return false;
        }
