...
public abstract class PathingAIWithProgTargetsBase : PathingAIBase
{
    ...
    private bool BuildingCommandWaypointsProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Location | ProgVariableTypes.Collection, new[] { ProgVariableTypes.Character }).LookupProg();
        if (prog is null)
        {
            return false;
        }
    ...
    private bool BuildingCommandFallbackLocationProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Location, new[] { ProgVariableTypes.Character }).LookupProg();
        if (prog is null)
        {
            return false;
        }
    ...
    private bool BuildingCommandOnStartProg(ICharacter actor, StringStack command)
    {
        ...
        IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Void, new[] { ProgVariableTypes.Character, ProgVariableTypes.Location, ProgVariableTypes.Exit | ProgVariableTypes.Collection }).LookupProg();
        if (prog is null)
        {
            return false;
        }
