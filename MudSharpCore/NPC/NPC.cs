...
public class NPC : Character.Character, INPC
{
    ...
    protected void LoadNPCFromDB(Models.Npc npc)
    {
        ...
        foreach (NpcsArtificialIntelligences ai in npc.NpcsArtificialIntelligences)
        {
    ...
    public override object DatabaseInsert()
    {
        ...
        foreach (IArtificialIntelligence item in _AIs)
        {
    ...
    {
        Tuple<object, Npc> item = (Tuple<object, Models.Npc>)dbitem;
    ...
    public override void Save()
    {
        ...
        if (dbnpc != null)
        {
            ...
            if (AIChanged)
            {
                ...
                foreach (IArtificialIntelligence ai in _AIs)
                {
