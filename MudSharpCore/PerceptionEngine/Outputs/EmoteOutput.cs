...
public class EmoteOutput : Output, IEmoteOutput
{
    ...
    {
        Emote parsedEmote = new(emote, DefaultSource, forceSourceInclusion);
        AllValid &= parsedEmote.Valid;

        foreach (IPerceiver perceiver in perceivers)
        {
    ...
    {
        Emote parsedEmote = new(emote, source, forceSourceInclusion);
        AllValid &= parsedEmote.Valid;
