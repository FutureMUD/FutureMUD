...
public class CorpseRecoveryPatrolStrategy : PatrolStrategyBase
{
    public CorpseRecoveryPatrolStrategy(IFuturemud gameworld) : base(gameworld)
    {
    }

    public override string Name => "CorpseRecovery";
