...
public class RandomAccessPriorityQueue<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>>
{
	...
	/// </summary>
	public RandomAccessPriorityQueue()
	...
	public RandomAccessPriorityQueue(int capacity)
	...
	/// </summary>
	/// <param name="comparer">priority comparer</param>
	public RandomAccessPriorityQueue(IComparer<TPriority> comparer)
	{
	...
	public RandomAccessPriorityQueue(IEnumerable<KeyValuePair<TPriority, TValue>> data)
	...
	/// <param name="data">data to be inserted into priority queue</param>
	/// <param name="comparer">priority comparer</param>
	public RandomAccessPriorityQueue(IEnumerable<KeyValuePair<TPriority, TValue>> data, IComparer<TPriority> comparer)
	{
	...
	/// </remarks>
	public static RandomAccessPriorityQueue<TPriority, TValue> MergeQueues(
		RandomAccessPriorityQueue<TPriority, TValue> pq1,
		RandomAccessPriorityQueue<TPriority, TValue> pq2)
	{
	...
	public static RandomAccessPriorityQueue<TPriority, TValue> MergeQueues(
		RandomAccessPriorityQueue<TPriority, TValue> pq1,
		RandomAccessPriorityQueue<TPriority, TValue> pq2, IComparer<TPriority> comparer)
	{
		...
		// merge data
		var result = new RandomAccessPriorityQueue<TPriority, TValue>(pq1.Count + pq2.Count, pq1._comparer);
	...
	/// <summary>
	///     Dequeues element with minimum priority and returns its value
	/// </summary>
	...
	public bool RemoveAll(Predicate<KeyValuePair<TPriority, TValue>> predicate)
	{
		if (_baseHeap.RemoveAll(predicate) > 0)
		{
			HeapifyFromBeginningToEnd(0);
		}
