...
public abstract class BaseInput : LateInitialisingItem, ICraftInput
{
    ...
    {
        CraftInput dbitem = FMDB.Context.CraftInputs.Find(Id);
    ...
    internal class SimpleItemInputData : ICraftInputDataWithItems
    {
        public SimpleItemInputData(XElement root, IFuturemud gameworld)
        {
            ...
            {
                // Legacy item
                IGameItem item = gameworld.TryGetItem(long.Parse(root.Element("Consumed").Value));
