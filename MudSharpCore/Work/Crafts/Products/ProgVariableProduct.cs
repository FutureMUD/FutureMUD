...
namespace MudSharp.Work.Crafts.Products
{
	...
	#3variable <definition>#0 - toggles a variable off for this item";
        ...
        private bool BuildingCommandVariable(ICharacter actor, StringStack command)
        {
            ...
            IFutureProg prog = new ProgLookupFromBuilderInput(Gameworld, actor, command.SafeRemainingArgument, ProgVariableTypes.Number, new ProgVariableTypes[]
            {
        ...
        public override string WhyNotValid()
        {
            ...
            foreach ((ICharacteristicDefinition _, IFutureProg prog) in Characteristics)
            {
        ...
        public override string Name
        {
            get
            {
                ...
                foreach ((ICharacteristicDefinition definition, IFutureProg input) in Characteristics)
                {
