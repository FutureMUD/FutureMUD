    ...
    public partial class FuturemudDatabaseContext
    {
        protected static void OnModelCreatingOne(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Models.Account>(entity =>
            {
                ...
                entity.Property(e => e.AutoReacquireTargets)
                      .HasColumnType("bit(1)")
                      .HasDefaultValueSql("b'1'");
            ...
            modelBuilder.Entity<CharacterBody>(entity =>
            {
                entity.HasKey(e => new { e.CharacterId, e.BodyId })
                    .HasName("PRIMARY");
                ...
                entity.HasOne(d => d.CanVoluntarilySwitchProg)
                    .WithMany()
                    .HasForeignKey(d => d.CanVoluntarilySwitchProgId)
                    .OnDelete(DeleteBehavior.SetNull)
            ...
            modelBuilder.Entity<CharacterCombatSetting>(entity =>
            {
                ...
                entity.Property(e => e.AttackHelpless)
                    .HasColumnType("bit(1)")
                    .HasDefaultValueSql("b'0'");

                entity.Property(e => e.AttackUnarmed)
                      .HasColumnType("bit(1)")
                      .HasDefaultValueSql("b'0'");
