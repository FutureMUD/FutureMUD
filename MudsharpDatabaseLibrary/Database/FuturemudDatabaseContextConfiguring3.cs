...
namespace MudSharp.Database
{
	public partial class FuturemudDatabaseContext
	{
		protected static void OnModelCreatingThree(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Models.RacesRemoveBreathableGases>(entity =>
			{
				entity.HasKey(e => new { e.RaceId, e.GasId })
				      .HasName("PRIMARY");

				entity.ToTable("Races_RemoveBreathableGases");

				entity.HasIndex(e => e.GasId)
				      .HasDatabaseName("FK_Races_RemoveBreathableGases_Gases_idx");
				...
				entity.HasOne(d => d.Gas)
				      .WithMany(p => p.RacesRemoveBreathableGases)
				      .HasForeignKey(d => d.GasId)
				      .HasConstraintName("FK_Races_RemoveBreathableGases_Gases");

				entity.HasOne(d => d.Race)
				      .WithMany(p => p.RacesRemoveBreathableGases)
				      .HasForeignKey(d => d.RaceId)
				      .HasConstraintName("FK_Races_RemoveBreathableGases_Races");
			});
			modelBuilder.Entity<Models.RacesRemoveBreathableLiquids>(entity =>
			{
				entity.HasKey(e => new { e.RaceId, e.LiquidId })
					  .HasName("PRIMARY");

				entity.ToTable("Races_RemoveBreathableLiquids");

				entity.HasIndex(e => e.LiquidId)
					  .HasDatabaseName("FK_Races_RemoveBreathableLiquids_Liquids_idx");
				...
				entity.HasOne(d => d.Liquid)
					  .WithMany(p => p.RacesRemoveBreathableLiquids)
					  .HasForeignKey(d => d.LiquidId)
					  .HasConstraintName("FK_Races_RemoveBreathableLiquids_Liquids");

				entity.HasOne(d => d.Race)
					  .WithMany(p => p.RacesRemoveBreathableLiquids)
					  .HasForeignKey(d => d.RaceId)
					  .HasConstraintName("FK_Races_RemoveBreathableLiquids_Races");
			});
