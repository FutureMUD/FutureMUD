...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketMarketCategory", b =>
                {
                    ...
                    b.ToTable("MarketMarketCategory", (string)null);
                });
            ...
            modelBuilder.Entity("MudSharp.Models.Account", b =>
                {
                    ...
                    b.Property<ulong>("AutoReacquireTargets")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit(1)")
                        .HasDefaultValueSql("b'1'");
            ...
            modelBuilder.Entity("MudSharp.Models.ArmourType", b =>
                {
                    ...
                    b.Property<double>("BaseDifficultyDegrees")
                        .HasColumnType("double");
                    ...
                    b.Property<double>("StackedDifficultyDegrees")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("MudSharp.Models.CharacterCombatSetting", b =>
                {
                    ...
                    b.Property<ulong>("AttackHelpless")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit(1)")
                        .HasDefaultValueSql("b'0'");

                    b.Property<ulong>("AttackUnarmed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit(1)")
                        .HasDefaultValueSql("b'0'");
            ...
            modelBuilder.Entity("MudSharp.Models.ClimateModelSeason", b =>
                {
                    ...
                    b.ToTable("ClimateModelSeason", (string)null);
                });
            ...
            modelBuilder.Entity("MudSharp.Models.ClimateModelSeasonEvent", b =>
                {
                    ...
                    b.ToTable("ClimateModelSeasonEvent", (string)null);
                });
            ...
            modelBuilder.Entity("MudSharp.Models.Crime", b =>
                {
                    ...
                    b.Property<ulong>("ExecutionPunishment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit(1)")
                        .HasDefaultValue(0ul);

                    b.Property<ulong>("FineHasBeenPaid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit(1)")
                        .HasDefaultValue(0ul);
                    ...
                    b.Property<double>("GoodBehaviourBond")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(0.0);
                    ...
                    b.Property<ulong>("SentenceHasBeenServed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit(1)")
                        .HasDefaultValue(0ul);
            ...
            modelBuilder.Entity("MudSharp.Models.EthnicitiesNameCultures", b =>
                {
                    ...
                    b.ToTable("EthnicitiesNameCultures", (string)null);
                });
            ...
            modelBuilder.Entity("MudSharp.Models.HeightWeightModel", b =>
                {
                    ...
                    b.Property<double?>("SkewnessBMI")
                        .HasColumnType("double");

                    b.Property<double?>("SkewnessHeight")
                        .HasColumnType("double");

                    b.Property<double?>("SkewnessWeight")
                        .HasColumnType("double");
                    ...
                    b.Property<double?>("StddevWeight")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("MudSharp.Models.Liquid", b =>
                {
                    ...
                    b.Property<bool>("LeaveResidueInRooms")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("MudSharp.Models.MarketInfluence", b =>
                {
                    ...
                    b.ToTable("MarketInfluences", (string)null);
                });
            ...
            modelBuilder.Entity("MudSharp.Models.MarketInfluenceTemplate", b =>
                {
                    ...
                    b.ToTable("MarketInfluenceTemplates", (string)null);
                });
            ...
            modelBuilder.Entity("MudSharp.Models.MarketPopulation", b =>
                {
                    ...
                    b.ToTable("MarketPopulations", (string)null);
                });
            ...
            modelBuilder.Entity("MudSharp.Models.Merchandise", b =>
                {
                    ...
                    b.Property<bool>("PermitItemDecayOnStockedItems")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("MudSharp.Models.Race", b =>
                {
                    ...
                    b.Property<double>("TrackIntensityOlfactory")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(1.0);

                    b.Property<double>("TrackIntensityVisual")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(1.0);

                    b.Property<double>("TrackingAbilityOlfactory")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(0.0);

                    b.Property<double>("TrackingAbilityVisual")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(1.0);
            ...
            modelBuilder.Entity("MudSharp.Models.RacesRemoveBreathableGases", b =>
                {
                    b.Property<long>("RaceId")
                        .HasColumnType("bigint(20)");
                    ...
                    b.ToTable("Races_RemoveBreathableGases", (string)null);
                });

            modelBuilder.Entity("MudSharp.Models.RacesRemoveBreathableLiquids", b =>
                {
                    b.Property<long>("RaceId")
                        .HasColumnType("bigint(20)");
                    ...
                    b.ToTable("Races_RemoveBreathableLiquids", (string)null);
                });
            ...
            modelBuilder.Entity("MudSharp.Models.Terrain", b =>
                {
                    ...
                    b.Property<ulong>("CanHaveTracks")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit(1)")
                        .HasDefaultValue(1ul);
                    ...
                    b.Property<double>("TrackIntensityMultiplierOlfactory")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(1.0);

                    b.Property<double>("TrackIntensityMultiplierVisual")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(1.0);
            ...
            modelBuilder.Entity("MudSharp.Models.Track", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20)");
                    ...
                    b.Property<long?>("FromDirectionExitId")
                        .HasColumnType("bigint(20)");

                    b.Property<long?>("FromMoveSpeedId")
                        .HasColumnType("bigint(20)");
                    ...
                    b.Property<long?>("ToMoveSpeedId")
                        .HasColumnType("bigint(20)");

                    b.Property<int>("TrackCircumstances")
                        .HasColumnType("int(11)");
                    ...
                    b.HasIndex("FromDirectionExitId");

                    b.HasIndex("FromMoveSpeedId");

                    b.HasIndex("ToDirectionExitId");
            ...
            modelBuilder.Entity("MudSharp.Models.Body", b =>
                {
                    ...
                    b.HasOne("MudSharp.Models.HealthStrategy", "HealthStrategy")
                        .WithMany()
                        .HasForeignKey("HealthStrategyId");
            ...
            modelBuilder.Entity("MudSharp.Models.RacesRemoveBreathableGases", b =>
                {
                    b.HasOne("MudSharp.Models.Gas", "Gas")
                        .WithMany("RacesRemoveBreathableGases")
                        .HasForeignKey("GasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("MudSharp.Models.RacesRemoveBreathableLiquids", b =>
                {
                    b.HasOne("MudSharp.Models.Liquid", "Liquid")
                        .WithMany("RacesRemoveBreathableLiquids")
                        .HasForeignKey("LiquidId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("MudSharp.Models.Track", b =>
                {
                    ...
                    b.HasOne("MudSharp.Models.Exit", "FromDirectionExit")
                        .WithMany()
                        .HasForeignKey("FromDirectionExitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_Tracks_Exits_From");

                    b.HasOne("MudSharp.Models.MoveSpeed", "FromMoveSpeed")
                        .WithMany()
                    ...
                    b.HasOne("MudSharp.Models.Exit", "ToDirectionExit")
                        .WithMany()
                        .HasForeignKey("ToDirectionExitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_Tracks_Exits_To");

                    b.HasOne("MudSharp.Models.MoveSpeed", "ToMoveSpeed")
                        .WithMany()
                        .HasForeignKey("ToMoveSpeedId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("MudSharp.Models.Gas", b =>
                {
                    ...
                    b.Navigation("RacesRemoveBreathableGases");
                });
            ...
            modelBuilder.Entity("MudSharp.Models.Liquid", b =>
                {
                    ...
                    b.Navigation("RacesRemoveBreathableLiquids");
