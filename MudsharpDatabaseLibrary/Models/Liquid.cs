...
namespace MudSharp.Models
{
	public partial class Liquid
	{
		public Liquid()
		{
			...
			RacesRemoveBreathableLiquids = new HashSet<RacesRemoveBreathableLiquids>();
		...
		public virtual ICollection<RacesRemoveBreathableLiquids> RacesRemoveBreathableLiquids { get; set; }
