...
const struct command_data commands[] = {
  ...
  {"aim", do_aim, FIGHT, C_BLD | C_HID}, //| C_MNT
  ...
  {"immcommands", do_immcommands, DEAD, C_LV1},
	...
	{"rend", do_rend, DEAD, C_LV5},	/* object.c */
