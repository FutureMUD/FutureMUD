...
//  MAX_OVERHEAD =     22048000;
  ...
  MAX_MEMORY =       6000000;
  PERM_MEMORY_SIZE = 4250000;
  MAX_OVERHEAD =     5512000;  
...
free_obj (OBJ_DATA * obj)
{
  ...
  if (!tobj || tobj->var_color2 != obj->var_color2)
    mem_free (obj->var_color2);

  if (!tobj || tobj->var_color3 != obj->var_color3)
    mem_free (obj->var_color3);
