...
extern const char *orc_colors[]; // commerce.c
...
extern const char *beor_art[]; // commerce.c
extern const char *war_art[]; // commerce.c
...
void directional_scan(CHAR_DATA * ch, int dir);
...
void equip_slave (CHAR_DATA * mob, int cmd);	/* arena.c */
...
void manage_resources (CHAR_DATA * keeper); // commerce.cpp
...
void insert_string_variables (OBJ_DATA * new_obj, OBJ_DATA * proto,
			      char *string, char *string2, char *string3);
void boot_db (void);
...
void soma_ten_second_affect (CHAR_DATA * ch, AFFECTED_TYPE * af);
void soma_rl_minute_affect (CHAR_DATA * ch, AFFECTED_TYPE * af);
OBJ_DATA *load_colored_object (int nVirtual, char *string, char *string2, char *string3);
...
void remove_object_poison (OBJ_DATA * obj, POISON_DATA * poison);
...
void remove_object_poison (OBJ_DATA * attack_weapon, POISON_DATA * poison);
...
int whisper_it (CHAR_DATA * ch, char *source, char *target);
