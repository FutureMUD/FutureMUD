...
#define BASE_SPECIAL_HEALING 20	/* Increased healing rate, for special mobs/PCs. */
...
#define ITEM_BENIGN         ( 1 << 5 ) // Used for poisons that are "good" for you.
...
#define NO_MAGIC   	( 1 << 5 )  // no magic
#define TWODI     	( 1 << 6 )  // two dimensional - the future
#define BRAWL       	( 1 << 7 )  // you can brawl in safety here
#define SAFE_Q     	( 1 << 8 )  // can quit
#define FORT	   	( 1 << 9 )  // can fortify a squeezable zone
#define FALL		( 1 << 10 ) // autofall
#define NO_MOUNT	( 1 << 11 ) // no mounts
...
#define PEACE		( 1 << 17 ) // defunct
#define ROAD		( 1 << 18 ) // defunct
#define WEALTHY		( 1 << 19 ) // defunct
#define POOR		( 1 << 20 ) // defunct
...
#define MAX_HERBS_PER_ROOM	2

#define HERB_RESET_DURATION	12
...
#define ACT_WIMPY     	( 1 << 7 )  // More or less defunct.
...
#define ACT_NOORDER	    ( 1 << 10 ) // Merchant doesn't take orders.
...
#define ACT_VENOM     ( 1 << 19 )	/* The mobile has venom */
...
// Actual somatic effects

// Effects granted by blunt damage

#define SOMA_BLUNT_MEDHEAD              MAGIC_FIRST_SOMA + 61
#define SOMA_BLUNT_SEVHEAD              MAGIC_FIRST_SOMA + 62
#define SOMA_BLUNT_R_SEVARM             MAGIC_FIRST_SOMA + 64
#define SOMA_BLUNT_L_SEVARM             MAGIC_FIRST_SOMA + 65
#define SOMA_BLUNT_SEVLEG               MAGIC_FIRST_SOMA + 68
#define SOMA_BLUNT_SEVBODY              MAGIC_FIRST_SOMA + 72

// Poisons - the next twentygive range will be posions.

#define SOMA_SPIDER_PARALYZE            MAGIC_FIRST_SOMA + 73 // paralyses
#define SOMA_SPIDER_NECROTIC            MAGIC_FIRST_SOMA + 74
#define SOMA_SPIDER_HIBERNATE           MAGIC_FIRST_SOMA + 75

#define SOMA_SNAKE_NEUROTOXIN           MAGIC_FIRST_SOMA + 76
#define SOMA_SNAKE_CYTOTOXIN            MAGIC_FIRST_SOMA + 77
#define SOMA_SNAKE_HEMOTOXIN            MAGIC_FIRST_SOMA + 78

#define SOMA_TOAD_POISON                MAGIC_FIRST_SOMA + 79
#define SOMA_TOAD_VISIONS               MAGIC_FIRST_SOMA + 80

#define SOMA_PLANT_DROWSINESS           MAGIC_FIRST_SOMA + 81 
#define SOMA_PLANT_SLEEP                MAGIC_FIRST_SOMA + 82  
#define SOMA_PLANT_BLEEDING             MAGIC_FIRST_SOMA + 83 // internal bleeding for a long time.
#define SOMA_PLANT_NASEUA               MAGIC_FIRST_SOMA + 84
#define SOMA_PLANT_BLINDNESS            MAGIC_FIRST_SOMA + 85 // gradually blinds
#define SOMA_PLANT_VISIONS              MAGIC_FIRST_SOMA + 86 // causes paranoia 
#define SOMA_PLANT_RELAX                MAGIC_FIRST_SOMA + 87 // increase hp regen but slow move
#define SOMA_PLANT_ALERTNESS            MAGIC_FIRST_SOMA + 88 // increases movement regen + hunger
#define SOMA_PLANT_FURY                 MAGIC_FIRST_SOMA + 89 // combat boost but no flee
#define SOMA_PLANT_SPIDERPROOF          MAGIC_FIRST_SOMA + 90 
#define SOMA_PLANT_WRAITHCURE           MAGIC_FIRST_SOMA + 91

#define SOMA_MAGIC_WRAITHCURSE          MAGIC_FIRST_SOMA + 92
#define SOMA_MAGIC_SOULSPITE            MAGIC_FIRST_SOMA + 93
#define SOMA_PLANT_FOCUS                MAGIC_FIRST_SOMA + 94 // boost to all skills
#define SOMA_MAGIC_BLANK2               MAGIC_FIRST_SOMA + 95
#define SOMA_MAGIC_BLANK3               MAGIC_FIRST_SOMA + 96
#define SOMA_MAGIC_BLANK4               MAGIC_FIRST_SOMA + 97
#define SOMA_SNOWCOLD                   MAGIC_FIRST_SOMA + 98

#define MAGIC_LAST_SOMA                 MAGIC_FIRST_SOMA + 98
#define MAGIC_FIRST_POISON              MAGIC_FIRST_SOMA + 73
#define MAGIC_LAST_POISON              MAGIC_FIRST_SOMA + 98
...
#define SKILL_CLUB      	6
#define SKILL_FLAIL       	7
#define SKILL_LARGE_WEAPON      8
#define SKILL_SINGLE_WEAPON     9
#define SKILL_SHIELD_STYLE      10
#define SKILL_DUAL          	11
#define SKILL_THROWN		12
#define SKILL_BLOWGUN		13
#define SKILL_SLING		14
#define SKILL_SHORTBOW		15
#define SKILL_LONGBOW		16
#define SKILL_AVERT         	17
#define SKILL_DEFUNCT         	18

#define SKILL_SNEAK         	19
#define SKILL_HIDE          	20
#define SKILL_STEAL         	21
#define SKILL_PICK          	22
#define SKILL_FORAGE        	23
#define SKILL_BARTER       	24
#define SKILL_RIDE		25
#define SKILL_BUTCHERY		26
#define SKILL_POISONING		27
#define SKILL_HERBALISM		28

#define SKILL_CLAIRVOYANCE	29
#define SKILL_DANGER_SENSE	30
#define SKILL_EMPATHIC_HEAL	31
#define SKILL_HEX		32
#define SKILL_MENTAL_BOLT	33
#define SKILL_PRESCIENCE	34
#define SKILL_SENSITIVITY	35
#define SKILL_TELEPATHY		36

#define SKILL_DODGE		37
#define SKILL_METALCRAFT	38
#define SKILL_WOODCRAFT		39
#define SKILL_LUMBERJACK        40
#define SKILL_COOKERY		41
#define SKILL_HIDEWORKING	42
#define SKILL_BREWING		43
#define SKILL_LITERACY		44
#define SKILL_APOTHECARY	45
#define SKILL_MINING		46
#define SKILL_TRACKING		47
#define SKILL_HEALING		48

#define SKILL_SPEAK_TALISKA             49
#define SKILL_SPEAK_HALADIN             50
#define SKILL_SPEAK_THRUNON             51
#define SKILL_SPEAK_BEAST_TONGUE        52
#define SKILL_SPEAK_VALARIN             53
#define SKILL_SPEAK_NANDORIN		54
#define SKILL_SPEAK_DRUAG		55
#define SKILL_SPEAK_SINDARIN		56
#define SKILL_SPEAK_QUENYA		57
#define SKILL_SPEAK_AVARIN		58
#define SKILL_SPEAK_KHUZDUL	    	59
#define SKILL_SPEAK_ORKISH		60
#define SKILL_SPEAK_TROLLISH	        61

#define SKILL_SCRIPT_SARATI		62
#define SKILL_SCRIPT_TENGWAR		63
#define SKILL_SCRIPT_CIRTH	        64
#define SKILL_SCRIPT_VALARIN_SCRIPT	65
#define SKILL_BLACK_WISE		66
#define SKILL_GREY_WISE			67
#define SKILL_WHITE_WISE		68
#define SKILL_RUNECASTING		69
#define SKILL_ASTRONOMY			70
#define SKILL_EAVESDROP                 71
#define LAST_SKILL			SKILL_EAVESDROP
...
#define GAME_BASE_YEAR		432
#define GAME_SECONDS_BEGINNING  1	/* Subtr 10800 to ++gametime 12hr */
