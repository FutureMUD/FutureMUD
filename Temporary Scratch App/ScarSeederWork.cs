...
public class ScarSeederWork
{
    public static int DoScarSeederWork(string[] args)
    {
        try
        {
    ...
    private static readonly IReadOnlyList<HighSeverityScarShapeSpec> HumanScarShapeSpecs = new[]
{
    ...
    new HighSeverityScarDamageSpec(
        ...
        "wrong-looking eldritch scar",
        "where an unnatural energy warped the flesh into a twisted pattern that healed wrong",
        "Patch",
        1,
        1,
        0.005),
    new HighSeverityScarDamageSpec(
        ...
        "arcane sear scar",
        "arcane sear scar",
        "where raw magical force seared the tissue into a strange, sigil-shaped scar pattern",
        "Patch",
        1,
        1,
        0.005),
